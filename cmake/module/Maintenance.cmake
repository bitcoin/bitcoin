...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS bitcoin snailcoind bitcoin-node snailcoin-qt bitcoin-gui snailcoin-cli bitcoin-tx bitcoin-util bitcoin-wallet test_bitcoin bench_bitcoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin AND TARGET snailcoin-qt AND TARGET snailcoind AND TARGET snailcoin-cli AND TARGET bitcoin-tx AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_bitcoin)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:snailcoin-qt> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:snailcoin-qt>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:snailcoind> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:snailcoind>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:snailcoin-cli> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:snailcoin-cli>
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET snailcoin-qt)
    set(macos_app "Snailcoin-Qt.app")
    ...
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Snailcoin-Qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component snailcoin-qt --prefix ${macos_app}/Contents/MacOS --strip
      COMMAND ${CMAKE_COMMAND} -E rename ${macos_app}/Contents/MacOS/bin/$<TARGET_FILE_NAME:snailcoin-qt> ${macos_app}/Contents/MacOS/Snailcoin-Qt
    ...
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/Snailcoin-Qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Snailcoin-Qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/Snailcoin-Qt
      )
    ...
    add_dependencies(deploydir snailcoin-qt)
