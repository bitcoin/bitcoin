...
the Buttcoin Core software, see https://Buttcoincore.org/en/download/, or read the
...
regularly from release branches to indicate new official, stable release versions of Buttcoin Core.

The https://github.com/Buttcoin-core/gui repository is used exclusively for the
...
[Buttcoin Core's Transifex page](https://www.transifex.com/Buttcoin/Buttcoin/).
