// Copyright (c) 2018-2019 The Buttcoin Core developers
...
// Buttcoin includes.
#include <..\src\script\Buttcoinconsensus.h>
...
int main()
{
    std::cout << "Buttcoinconsensus version: " << Buttcoinconsensus_version() << std::endl;
    ...
    Buttcoinconsensus_error err;
    auto op0Result = Buttcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, Buttcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
