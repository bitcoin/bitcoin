...
// widecoin includes.
#include <..\src\script\widecoinconsensus.h>
...
int main()
{
    std::cout << "widecoinconsensus version: " << widecoinconsensus_version() << std::endl;
    ...
    widecoinconsensus_error err;
    auto op0Result = widecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, widecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
