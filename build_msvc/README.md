...
Introduction
---------------------
Visual Studio 2022 is minimum required to build Widecoin Core.
...
```cmd
msbuild build_msvc\widecoin.sln -property:Configuration=Release -maxCpuCount -verbosity:minimal
```
