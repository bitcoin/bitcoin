...
AC_DEFUN([_SYSCOIN_QT_FIND_LIBS],[
  SYSCOIN_QT_CHECK([
    PKG_CHECK_MODULES([QT_CORE], [${qt_lib_prefix}Core $qt_version], [],
                      [SYSCOIN_QT_FAIL([${qt_lib_prefix}Core $qt_version not found])])
  ])
  SYSCOIN_QT_CHECK([
    PKG_CHECK_MODULES([QT_GUI], [${qt_lib_prefix}Gui $qt_version], [],
                      [SYSCOIN_QT_FAIL([${qt_lib_prefix}Gui $qt_version not found])])
  ])
  SYSCOIN_QT_CHECK([
    PKG_CHECK_MODULES([QT_WIDGETS], [${qt_lib_prefix}Widgets $qt_version], [],
                      [SYSCOIN_QT_FAIL([${qt_lib_prefix}Widgets $qt_version not found])])
  ])
  SYSCOIN_QT_CHECK([
    PKG_CHECK_MODULES([QT_NETWORK], [${qt_lib_prefix}Network $qt_version], [],
                      [SYSCOIN_QT_FAIL([${qt_lib_prefix}Network $qt_version not found])])
  ])
