...
class AddressIndexTest(ParticlTestFramework):
    ...
    def setup_network(self):
        ...
        self.nodes.append(start_node(0, self.options.tmpdir, ["-debug", "-relaypriority=0"], genfirstkey=False))
        self.nodes.append(start_node(1, self.options.tmpdir, ["-debug", "-addressindex"], genfirstkey=False))
        # Nodes 2/3 are used for testing
        self.nodes.append(start_node(2, self.options.tmpdir, ["-debug", "-addressindex", "-relaypriority=0"], genfirstkey=False))
        self.nodes.append(start_node(3, self.options.tmpdir, ["-debug", "-addressindex"], genfirstkey=False))
