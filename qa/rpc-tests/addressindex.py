...
class AddressIndexTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        balance0 = self.nodes[1].getaddressbalance("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti")
        assert_equal(balance0["balance"], 0)

        # Check p2pkh and p2sh address indexes
        print("Testing p2pkh and p2sh address index...")

        txid0 = self.nodes[0].sendtoaddress("pcX1WHotKuQwFypDf1ZkJrh81J1DS7DfXd", 10)
        self.nodes[0].generate(1)

        txidb0 = self.nodes[0].sendtoaddress("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti", 10)
        self.nodes[0].generate(1)

        txid1 = self.nodes[0].sendtoaddress("pcX1WHotKuQwFypDf1ZkJrh81J1DS7DfXd", 15)
        self.nodes[0].generate(1)

        txidb1 = self.nodes[0].sendtoaddress("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti", 15)
        self.nodes[0].generate(1)

        txid2 = self.nodes[0].sendtoaddress("pcX1WHotKuQwFypDf1ZkJrh81J1DS7DfXd", 20)
        self.nodes[0].generate(1)

        txidb2 = self.nodes[0].sendtoaddress("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti", 20)
        self.nodes[0].generate(1)

        self.sync_all()

        txids = self.nodes[1].getaddresstxids("pcX1WHotKuQwFypDf1ZkJrh81J1DS7DfXd")
        assert_equal(len(txids), 3)
        assert_equal(txids[0], txid0)
        assert_equal(txids[1], txid1)
        assert_equal(txids[2], txid2)

        txidsb = self.nodes[1].getaddresstxids("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti")
        ...
        height_txids = self.nodes[1].getaddresstxids({
            "addresses": ["rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti"],
            "start": 105,
            "end": 110
        })
        ...
        multitxids = self.nodes[1].getaddresstxids({"addresses": ["rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti", "pcX1WHotKuQwFypDf1ZkJrh81J1DS7DfXd"]})
        ...
        txidsmany = self.nodes[1].getaddresstxids("rFHaEuXkYpNUYpMMY3kMkDdayQxpc7ozti")
