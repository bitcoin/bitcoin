...
class TxnMallTest(SyscoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 SYS:
        ...
        # First: use raw transaction API to send 12400 SYS to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 SYS coin each
        ...
        # Node0's balance should be starting balance, plus 500SYS for another
        ...
        # Node0's total balance should be starting balance, plus 100000SYS for
