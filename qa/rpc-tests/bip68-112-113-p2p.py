...
class BIP68_112_113Test(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        self.coinbase_blocks = self.nodes[0].wallet.generate(1 + 16 + 2*32 + 1) # 82 blocks generated for inputs
        ...
        inputblockhash = self.nodes[0].wallet.generate(1)[0] # 1 block generated for inputs to be in chain at height 572
