...
export NO_DEPENDS=1
export GOAL="install"
export TEST_RUNNER_EXTRA="--exclude interface_zmq_nevm,feature_deterministicmns,feature_llmq_is_retroactive,feature_llmqdkgerrors,feature_llmqconnections,feature_llmqsigning,feature_llmqsimplepose"
