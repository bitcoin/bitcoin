...
export TEST_RUNNER_EXTRA="--exclude feature_block,feature_llmqconnections,feature_llmqsigning,feature_llmqsimplepose"  # Low memory on Travis machines, exclude feature_block.
export GOAL="install"
