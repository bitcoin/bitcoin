...
export TEST_RUNNER_EXTRA="--exclude feature_block,feature_llmqsimplepose,feature_asset_zdag,feature_asset_verify_zdag"  # Low memory on Travis machines, exclude feature_block.
export GOAL="install"
