...
if [ -n "$QEMU_USER_CMD" ]; then
  ...
  export PACKAGES="$PACKAGES g++-s390x-linux-gnu qemu-user libc6:s390x libstdc++6:s390x libfontconfig1:s390x libxcb1:s390x libgmp3-dev:s390x libcurl4-gnutls-dev:s390x"
fi
