...
# [WIP] dropped -nostdlib++ to workaround compilation issues with using system-provided compiler-rt and libstdc++
# Related too: https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1005341
LIBCXX_FLAGS="-nostdinc++ -isystem ${LIBCXX_DIR}include/c++/v1 -L${LIBCXX_DIR}lib -Wl,-rpath,${LIBCXX_DIR}lib -lc++ -lc++abi -lpthread -Wno-unused-command-line-argument"
