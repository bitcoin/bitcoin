...
export PACKAGES="python3 nsis g++-mingw-w64-x86-64 wine-binfmt wine64 wine32 file libgmp3-dev:i386 curl:i386 libcurl4-gnutls-dev:i386"
export RUN_FUNCTIONAL_TESTS=false
export GOAL="deploy"
export SYSCOIN_CONFIG="--enable-reduce-exports --disable-gui-tests --disable-external-signer"
