...
export BITCOIN_CONFIG="--enable-gui --enable-reduce-exports --disable-miner --enable-external-signer CXXFLAGS='-Wno-return-type -Wno-error=maybe-uninitialized -Wno-error=array-bounds'"
