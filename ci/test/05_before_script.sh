...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Buttcoin
else
  DOCKER_EXEC echo \> \$HOME/.Buttcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/Buttcoin/Buttcoin/pull/18288#discussion_r433189350 for
  # details.
