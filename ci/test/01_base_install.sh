...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  cmake -G Ninja -B /msan/cxx_build/ \
    ...
    -DCMAKE_CXX_FLAGS="-D_LIBCPP_ABI_BOUNDED_ITERATORS -D_LIBCPP_ABI_BOUNDED_ITERATORS_IN_STRING -D_LIBCPP_ABI_BOUNDED_ITERATORS_IN_VECTOR -D_LIBCPP_ABI_BOUNDED_UNIQUE_PTR -D_LIBCPP_ABI_BOUNDED_ITERATORS_IN_STD_ARRAY" \
    -DLLVM_TARGETS_TO_BUILD=Native \
