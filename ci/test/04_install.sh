...
export ASAN_OPTIONS="suppressions=${BASE_ROOT_DIR}/test/sanitizer_suppressions/asan:detect_stack_use_after_return=1:check_initialization_order=1:strict_init_order=1"
