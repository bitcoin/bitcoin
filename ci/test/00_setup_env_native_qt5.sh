...
export TEST_RUNNER_EXTRA="--previous-releases --coverage --extended --exclude feature_block,feature_dbcrash,interface_zmq_nevm"  # Run extended tests so that coverage does not fail, but exclude the very slow dbcrash
