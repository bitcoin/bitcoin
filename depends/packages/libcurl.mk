...
$(package)_config_opts_mingw32=LIBS="-lcrypt32 -lnettle -lhogweed -lgmp" --without-nghttp2 LDFLAGS="-mwindows" CPPFLAGS="-DCURL_STATIC_LIB -DCURL_STATICLIB -static -DNGHTTP2_STATICLIB " CFLAGS="-DCURL_STATICLIB -DCURL_STATIC_LIB -DNGHTTP2_STATICLIB" --disable-shared --enable-static --disable-ftp --without-ssl --with-gnutls="$(PREFIX_DIR)" --disable-ntlm-wb --disable-file --disable-ldap --disable-ldaps --disable-rtsp --disable-dict --disable-telnet --disable-tftp --disable-pop3 --disable-imap --disable-smb --disable-smtp --disable-gopher --enable-proxy --without-ca-path --without-ca-bundle --with-ca-fallback
