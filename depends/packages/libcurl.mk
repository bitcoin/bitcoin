...
$(package)_config_opts_linux=LIBS="-lcrypt32 -lnettle -lhogweed -lgmp" --without-ssl --with-gnutls="$(PREFIX_DIR)" --enable-threaded-resolver

# mingw specific settings
$(package)_config_opts_mingw32=LIBS="-lcrypt32 -lnettle -lhogweed -lgmp" --without-ssl --with-gnutls="$(PREFIX_DIR)"

# darwin specific settings
$(package)_config_opts_darwin=--with-sysroot="$(DARWIN_SDK_PATH)" --with-darwinssl --without-ssl --enable-threaded-resolver
