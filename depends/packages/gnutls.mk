...
define $(package)_set_vars
  # default settings
  $(package)_config_opts_default=NETTLE_CFLAGS="-static" GMP_CFLAGS="-static" -static --disable-shared --enable-static --with-included-libtasn1 --with-included-unistring --enable-local-libopts --disable-non-suiteb-curves --disable-doc --without-p11-kit
