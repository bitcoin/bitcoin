...
This means one can have an always-on bitcreditd instance running, and another local bitcreditd/credits-qt instance which connects to this node and receives blocks from it.
