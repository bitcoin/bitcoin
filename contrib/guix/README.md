# Bootstrappable BitGreen Core Builds

This directory contains the files necessary to perform bootstrappable BitGreen
Core builds.
...
- 24GB of free disk space on the partition that the BitGreen Core git repository
  resides in
...
For a BitGreen Core depends development environment, simply invoke
...
From the top of a clean BitGreen Core repository:
...
To use dongcarl's substitute server for BitGreen Core builds after having
