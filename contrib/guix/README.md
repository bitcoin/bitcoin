# Bootstrappable XBit Core Builds

This directory contains the files necessary to perform bootstrappable XBit
Core builds.
...
- 24GB of free disk space on the partition that the XBit Core git repository
  resides in
...
For a XBit Core depends development environment, simply invoke
...
From the top of a clean XBit Core repository:
...
To use dongcarl's substitute server for XBit Core builds after having
