# Bootstrappable BTCSQ Core Builds

This directory contains the files necessary to perform bootstrappable BTCSQ
Core builds.
...
- 24GB of free disk space on the partition that the BTCSQ Core git repository
  resides in
...
For a BTCSQ Core depends development environment, simply invoke
...
From the top of a clean BTCSQ Core repository:
...
To use dongcarl's substitute server for BTCSQ Core builds after having
