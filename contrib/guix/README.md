...
This directory contains the files necessary to perform bootstrappable Snailcoin
Core builds.
...
To build Snailcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Snailcoin Core version being built.
