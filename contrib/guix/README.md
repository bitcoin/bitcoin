# Bootstrappable Buttcoin Core Builds

This directory contains the files necessary to perform bootstrappable Buttcoin
Core builds.
...
- 24GB of free disk space on the partition that the Buttcoin Core git repository
  resides in
...
For a Buttcoin Core depends development environment, simply invoke
...
From the top of a clean Buttcoin Core repository:
...
To use dongcarl's substitute server for Buttcoin Core builds after having
