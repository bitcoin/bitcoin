...
```
git clone https://codeberg.org/guix/guix-mirror.git
cd guix
```
...
2. `guix describe` should not print `guix describe: error: failed to determine
   ...
   Generation 38   Feb 22 2021 16:39:31    (current)
     guix f350df4
       repository URL: https://codeberg.org/guix/guix-mirror.git
...
[codeberg/guix@6ba1058](https://codeberg.org/guix/guix-mirror/commit/6ba1058df0c4ce5611c2367531ae5c3cdc729ab4)
