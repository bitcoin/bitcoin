...
=======
SIGNATUREFILE="http://downloads.sourceforge.net/project/crowncoin/Crowncoin/crowncoin-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/crowncoin/Crowncoin/"
VERSIONPREFIX="crowncoin-"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'crowncoin-',
...
=======
   echo "[crowncoin-]<version>-[rc[0-9]] (example: crowncoin-0.7.1-rc1)"
>>>>>>> origin/dirty-merge-dash-0.11.0
   echo "wget output:"
