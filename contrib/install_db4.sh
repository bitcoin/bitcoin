...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the Buttcoin repository."
  exit 1
fi
...
# See https://github.com/Buttcoin/Buttcoin/issues/16064
...
echo 'When compiling Buttcoind, run `./configure` in the following way:'
echo
