...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the xbit repository."
  exit 1
fi
...
# See https://github.com/xbit/xbit/issues/16064
...
echo 'When compiling xbitd, run `./configure` in the following way:'
echo
