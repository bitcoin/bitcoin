...
complete --command snailcoind --no-files

# Extract options
function __fish_snailcoind_get_options
...
complete \
    --command snailcoind \
    --arguments "(__fish_snailcoind_get_options --nofiles)"
