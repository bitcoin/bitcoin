...
complete --command naviod --no-files

# Extract options
function __fish_naviod_get_options
...
complete \
    --command naviod \
    --arguments "(__fish_naviod_get_options --nofiles)"
