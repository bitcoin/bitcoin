...
complete --command tortoisecoind --no-files

# Extract options
function __fish_tortoisecoind_get_options
...
complete \
    --command tortoisecoind \
    --arguments "(__fish_tortoisecoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command tortoisecoind \
...
complete \
    --command tortoisecoind \
    --arguments "(__fish_tortoisecoind_get_options --nofiles)"
