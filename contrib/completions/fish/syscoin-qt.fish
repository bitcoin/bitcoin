...
complete --command syscoin-qt --no-files

# Extract options
function __fish_syscoinqt_get_options
...
complete \
    --command syscoin-qt \
    --arguments "(__fish_syscoinqt_get_options --nofiles)"
