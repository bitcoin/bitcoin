...
complete --command britanniacoind --no-files

# Extract options
function __fish_britanniacoind_get_options
...
complete \
    --command britanniacoind \
    --arguments "(__fish_britanniacoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command britanniacoind \
...
complete \
    --command britanniacoind \
    --arguments "(__fish_britanniacoind_get_options --nofiles)"
