...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BRITANNIACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define BRITANNIACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the britanniacoin network\n')
    ...
    g.write('#endif // BRITANNIACOIN_CHAINPARAMSSEEDS_H\n')
