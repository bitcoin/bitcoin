#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Tortoisecoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of tortoisecoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple tortoisecoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple tortoisecoin ports', file=sys.stderr)
