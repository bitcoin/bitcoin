#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Widecoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of widecoin node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple widecoin ports', file=sys.stderr)
