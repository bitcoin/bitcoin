...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of britanniacoin node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple britanniacoin ports', file=sys.stderr)
