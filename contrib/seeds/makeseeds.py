#!/usr/bin/env python3
# Copyright (c) 2013-2020 The Buttcoin Core developers
...
def main():
    ...
    # Filter out hosts with multiple Buttcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple Buttcoin ports' % (ip_stats(ips)), file=sys.stderr)
