...
def connect_JSON(config):
    ...
    try:
        ...
        # but also make sure the bitcreditd we're talking to is/isn't testnet:
...
def create_tx(bitcreditd, fromaddresses, toaddress, amount, fee):
    ...
    # Decimals, I'm casting amounts to float before sending them to bitcreditd.
    #  
...
def main():
    ...
    if options.amount is None:
        ...
        txdata = create_tx(bitcreditd, options.fromaddresses.split(","), options.to, amount, fee)
