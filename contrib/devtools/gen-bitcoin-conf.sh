...
BITCOIND=${BITCOIND:-$BINDIR/snailcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/snailcoin.conf}
...
then
  ...
  echo -e "To safely generate a snailcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example snailcoin.conf file in share/examples/'
...
##
## snailcoin.conf configuration file.
...
# parse the output from snailcoind --help
