...
ARG_PATTERNS = {
    ...
    "DEFAULT_PREVOUTFETCH_THREADS": PatternOptions(include_path="kernel/chainstatemanager_opts.h"),
    ...
    "MAX_PREVOUTFETCH_THREADS": PatternOptions(include_path="node/settings.h"),
