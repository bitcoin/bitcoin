...
// Copyright (c) 2009-2012 The Liberta Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Liberta/$1-%s The Liberta/' %s"
REGEX_CURRENT= re.compile("%s The Liberta" % year)
