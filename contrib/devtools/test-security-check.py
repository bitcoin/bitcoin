...
class TestSecurityChecks(unittest.TestCase):
    def test_ELF(self):
        ...
        if arch == lief.ARCHITECTURES.X86:
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-zexecstack','-Wl,-znorelro','-no-pie','-fno-PIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed PIE NX RELRO FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-znorelro','-no-pie','-fno-PIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed PIE RELRO FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-znorelro','-no-pie','-fno-PIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed PIE RELRO FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-znorelro','-pie','-fPIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed RELRO FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,noseparate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed separate_code FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed FORTIFY CONTROL_FLOW'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,separate-code', '-fcf-protection=full', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed FORTIFY'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,separate-code', '-fcf-protection=full', '-D_FORTIFY_SOURCE=2']),
                    (0, ''))
        else:
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-zexecstack','-Wl,-znorelro','-no-pie','-fno-PIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed PIE NX RELRO FORTIFY'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-znorelro','-no-pie','-fno-PIE', '-Wl,-z,separate-code', '-U_FORTIFY_SOURCE']),
            ...
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,separate-code', '-fcf-protection=full', '-U_FORTIFY_SOURCE']),
                    (1, executable+': failed FORTIFY'))
            self.assertEqual(call_security_check(cc, source, executable, ['-Wl,-znoexecstack','-Wl,-zrelro','-Wl,-z,now','-pie','-fPIE', '-Wl,-z,separate-code', '-D_FORTIFY_SOURCE=2']),
                    (0, ''))
