...
BITCOIND=${BITCOIND:-$BINDIR/naviod}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/navio.conf}
...
then
  ...
  echo -e "To safely generate a navio.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example navio.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-navio-conf.sh.
##
...
# parse the output from naviod --help
