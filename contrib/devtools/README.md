...
Provides utilities for managing copyright headers of `The Snailcoin Core
...
---------------------------------------------------------
Updates all the copyright headers of `The Snailcoin Core developers` which were
changed in a year more recent than is listed. For example:
```
// Copyright (c) <firstYear>-<lastYear> The Snailcoin Core developers
```
will be updated to:
```
// Copyright (c) <firstYear>-<lastModifiedYear> The Snailcoin Core developers
```
...
those cases:
```
// Copyright (c) <year> The Snailcoin Core developers
```
will be updated to:
```
// Copyright (c) <year>-<lastModifiedYear> The Snailcoin Core developers
```
where the update is appropriate.

copyright\_header.py insert \<file\>
------------------------------------
Inserts a copyright header for `The Snailcoin Core developers` at the top of the
...
If the file already has a copyright for `The Snailcoin Core developers`, the
script will exit.
...
Generates a snailcoin.conf file in `share/examples/` by parsing the output from `snailcoind --help`. This script is run during the
release process to include a snailcoin.conf with the release binaries and can also be run by users to generate a file locally.
