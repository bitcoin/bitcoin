...
def main(args):
    ...
    if not success:
        print("widecoin.org failed to provide signature file, "
              "but widecoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("widecoin.org and widecoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Widecoin Core binary release "
