...
### [UTXO-to-CSV](/contrib/utxo-tools/utxo_to_csv.py) ###
Similar to utxo_to_sqlite.py, but outputs a CSV file with txid, vout, amount, height, coinbase,
scriptpubkey, and address/descriptor.
