...
Files used during the gitian build process. For more information about gitian, see the [the Syscoin Core documentation repository](https://github.com/syscoin/docs).
