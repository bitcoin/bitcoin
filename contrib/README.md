...
PGP keys used for signing Dobbscoin Core [Gitian release](/doc/release-process.md) results.

### [MacDeploy](/contrib/macdeploy) ###
Scripts and notes for Mac builds. 

### [RPM](/contrib/rpm) ###
RPM spec file for building bdobbscoin-core on RPM based distributions.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from dobbscoin.info.
