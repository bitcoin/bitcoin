...
```
$ python3 contrib/tracing/p2p_monitor.py ./src/tortoisecoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./src/tortoisecoind
```
...
```
$ ./src/tortoisecoind -signet -reindex
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./src/tortoisecoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/tortoisecoind
```
