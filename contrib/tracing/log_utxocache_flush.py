...
"""Example logging Widecoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/widecoind
...
def main(widecoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[widecoind_with_usdts])
