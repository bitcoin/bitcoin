...
def syscoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.syscoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = syscoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = syscoin_cli(['getnewaddress', 'faucet', 'bech32'])
