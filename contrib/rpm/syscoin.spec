...
#man pages
Source20:	https://raw.githubusercontent.com/syscoin/syscoin/v%{version}/doc/man/syscoind.1
Source21:	https://raw.githubusercontent.com/syscoin/syscoin/v%{version}/doc/man/syscoin-cli.1
Source22:	https://raw.githubusercontent.com/syscoin/syscoin/v%{version}/doc/man/syscoin-qt.1
...
CONFIG_FILE="%{_sysconfdir}/syscoincore/syscoin.conf"
...
%{_sbindir}/semanage port -a -t syscoin_port_t -p tcp 18443
%{_sbindir}/semanage port -a -t syscoin_port_t -p tcp 18444
...
%dir %attr(0750,syscoincore,syscoin) %{_sysconfdir}/syscoin
%dir %attr(0750,syscoincore,syscoin) %{_localstatedir}/lib/syscoin
