...
#
# Be aware that naviod and bitcoin-qt differ in terms of localization: Qt
# opts in to POSIX localization by running setlocale(LC_ALL, "") on startup,
# whereas no such call is made in naviod.
#
...
# C locale.
#
# In contrast, naviod does not opt in to localization -- no call to
# setlocale(LC_ALL, "") is made and the environment variables LC_* are
# thus ignored.
#
# This results in situations where naviod is guaranteed to be running
...
# call std::to_string(1.23) will return "1.230000" in naviod but
