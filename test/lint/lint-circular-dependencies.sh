...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "coinjoin/coinjoin -> llmq/quorums_instantsend -> wallet/wallet -> coinjoin/coinjoin"
    ...
    "coinjoin/coinjoin -> llmq/quorums_instantsend -> wallet/wallet -> wallet/coinselection -> coinjoin/coinjoin"
