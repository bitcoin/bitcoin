...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/syscoingui -> qt/utilitydialog -> qt/syscoingui"
    "qt/syscoingui -> qt/walletframe -> qt/syscoingui"
    "qt/syscoingui -> qt/walletview -> qt/syscoingui"
    ...
    "qt/addressbookpage -> qt/syscoingui -> qt/walletview -> qt/addressbookpage"
