...
* for `src/leveldb`: https://github.com/widecoin-core/leveldb.git (branch widecoin-fork)
* for `src/univalue`: https://github.com/widecoin-core/univalue.git (branch master)
