...
class TransactionTimeRescanTest(WidecoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine WCN and create transactions
        ...
        # generate some wcn to create transactions and check blockcount
        ...
        # send 10 wcn to user's first watch-only address
        self.log.info('Send 10 wcn to user')
        ...
        # send 5 wcn to our second watch-only address
        self.log.info('Send 5 wcn to user')
        ...
        # send 1 wcn to our third watch-only address
        self.log.info('Send 1 wcn to user')
