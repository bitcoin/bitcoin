...
class TransactionTimeRescanTest(RevoltTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine RVT and create transactions
        ...
        # generate some rvt to create transactions and check blockcount
        ...
        # send 10 rvt to user's first watch-only address
        self.log.info('Send 10 rvt to user')
        ...
        # send 5 rvt to our second watch-only address
        self.log.info('Send 5 rvt to user')
        ...
        # send 1 rvt to our third watch-only address
        self.log.info('Send 1 rvt to user')
