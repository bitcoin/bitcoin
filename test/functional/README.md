...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/Buttcoin/Buttcoin/pull/14884#discussion_r239585126).
...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the ButtcoinTestFramework, place overrides for the
...
The [`TestShell`](test-shell.md) class exposes the ButtcoinTestFramework
...
Test objects for interacting with a Buttcoind node over the p2p interface.
