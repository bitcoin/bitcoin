...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_wallet_reorg_during_background_sync(self, dump_output):
        ...
        # Reindex with an old mocktime so the snapshot has more work than the active chainstate.
        self.restart_node(n3.index, extra_args=[*self.extra_args[n3.index], "-reindex=1", "-mocktime=123"])
        ...
        self.wait_until(lambda: w_reorg.gettransaction(txid)['confirmations'] >= 1, timeout=60)
