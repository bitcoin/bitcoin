...
By default, snailcoind will dump mempool on shutdown and
...
class MempoolPersistTest(SnailcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent snailcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
