...
By default, bitcointalkcoind will dump mempool on shutdown and
...
class MempoolPersistTest(BitcointalkcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcointalkcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
