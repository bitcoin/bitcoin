...
class MempoolPersistTest(BritanniaCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent britanniacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
