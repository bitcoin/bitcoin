...
By default, talkcoind will dump mempool on shutdown and
...
class MempoolPersistTest(TalkcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent talkcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
