...
# TestP2PConn: A peer we use to send messages to microbitcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes microbitcoind to (reasonably!) disconnect us, so do this last.
    ...
    # microbitcoind's choice of nonce.
    ...
    # Test that microbitcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for microbitcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # microbitcoind will not send blocktxn responses for blocks whose height is
