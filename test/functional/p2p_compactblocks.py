...
# TestP2PConn: A peer we use to send messages to bitcointalkcoind, and store responses.
...
class CompactBlocksTest(BitcointalkcoinTestFramework):
    ...
    # This test actually causes bitcointalkcoind to (reasonably!) disconnect us, so do this last.
    ...
    # bitcointalkcoind's choice of nonce.
    ...
    # Test that bitcointalkcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcointalkcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # bitcointalkcoind will not send blocktxn responses for blocks whose height is
