...
# TestP2PConn: A peer we use to send messages to tortoisecoind, and store responses.
...
class CompactBlocksTest(TortoisecoinTestFramework):
    ...
    # This test actually causes tortoisecoind to (reasonably!) disconnect us, so do this last.
    ...
    # tortoisecoind's choice of nonce.
    ...
    # Test that tortoisecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for tortoisecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # tortoisecoind will not send blocktxn responses for blocks whose height is
