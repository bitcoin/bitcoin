...
class CompactBlocksTest(SyscoinTestFramework):
    ...
    # This test actually causes syscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that syscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for syscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # syscoind will not send blocktxn responses for blocks whose height is
