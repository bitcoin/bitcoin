...
"""Verify that starting xbit with -h works as expected."""

from test_framework.test_framework import XBitTestFramework
from test_framework.util import assert_equal

class HelpTest(XBitTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xbit with -h for help text")
        ...
        self.log.info("Start xbit with -version for version information")
        ...
        self.log.info("Start xbitd with -fakearg to make sure it does not start")
