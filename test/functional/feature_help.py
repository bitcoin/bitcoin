...
"""Verify that starting revolt with -h works as expected."""

from test_framework.test_framework import RevoltTestFramework
from test_framework.util import assert_equal

class HelpTest(RevoltTestFramework):
    ...
    def run_test(self):
        self.log.info("Start revolt with -h for help text")
        ...
        self.log.info("Start revolt with -version for version information")
        ...
        self.log.info("Start revoltd with -fakearg to make sure it does not start")
