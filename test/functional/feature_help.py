...
class HelpTest(BritanniaCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start britanniacoin with -h for help text")
        ...
        self.log.info("Start britanniacoin with -version for version information")
        ...
        self.log.info("Start britanniacoind with -fakearg to make sure it does not start")
