...
"""Verify that starting Buttcoin with -h works as expected."""

from test_framework.test_framework import ButtcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ButtcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Buttcoin with -h for help text")
        ...
        self.log.info("Start Buttcoin with -version for version information")
        ...
        self.log.info("Start Buttcoind with -fakearg to make sure it does not start")
