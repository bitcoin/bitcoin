...
"""Verify that starting syscoin with -h works as expected."""

from test_framework.test_framework import SyscoinTestFramework
from test_framework.util import assert_equal

class HelpTest(SyscoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start syscoin with -h for help text")
        ...
        self.log.info("Start syscoin with -version for version information")
        ...
        self.log.info("Start syscoind with -fakearg to make sure it does not start")
