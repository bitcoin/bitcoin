...
"""Verify that starting talkcoin with -h works as expected."""

from test_framework.test_framework import TalkcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TalkcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start talkcoin with -h for help text")
        ...
        self.log.info("Start talkcoin with -version for version information")
        ...
        self.log.info("Start talkcoind with -fakearg to make sure it does not start")
