...
"""Verify that starting bitcointalkcoin with -h works as expected."""

from test_framework.test_framework import BitcointalkcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcointalkcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcointalkcoin with -h for help text")
        ...
        self.log.info("Start bitcointalkcoin with -version for version information")
        ...
        self.log.info("Start bitcointalkcoind with -fakearg to make sure it does not start")
