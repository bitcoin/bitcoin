...
"""Verify that starting widecoin with -h works as expected."""

from test_framework.test_framework import WidecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(WidecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start widecoin with -h for help text")
        ...
        self.log.info("Start widecoin with -version for version information")
        ...
        self.log.info("Start widecoind with -fakearg to make sure it does not start")
