...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_doublespend_chain(self):
        ...
        initial_nValue = btcToSat(5)
        tx0_outpoint = self.make_utxo(self.nodes[0], initial_nValue)

        prevout = tx0_outpoint
        remaining_value = initial_nValue
        chain_txids = []
        while remaining_value > btcToSat(1):
            remaining_value -= btcToSat(0.1)
        ...
        dbl_tx.vout[0].nValue = btcToSat(0.1)
        dbl_tx_hex = dbl_tx.serialize().hex()
    ...
    def test_doublespend_tree(self):
        ...
        dbl_tx_hex = self.wallet.create_self_transfer(
            utxo_to_spend=tx0_outpoint,
            sequence=0,
            fee=satToBtc(fee) * n + Decimal("0.1"),
        )["hex"]
        self.nodes[0].sendrawtransaction(dbl_tx_hex, 0)
    ...
    def test_replacement_feeperkb(self):
        ...
        tx0_outpoint = self.make_utxo(self.nodes[0], btcToSat(1.1))
    ...
    def test_spends_of_conflicting_outputs(self):
        ...
        utxo1 = self.make_utxo(self.nodes[0], btcToSat(1.2))
        utxo2 = self.make_utxo(self.nodes[0], btcToSat(3))
        ...
        tx2_hex = self.wallet.create_self_transfer_multi(
            ...
            sequence=0,
            amount_per_output=btcToSat(tx1a_utxo["value"]),
        )["hex"]
    ...
    def test_new_unconfirmed_inputs(self):
        ...
        confirmed_utxo = self.make_utxo(self.nodes[0], btcToSat(1.1))
        unconfirmed_utxo = self.make_utxo(self.nodes[0], btcToSat(0.1), confirmed=False)
    ...
    def test_prioritised_transactions(self):
        ...
        tx1b_hex = self.wallet.create_self_transfer_multi(
            ...
            sequence=0,
            num_outputs=100,
            amount_per_output=btcToSat(0.00001),
        )["hex"]
        ...
        self.nodes[0].prioritisetransaction(txid=tx1a_txid, fee_delta=btcToSat(-0.1))
        ...
        tx1_outpoint = self.make_utxo(self.nodes[0], btcToSat(1.1))
        ...
        self.nodes[0].prioritisetransaction(txid=tx2b["txid"], fee_delta=btcToSat(0.1))
    ...
    def test_fullrbf(self):
        ...
        confirmed_utxo = self.make_utxo(self.nodes[0], btcToSat(2))
