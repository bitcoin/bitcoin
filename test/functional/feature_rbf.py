...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}, not enough additional fees to relay; 0.00 < 0.00000104"
    ...
    def test_too_many_replacements(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {double_tx.hash}; too many conflicting clusters ({MAX_REPLACEMENT_LIMIT + 1} > {MAX_REPLACEMENT_LIMIT})"
