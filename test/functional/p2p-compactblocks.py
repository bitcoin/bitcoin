...
# TestNode: A peer we use to send messages to flowd, and store responses.
...
class CompactBlocksTest(FlowTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes flowd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that flowd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for flowd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # flowd will not send blocktxn responses for blocks whose height is
