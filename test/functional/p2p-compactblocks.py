...
# TestNode: A peer we use to send messages to iopd, and store responses.
...
class CompactBlocksTest(IoPTestFramework):
    ...
    # This test actually causes iopd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that iopd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for iopd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # iopd will not send blocktxn responses for blocks whose height is
