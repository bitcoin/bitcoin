...
class AddressTypeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for explicit_type, multisig, from_node in itertools.product([False, True], do_multisigs, range(4)):
            ...
            to_send = (old_balances[from_node] / (100 + 1)).quantize(Decimal("0.00000001"))  # ITCOIN_SPECIFIC: replaced COINBASE_MATURITY with hardcoded 100 (i.e. just a large number)
            sends = {}
            addresses = {}
