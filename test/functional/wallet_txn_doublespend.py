...
class TxnMallTest(SnailcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 SNAIL:
        ...
        # First: use raw transaction API to send 1240 SNAIL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SNAIL coin each
        ...
        # Node0's balance should be starting balance, plus 50SNAIL for another
        ...
        # Node0's total balance should be starting balance, plus 100SNAIL for
