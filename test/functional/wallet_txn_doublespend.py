...
class TxnMallTest(RevoltTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 RVT:
        ...
        # First: use raw transaction API to send 1240 RVT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RVT coin each
        ...
        # Node0's balance should be starting balance, plus 50RVT for another
        ...
        # Node0's total balance should be starting balance, plus 100RVT for
