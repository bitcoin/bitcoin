...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def test_wallet_with_relative_path(self):
        self.log.info("Test that a wallet cannot be specified by relative path")
        ...
        assert_raises_rpc_error(-4, "Wallet name given as a relative path cannot begin with ./ or ../", self.master_node.migratewallet, relative_name)
