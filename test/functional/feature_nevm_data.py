...
class NEVMDataTest(DashTestFramework):
    ...
    def basic_nevm_data(self):
        ...
        self.wait_for_chainlocked_block(self.nodes[0], tip)
        self.wait_for_chainlocked_block(self.nodes[1], tip)
        self.wait_for_chainlocked_block(self.nodes[2], tip)
        self.wait_for_chainlocked_block(self.nodes[3], tip)
