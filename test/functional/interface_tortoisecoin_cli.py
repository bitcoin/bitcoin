...
class TestTortoisecoinCli(TortoisecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `tortoisecoin-cli getblockchaininfo`")
        ...
        # Prevent tortoisecoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and tortoisecoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and tortoisecoin-cli getwalletinfo return expected wallet info")
            ...
            # Test tortoisecoin-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test tortoisecoin-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestTortoisecoinCli(__file__).main()
