...
class P2PPermissionsTests(ButtcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].Buttcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].Buttcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
