...
Verify that a widecoind node can use an external signer command.
...
class RPCSignerTest(WidecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart widecoind with -signer=<cmd>',
