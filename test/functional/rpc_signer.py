...
Verify that a snailcoind node can use an external signer command.
...
class RPCSignerTest(SnailcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart snailcoind with -signer=<cmd>',
