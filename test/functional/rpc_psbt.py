...
class PSBTTest(SyscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test walletcreatefundedpsbt feeRate of 0.1 SYS/kB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
        ...
        self.log.info("Test walletcreatefundedpsbt feeRate of 10 SYS/kB produces total fee well above -maxtxfee and raises RPC error")
        ...
        # SYSCOIN TODO: update values so moneyrange fails in psbt 21m vs 888m
        #assert_equal(analysis['next'], 'creator')
