...
class AssetNotaryTest(SyscoinTestFramework):
    ...
    def basic_asset(self):
        ...
        self.asset = self.nodes[0].assetnew('1', 'TST', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address, '', notary, {})['asset_guid']
        self.sync_mempools()
        self.nodes[0].generate(1)
        self.sync_blocks()
    ...
    def complex_notary(self):
        ...
        self.asset0 = self.nodes[0].assetnew('1', 'TST0', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address0, '', notary, {})['asset_guid']
        self.asset1 = self.nodes[0].assetnew('1', 'TST1', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address1, '', notary, {})['asset_guid']
        self.asset2 = self.nodes[0].assetnew('1', 'TST2', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address2, '', notary, {})['asset_guid']
        self.asset3 = self.nodes[0].assetnew('1', 'TST3', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address3, '', notary, {})['asset_guid']
        self.asset4 = self.nodes[0].assetnew('1', 'TST4', 'asset description', '0x', 8, 1000, 10000, 255, self.notary_address4, '', notary, {})['asset_guid']
        self.asset5 = self.nodes[0].assetnew('1', 'TST4', 'asset description', '0x', 8, 1000, 10000, 255, '', '', {}, {})['asset_guid']
        self.nodes[0].generate(1)
        ...
        assert(out[0]['asset_amount'] == int(0.5*COIN) or out[1]['asset_amount'] == int(0.5*COIN))
        ...
        assert_equal(len(out), 2)
        assert(out[0]['asset_amount'] == int(1.5*COIN) or out[1]['asset_amount'] == int(1.5*COIN))
