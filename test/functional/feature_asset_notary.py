...
class AssetNotaryTest(SyscoinTestFramework):
    ...
    def complex_notary(self):
        ...
        assert_equal(out[0]['asset_amount'], 0)
        assert_equal(out[1]['asset_guid'], self.asset2)
        ...
        assert_equal(out[0]['asset_amount'], 0)
        assert_equal(out[1]['asset_guid'], self.asset3)
        assert_equal(out[1]['asset_amount'], int(1*COIN))
        out =  self.nodes[0].listunspent(query_options={'assetGuid': self.asset4})
        assert_equal(len(out), 2)
        assert_equal(out[0]['asset_guid'], self.asset4)
        assert_equal(out[0]['asset_amount'], 0)
        assert_equal(out[1]['asset_guid'], self.asset4)
        ...
        assert_equal(out[0]['asset_amount'], 0)
        assert_equal(out[1]['asset_guid'], self.asset5)
        assert_equal(out[1]['asset_amount'], int(1*COIN))
        # check receiver node
