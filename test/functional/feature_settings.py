...
class SettingsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(0)
        default_settings = {"_warning_": "This file is automatically generated and updated by Bitcoin Inquisition. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
        with settings.open() as fp:
            actual_settings = json.load(fp)
            # don't seem to be able to change MSVC builds from setting PACKAGE_NAME to Bitcoin Core??
            if "Bitcoin Core" in actual_settings.get("_warning_", ""):
                 actual_settings["_warning_"] = actual_settings["_warning_"].replace("Bitcoin Core", "Bitcoin Inquistion", 1)
            assert_equal(actual_settings, default_settings)
