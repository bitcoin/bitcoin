...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The snailcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(SnailcoinTestFramework):
    ...
    def run_test(self):
        ...
        # snailcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that snailcoind sends its own version prior to processing
