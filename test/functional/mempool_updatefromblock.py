...
CUSTOM_DESCENDANT_COUNT = 100
CUSTOM_ANCESTOR_COUNT = CUSTOM_DESCENDANT_COUNT
...
class MempoolUpdateFromBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.transaction_graph_test(size=CUSTOM_DESCENDANT_COUNT, n_tx_to_mine=[25, 50, 75])
