...
class WalletCrossChain(RevoltTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].revoltconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].revoltconf, 'w', encoding='utf8') as conf:
