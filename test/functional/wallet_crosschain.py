...
class WalletCrossChain(WidecoinTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].widecoinconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].widecoinconf, 'w', encoding='utf8') as conf:
