...
class AssetTest(SyscoinTestFramework):
    ...
    def asset_maxsupply(self):
        ...
        assert_raises_rpc_error(-3, 'Invalid amount', self.nodes[0].assetnew, '1', 'TST', gooddata, '0x', 0, maxUint, maxUint+1, 31, '', {}, {})
        assert_raises_rpc_error(-3, 'Invalid amount', self.nodes[0].assetnew, '1', 'TST', gooddata, '0x', 0, maxUint+1, maxUint+1, 31, '', {}, {})
