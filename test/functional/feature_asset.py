...
class AssetTest(SyscoinTestFramework):
    ...
    def asset_description_too_big(self):
        # 750 + 18 byte overhead for pub data descriptor and json = 768 bytes long (1024 bytes base64 encoded)
        gooddata = ""
    ...
    def asset_transfer(self):
        ...
        assert_raises_rpc_error(-4, 'No inputs found for this asset', self.nodes[0].assetupdate, asset0, '', '', 0, 31, '', {}, {})
        assert_raises_rpc_error(-4, 'No inputs found for this asset', self.nodes[1].assetupdate, asset1, '', '', 0, 31, '', {}, {})
        self.sync_mempools()
        self.nodes[0].generate(1)
        self.sync_blocks()
        assert_raises_rpc_error(-4, 'No inputs found for this asset', self.nodes[0].assetupdate, asset0, '', '', 0, 31, '', {}, {})
