...
class FeatureBlockfilterindexPruneTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        wait_until(lambda: self.nodes[1].getindexinfo() == {'basic block filter index': {'synced': True, 'best_block_height': 200}})
        ...
        self.nodes[1].generate(250)
        self.sync_all()
        wait_until(lambda: self.nodes[1].getindexinfo() == {'basic block filter index': {'synced': True, 'best_block_height': 700}})
