...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_submitpackage(self):
        ...
        assert_raises_rpc_error(-22, "TX decode failed for tx 0. TX decode failed. Make sure the transaction is complete, correctly serialized, hex-encoded, and has at least one input.", node.submitpackage, hex_list)
