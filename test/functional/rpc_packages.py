...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def test_independent(self, coin):
        ...
        testres_bad = self.independent_txns_testres_blank + [{"txid": tx.hash, "wtxid": tx.getwtxid(), "allowed": False, "reject-reason": "missing-inputs"}]
        ...
        tx_bad_sig_txid = tx_bad_sig.hash
    ...
    def test_chain(self):
        ...
        assert_equal(node.testmempoolaccept(rawtxs=chain_hex[::-1]),
                [{"txid": tx.hash, "wtxid": tx.getwtxid(), "package-error": "package-not-sorted"} for tx in chain_txns[::-1]])
    ...
    def test_submit_child_with_parents(self, num_parents, partial_submit):
        ...
        for package_txn in package_txns:
            ...
            assert_equal(tx_result["txid"], tx.hash)
