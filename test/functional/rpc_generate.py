...
class RPCGenerateTest(BitcoinTestFramework):
    ...
    def test_generateblock(self):
        ...
        invalid_raw_tx = '0000'
        assert_raises_rpc_error(-22, 'TX decode failed for tx 0. TX decode failed. Make sure the transaction is complete, correctly serialized, hex-encoded, and has at least one input.', self.generateblock, node, address, [invalid_raw_tx])
