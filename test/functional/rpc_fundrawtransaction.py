...
class RawTransactionsTest(SyscoinTestFramework):
    ...
    def test_option_feerate(self):
        ...
        result1 = node.fundrawtransaction(rawtx, {"fee_rate": 2 * sys_kvb_to_sat_vb * self.min_relay_tx_fee})
        ...
        assert_raises_rpc_error(-8, "Invalid feeRate 0.00000000 SYS/kvB (must be greater than 0)",
