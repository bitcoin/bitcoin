...
class PortTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with node.assert_debug_log(expected_msgs=[f'Bound to and listening at 0.0.0.0:{port1}', f'Bound to and listening at 127.0.0.1:{port1 + 1}']):
        ...
        with node.assert_debug_log(expected_msgs=[f'Bound to and listening at 0.0.0.0:{port2}', f'Bound to and listening at 127.0.0.1:{port2 + 1}'], unexpected_msgs=[f'Bound to and listening at 0.0.0.0:{port1}']):
        ...
        with node.assert_debug_log(expected_msgs=[f'Bound to and listening at 0.0.0.0:{port2}'], unexpected_msgs=[f'Bound to and listening at 0.0.0.0:{port1}']):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=[f'Bound to and listening at 0.0.0.0:{port1}']):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=[f'Bound to and listening at 127.0.0.1:{port1 + 1}']):
