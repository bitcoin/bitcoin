...
class MempoolAcceptanceTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        txid_0 = tx.txid_hex
        self.check_mempool_result(
            result_expected=[{'txid': txid_0, 'allowed': True, 'vsize_adjusted': tx.get_vsize(),  'vsize': tx.get_vsize(),'fees': {'base': fee}}],
            rawtxs=[raw_tx_0],
        )
        ...
        self.check_mempool_result(
            result_expected=[{'txid': tx.txid_hex, 'allowed': True, 'vsize_adjusted': tx.get_vsize(), 'vsize': tx.get_vsize(), 'fees': {'base': fee_expected}}],
        ...
        txid_0 = tx.txid_hex
        self.check_mempool_result(
            result_expected=[{'txid': txid_0, 'allowed': True, 'vsize_adjusted': tx.get_vsize(), 'vsize': tx.get_vsize(), 'fees': {'base': (2 * fee)}}],
            rawtxs=[raw_tx_0],
        )
        ...
        self.check_mempool_result(
            result_expected=[{'txid': tx.txid_hex, 'allowed': True, 'vsize_adjusted': tx.get_vsize(), 'vsize': tx.get_vsize(), 'fees': { 'base': Decimal('0.1') - Decimal('0.05')}}],
            rawtxs=[tx.serialize().hex()],
            maxfeerate=0,
        )
        ...
        self.check_mempool_result(
            result_expected=[{'txid': tx.txid_hex, 'allowed': True, 'vsize_adjusted': tx.get_vsize(), 'vsize': tx.get_vsize(), 'fees': {'base': Decimal('0.05')}}],
            rawtxs=[tx.serialize().hex()],
            maxfeerate=0
        )
        ...
        self.check_mempool_result(
            result_expected=[{"txid": tx.txid_hex, "allowed": True, "vsize_adjusted": tx.get_vsize(), "vsize": tx.get_vsize(), "fees": {"base": Decimal("0.05000026")}}],
            rawtxs=[tx.serialize().hex()],
        )
        ...
        self.check_mempool_result(
            result_expected=[{'txid': tx.txid_hex, 'allowed': True, 'vsize_adjusted': tx.get_vsize(), 'vsize': tx.get_vsize(), 'fees': { 'base': Decimal('0.00001000')}}],
            rawtxs=[tx.serialize().hex()],
            maxfeerate=0,
        )
        ...
        self.check_mempool_result(
            result_expected=[{'txid': anchor_spend.txid_hex, 'allowed': True, 'vsize_adjusted': anchor_spend.get_vsize(), 'vsize': anchor_spend.get_vsize(), 'fees': { 'base': Decimal('0.00000700')}}],
        ...
        self.check_mempool_result(
            result_expected=[{'txid': tx_spend.txid_hex, 'allowed': True, 'vsize_adjusted': tx_spend.get_vsize(), 'vsize': tx_spend.get_vsize(), 'fees': { 'base': Decimal('0.00000700')}}],
