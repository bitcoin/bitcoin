...
class AssetBurnTest(SyscoinTestFramework):
    ...
    def basic_burn_syscoin(self):
        ...
        assert_raises_rpc_error(-20, 'Failed to read from asset DB', self.nodes[1].assetallocationburn(self.asset, newaddress, int(0.6*COIN), '0x931d387731bbbc988b312206c74f77d004d6b84b'))
        self.nodes[1].assetallocationburn(self.asset, newaddress, int(0.5*COIN), '0x931d387731bbbc988b312206c74f77d004d6b84b')
        self.nodes[0].generate(1)
        out =  self.nodes[1].listunspent(query_options={'assetGuid': self.asset})
