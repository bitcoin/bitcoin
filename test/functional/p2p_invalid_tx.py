...
class InvalidTxRequestTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx_withhold.vout = [CTxOut(nValue=btc_to_sat(25) - 12000, scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE)] * 2
        tx_withhold.calc_sha256()

        # Our first orphan tx with some outputs to create further orphan txs
        tx_orphan_1 = CTransaction()
        tx_orphan_1.vin.append(CTxIn(outpoint=COutPoint(tx_withhold.sha256, 0)))
        tx_orphan_1.vout = [CTxOut(nValue=btc_to_sat(8), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE)] * 3
        tx_orphan_1.calc_sha256()

        # A valid transaction with low fee
        tx_orphan_2_no_fee = CTransaction()
        tx_orphan_2_no_fee.vin.append(CTxIn(outpoint=COutPoint(tx_orphan_1.sha256, 0)))
        tx_orphan_2_no_fee.vout.append(CTxOut(nValue=btc_to_sat(8), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))

        # A valid transaction with sufficient fee
        tx_orphan_2_valid = CTransaction()
        tx_orphan_2_valid.vin.append(CTxIn(outpoint=COutPoint(tx_orphan_1.sha256, 1)))
        tx_orphan_2_valid.vout.append(CTxOut(nValue=btc_to_sat(8) - 12000, scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        tx_orphan_2_valid.calc_sha256()

        # An invalid transaction with negative fee
        tx_orphan_2_invalid = CTransaction()
        tx_orphan_2_invalid.vin.append(CTxIn(outpoint=COutPoint(tx_orphan_1.sha256, 2)))
        tx_orphan_2_invalid.vout.append(CTxOut(nValue=btc_to_sat(11), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        for i in range(len(orphan_tx_pool)):
            ...
            orphan_tx_pool[i].vout.append(CTxOut(nValue=btc_to_sat(11), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        rejected_parent.vout.append(CTxOut(nValue=btc_to_sat(11), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        tx_withhold_until_block_A.vout = [CTxOut(nValue=btc_to_sat(12), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE)] * 2
        ...
        tx_orphan_include_by_block_A.vout.append(CTxOut(nValue=btc_to_sat(12) - 12000, scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        tx_withhold_until_block_B.vout.append(CTxOut(nValue=btc_to_sat(11), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        tx_orphan_include_by_block_B.vout.append(CTxOut(nValue=btc_to_sat(10), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
        ...
        tx_orphan_conflict_by_block_B.vout.append(CTxOut(nValue=btc_to_sat(9), scriptPubKey=SCRIPT_PUB_KEY_OP_TRUE))
