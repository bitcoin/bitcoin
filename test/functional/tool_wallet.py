#!/usr/bin/env python3
# Copyright (c) 2018-2022 The Snailcoin Core developers
...
class ToolWalletTest(SnailcoinTestFramework):
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.snailcoin_wallet_process(*args)
    ...
    def do_tool_createfromdump(self, wallet_name, dumpfile):
        ...
        self.assert_tool_output("The dumpfile may contain private keys. To ensure the safety of your Snailcoin, do not share the dumpfile.\n", '-wallet={}'.format(wallet_name), '-dumpfile={}'.format(rt_dumppath), 'dump')
