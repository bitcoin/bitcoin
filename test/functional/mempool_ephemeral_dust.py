...
class EphemeralDustTest(BitcoinTestFramework):
    ...
    def test_reorgs(self):
        ...
        # Prepare a fork with empty blocks to not use invalidate directly
        fork_blocks = self.generate(self.nodes[0], 10, sync_fun=self.no_op)
