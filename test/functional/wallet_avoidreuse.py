...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_persistence(self):
        ...
        assert_equal(sorted(self.nodes[0].getwalletinfo()["flags"]), sorted(["descriptor_wallet", "last_hardened_xpub_cached", "seeds_stored"]))
        assert_equal(self.nodes[1].getwalletinfo()["avoid_reuse"], True)
        assert_equal(sorted(self.nodes[1].getwalletinfo()["flags"]), sorted(["descriptor_wallet", "last_hardened_xpub_cached", "seeds_stored", "avoid_reuse"]))
