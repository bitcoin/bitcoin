...
class EstimateFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.usecli:
            ...
            assert_raises_rpc_error(-3, "JSON value of type number is not of expected type bool", self.nodes[0].estimatesmartfee, 1, 'ECONOMICAL', 1, 1)
        ...
        # extra params
        assert_raises_rpc_error(-1, "estimatesmartfee", self.nodes[0].estimatesmartfee, 1, 'ECONOMICAL', 1, True, 1)
