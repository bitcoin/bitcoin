...
class ImportDescriptorsTest(SyscoinTestFramework):
    ...
    def run_test(self):
        ...
        # SYSCOIN
        assert_equal(addr, 'bcrt1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqn6mvr9') # Derived at m/84'/57'/0'/1
