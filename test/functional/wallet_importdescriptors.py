...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def import_descriptor_scan_utxo_flag_test(self, node, miner_wallet):
        ...
        assert_equal(info_now_scan.get('utxo_check'), 'matched')
        ...
        assert_equal(info_ts_scan.get('utxo_check'), 'matched')
    ...
    def run_test(self):
        ...
        self.import_descriptor_scan_utxo_flag_test(self.nodes[1], miner_wallet)
