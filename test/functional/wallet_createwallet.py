...
class CreateWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for invalid_name in ["w0\ninvalid", "w0\x7finvalid"]:
            assert_raises_rpc_error(-8, "Wallet name cannot contain control characters", self.nodes[0].createwallet, invalid_name)
