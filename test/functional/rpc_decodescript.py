...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_miniscript(self):
        ...
        # Unspendable Miniscript (`or_i(0,0)`)
        res = self.nodes[0].decodescript("6300670068")
        assert res["segwit"]["desc"] == "wsh(raw(6300670068))#0tunxae8"  # FIXME wsh(raw()) doesn't exist. See PR #28067
