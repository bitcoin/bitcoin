...
# ITCOIN_SPECIFIC: changed 100 to 0 in the COINBASE_MATURITY value in the following comment
#
# The block reward of coinbaseoutput.nValue (50) BTC/block matures after
# COINBASE_MATURITY (0) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTC/block.
BLOCKS = COINBASE_MATURITY + 1
BALANCE = (BLOCKS - COINBASE_MATURITY) * 50  # ITCOIN_SPECIFIC: replaced hardcoded 100 with COINBASE_MATURITY, this could be upstreamed
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_specified_wallet_compiled():
            ...
            amounts = [BALANCE + Decimal(10), Decimal(9), Decimal(31)]  # ITCOIN_SPECIFIC: changed form Decimal(9.999928) to Decimal(10): the transaction fee collected by node0 by the subsequent generate is already matured and is added to its balance
