...
class WalletTest(SnailcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SNAIL from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SNAIL with subtract fee from amount
        ...
        # Sendmany 10 SNAIL with subtract fee from amount
        ...
        # Sendmany 5 SNAIL to two addresses with subtracting fee from both addresses
