...
challenge based on a tweaked FROST pubkey
"""
...
class SignetChallengeTaprootFrostPubkeyTweaked(BaseFrostTest):
    def set_test_params(self):
        self.num_nodes = 4
        self.signet_num_signers = 4
        self.signet_num_signatures = 3
        super().set_test_params(tweak_public_key=True)
...
if __name__ == '__main__':
    SignetChallengeTaprootFrostPubkeyTweaked().main()
