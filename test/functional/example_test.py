#!/usr/bin/env python3
# Copyright (c) 2017 The IoP Core developers
...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the IoPTestFramework
    pass

class ExampleTest(IoPTestFramework):
    # Each functional test is a subclass of the IoPTestFramework class.
    ...
    def custom_method(self):
        ...
        IoPTestFramework class so other tests can use it."""
