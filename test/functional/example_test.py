...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the WidecoinTestFramework
    pass


class ExampleTest(WidecoinTestFramework):
    # Each functional test is a subclass of the WidecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        WidecoinTestFramework class so other tests can use it."""
