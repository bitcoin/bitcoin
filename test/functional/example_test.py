...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the XBitTestFramework
    pass


class ExampleTest(XBitTestFramework):
    # Each functional test is a subclass of the XBitTestFramework class.
    ...
    def custom_method(self):
        ...
        XBitTestFramework class so other tests can use it."""
