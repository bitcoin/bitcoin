...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SnailcoinTestFramework
    pass


class ExampleTest(SnailcoinTestFramework):
    # Each functional test is a subclass of the SnailcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SnailcoinTestFramework class so other tests can use it."""
