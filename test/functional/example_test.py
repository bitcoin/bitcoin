...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RevoltTestFramework
    pass


class ExampleTest(RevoltTestFramework):
    # Each functional test is a subclass of the RevoltTestFramework class.
    ...
    def custom_method(self):
        ...
        RevoltTestFramework class so other tests can use it."""
