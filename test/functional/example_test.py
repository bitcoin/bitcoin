...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ButtcoinTestFramework
    pass


class ExampleTest(ButtcoinTestFramework):
    # Each functional test is a subclass of the ButtcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ButtcoinTestFramework class so other tests can use it."""
