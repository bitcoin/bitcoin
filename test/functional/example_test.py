...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TortoisecoinTestFramework
    pass


class ExampleTest(TortoisecoinTestFramework):
    # Each functional test is a subclass of the TortoisecoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TortoisecoinTestFramework class so other tests can use it."""
