...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `navio-cli getblockchaininfo`")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and navio-cli getwalletinfo return expected wallet info")
