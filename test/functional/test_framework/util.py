...
# SYSCOIN timeout
def wait_until_helper(predicate, *, attempts=float('inf'), timeout=float('inf'), lock=None, timeout_factor=1.6):
...
def copy_datadir(from_node, to_node, dirname):
    ...
    dirs = ["blocks", "chainstate", "evodb", "llmq", "ethereumminttx", "ethereumtxroots", "assets", "dbblockindex"]
    for d in dirs:
        try:
