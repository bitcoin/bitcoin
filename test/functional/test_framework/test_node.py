...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, factor, syscoind, syscoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        """
        Kwargs:
