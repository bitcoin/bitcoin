...
class DashTestFramework(SyscoinTestFramework):
    ...
    def wait_for_chainlocked_block_all_nodes(self, block_hash, timeout=300):
    ...
    def wait_for_sporks_same(self, timeout=300):
    ...
    def wait_for_quorum_list(self, quorum_hash, nodes, timeout=600, sleep=1):
        def wait_func():
