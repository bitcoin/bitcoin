    ...
    def _initialize_chain(self):
        ...
        if not os.path.isdir(cache_node_dir):
            ...
            for entry in os.listdir(cache_path()):
                if entry not in ['chainstate', 'blocks', 'indexes', 'nevmminttx', 'nevmtxroots', 'geth', 'dbblockindex', 'llmq', 'evodb_dmn', 'evodb_qc', 'evodb_qc', 'evodb_qvvecs', 'evodb_qsk', 'nevmdata']:  # Only keep chainstate and blocks folder
