    ...
    def _initialize_chain(self):
        ...
        if not os.path.isdir(cache_node_dir):
            ...
            for entry in os.listdir(cache_path()):
                if entry not in ['chainstate', 'blocks', 'indexes', 'ethereumminttx', 'ethereumtxroots', 'geth', 'dbblockindex', 'asset', 'assetnft', 'llmq', 'evodb']:  # Only keep chainstate and blocks folder
