...
class TestShell:
    """Wrapper Class for XBitTestFramework.

    The TestShell class extends the XBitTestFramework
    ...
    class __TestShell(XBitTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by XBitTestFramework child class.
            self.num_nodes = 1
