...
class TestShell:
    """Wrapper Class for RevoltTestFramework.

    The TestShell class extends the RevoltTestFramework
    ...
    class __TestShell(RevoltTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by RevoltTestFramework child class.
            self.num_nodes = 1
