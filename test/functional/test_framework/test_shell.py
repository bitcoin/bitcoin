...
class TestShell:
    """Wrapper Class for ButtcoinTestFramework.

    The TestShell class extends the ButtcoinTestFramework
    ...
    class __TestShell(ButtcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ButtcoinTestFramework child class.
            self.num_nodes = 1
