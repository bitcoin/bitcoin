...
MAX_NEVM_DATA_BLOB = 3276800
NEVM_DATA_SCALE_FACTOR = 100
MAX_BLOCK_SERIALIZED_SIZE = MAX_BLOCK_WEIGHT + (32 * 1024 * 1024)
WITNESS_SCALE_FACTOR = 4
MAX_NEVM_DATA_BLOCK = (MAX_BLOCK_WEIGHT/WITNESS_SCALE_FACTOR)*NEVM_DATA_SCALE_FACTOR
    ...
    def __repr__(self):
        return 'msg_version(nVersion=%i nServices=%i nTime=%s addrTo=%s addrFrom=%s nNonce=0x%016X strSubVer=%s nStartingHeight=%i nRelay=%i, receivedMNAuthChallenge=%064x, fOtherMasternode=%i)' \
            % (self.nVersion, self.nServices, time.ctime(self.nTime),
               ...
               self.strSubVer, self.nStartingHeight, self.relay, self.receivedMNAuthChallenge, self.fOtherMasternode)
