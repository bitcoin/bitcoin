...
class BytesPerSigOpTest(BitcoinTestFramework):
    ...
    def test_sigops_limit(self, bytes_per_sigop, num_sigops):
        ...
        entry_child = self.nodes[0].getmempoolentry(tx.hash)
        ...
        entry_parent = self.nodes[0].getmempoolentry(parent_tx.hash)
    ...
    def test_sigops_package(self):
        ...
        assert tx_parent.hash in self.nodes[0].getrawmempool()
