...
import RPC call and node 0 sends FLW to it. Then other nodes import the
...
In the second part of the test, node 0 sends more FLW to each address, and the
...
class ImportRescanTest(FlowTestFramework):
    def __init__(self):
        super().__init__()
