...
# Fee rates (in SYS per 1000 vbytes)
...
class BumpFeeTest(SyscoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for unit, fee_rate in {"SAT/B": 100, "SYS/KB": NORMAL}.items():
        ...
        for mode in ["unset", "economical", "conservative", BTC_MODE, SAT_MODE]:
            ...
            for k, v in {"string": "", "object": {"foo": "bar"}}.items():
                ...
                assert_raises_rpc_error(-8, "Invalid fee_rate 0.00000000 SYS/kB (must be greater than 0)",
...
def test_simple_bumpfee_succeeds(self, mode, rbf_node, peer_node, dest_address):
    ...
    if mode == "fee_rate":
        ...
        sat_fee = NORMAL * COIN / 1000  # convert NORMAL from SYS/kB to sat/B
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 0.00350250 SYS per 1000 vbytes to create dust.
