...
def spenders_taproot_active():
    ...
    for p2sh in [False, True]:
        for witv0 in [False, True]:
            eckey1, pubkey1 = generate_keypair(compressed=compressed)
            for _ in range(10):
                # Construct a script with 96 checksig operations (12 sighash types, each 8 times),
                # randomly ordered and interleaved with 8 OP_CODESEPARATORS.
                ops = [1, 2, 3, 0x21, 0x42, 0x63, 0x81, 0x82, 0x83, 0xe1, 0xc2, 0xa3, -1] * 8
