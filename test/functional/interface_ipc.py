...
class IPCInterfaceTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Set an absurd reserved weight to test that -blockreservedweight is
        # RPC-only, while IPC clients supply their own blockReservedWeight.
    ...
    def run_mining_test(self):
        ...
        async def async_routine():
            ...
            async with AsyncExitStack() as stack:
                ...
                refused_template = await create_block_template(mining, stack, ctx, opts)
                assert refused_template is None
