...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        tx.vout.append(CTxOut(btc_to_sat(49.99), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))
        ...
        tx.vout.append(CTxOut(btc_to_sat(49.95), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE])))  # Huge fee
        tx.calc_sha256()
