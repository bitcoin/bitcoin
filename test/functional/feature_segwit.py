...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.fail_accept(self.nodes[0], "bad-witness-stripped", wit_ids[NODE_0][P2WPKH][0], sign=False)
        self.fail_accept(self.nodes[0], "bad-witness-stripped", wit_ids[NODE_0][P2WSH][0], sign=False)
        ...
        self.fail_accept(self.nodes[2], 'bad-witness-stripped', wit_ids[NODE_2][P2WPKH][2], sign=False)
        self.fail_accept(self.nodes[2], 'bad-witness-stripped', wit_ids[NODE_2][P2WSH][2], sign=False)
