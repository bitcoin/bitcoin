...
class P2POutEvict(BitcoinTestFramework):
    ...
    def test_outbound_eviction_unprotected(self):
        ...
        best_block_hash = self.generateblock(node, outputs=["raw(42)"], transactions=[])["hash"]
        peer.sync_with_ping()
    ...
    def test_outbound_eviction_protected(self):
        ...
        self.generateblock(node, outputs=["raw(42)"], transactions=[])
        peer.sync_with_ping()
    ...
    def test_outbound_eviction_mixed(self):
        ...
        tip_hash = self.generateblock(node, outputs=["raw(42)"], transactions=[])["hash"]
