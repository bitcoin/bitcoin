...
# Copyright 2016-2017 The Tortoisecoin Core developers
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./tortoisecoin-util":
        execprog = os.getenv("TORTOISECOINUTIL", default=execprog)
    elif testObj["exec"] == "./tortoisecoin-tx":
        execprog = os.getenv("TORTOISECOINTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, tortoisecoin-tx
