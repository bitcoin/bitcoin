...
android {
    ...
    RESOURCES = gameunits.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = com.discovergameunits
...
contains(GAMEUNITS_NEED_QT_PLUGINS, 1) {
    DEFINES += GAMEUNITS_NEED_QT_PLUGINS
...
macx:ICON = src/qt/res/icons/gameunits.icns
macx:TARGET = "GAMEUNITS"
