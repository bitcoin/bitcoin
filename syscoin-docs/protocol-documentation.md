...
This document describes the protocol extensions for all additional functionality build into the Syscoin protocol. This doesn't include any of the Syscoin protocol, which has been left intact in the Syscoin project. For more information about the core protocol, please see https://en.syscoin.it/w/index.php?title#Protocol_documentation&action#edit
...
Syscoin Outpoint https://syscoin.org/en/glossary/outpoint
...
Syscoin Input https://syscoin.org/en/glossary/input
...
Syscoin Output https://syscoin.org/en/glossary/output
...
Syscoin Public Key https://syscoin.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 100000 SYS
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 100000 SYS unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 syscoin)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the syscoin treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 100000 SYS for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 100000 SYS for masternode 2
