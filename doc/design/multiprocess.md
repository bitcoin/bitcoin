...
The choice to maintain interface definitions and C++ type mappings as `.capnp` files in the [`src/ipc/capnp/`](../../src/ipc/capnp/) were mostly done for convenience, and probably something that could be improved in the future.
