...
| *libnavioconsensus*    | Shared library build of static *libbitcoin_consensus* library |
...
| *libbitcoin_node*        | P2P and RPC server functionality used by *naviod* and *bitcoin-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *naviod* and *bitcoin-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *bitcoin-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *naviod* and *bitcoin-qt* executables. |
...
naviod[naviod]-->libbitcoin_node;
naviod[naviod]-->libbitcoin_wallet;
...
class bitcoin-qt,naviod,bitcoin-cli,bitcoin-wallet bold
```
</td></tr><tr><td>
...
- Validation code is moving from *libbitcoin_node* to *libbitcoin_kernel* as part of [The libnaviokernel Project #24303](https://github.com/bitcoin/bitcoin/issues/24303)
