...
To build Buttcoin Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Buttcoin Core may be
...
The first time you run Buttcoind, it will start downloading the blockchain. This process could
