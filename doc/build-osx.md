...
To enable [descriptor wallets](https://github.com/widecoin/widecoin/blob/master/doc/descriptors.md), `sqlite` is required.
...
You can deploy a `.dmg` containing the Widecoin Core application using `make deploy`.
