...
*Setup instructions for a Gitian build of IoP HD using a Debian VM or physical system.*
...
- [Building IoP HD](#building-iop-hd)
...
To build IoP HD (for Linux, OS X and Windows) just follow the steps under 'perform
...
[iop-hd/gitian.sigs](https://github.com/iop-hd/gitian.sigs/) repository, or if that's not possible create a pull
