UNIX BUILD NOTES
====================
Some notes on how to build Dobbscoin Core in Unix.
...
memory available when compiling Dobbscoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Dobbscoin Core without wallet.
...
As mentioned above, when maintaining portability of the wallet between the standard Dobbscoin Core distributions and independently built
