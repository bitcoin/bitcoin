UNIX BUILD NOTES
====================
Some notes on how to build Bitcredit in Unix. 
...
memory available when compiling Credits Core. With 512MB of memory or less
...
# Configure Credits Core to use our own-built instance of BDB
cd $BITCOIN_ROOT
