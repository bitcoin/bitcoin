...
Now, you can either build from self-compiled [depends](/depends/README.md) or install the required dependencies:
    ...
    sudo apt-get install libevent-dev libboost-dev libboost-test-dev libcurl4-gnutls-dev libgmp3-dev
...
Otherwise, you can build Syscoin Core from self-compiled [depends](/depends/README.md).
