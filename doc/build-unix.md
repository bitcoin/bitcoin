...
Note
---------------------
Always use absolute paths to configure and compile xpchain and the dependencies,
...
Security
--------
To help make your xpchain installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, xpchain should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, xpchain may be compiled in
