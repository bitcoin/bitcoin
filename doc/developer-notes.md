...
configuration options and toggled while tortoisecoind is running with the `logging`
RPC.  For instance, launching tortoisecoind with `-debug` or `-debug=1` will turn on
...
with "play tortoisecoins" on a test network.
...
i.e. `CPPFLAGS="-DDEBUG_LOCKCONTENTION"`, then build and run tortoisecoind.

You can then use the `-debug=lock` configuration option at tortoisecoind startup or
...
```shell
$ valgrind --suppressions=contrib/valgrind.supp src/test/test_tortoisecoin
$ valgrind --suppressions=contrib/valgrind.supp --leak-check=full \
      --show-leak-kinds=all src/test/test_tortoisecoin --log_level=test_suite
$ valgrind -v --leak-check=full src/tortoisecoind -printtoconsole
...
# A coverage report will now be accessible at `./test_tortoisecoin.coverage/index.html`,
...
To profile a running tortoisecoind process for 60 seconds, you could use an
invocation of `perf record` like this:

```sh
$ perf record \
    -g --call-graph dwarf --per-thread -F 140 \
    -p `pgrep tortoisecoind` -- sleep 60
```
 ...
 * [Issue #12691: Enable -fsanitize flags in Travis](https://github.com/tortoisecoin/tortoisecoin/issues/12691)
...
- [Main thread (`tortoisecoind`)](https://doxygen.tortoisecoincore.org/tortoisecoind_8cpp.html#a0ddf1224851353fc92bfbff6f499fa97)
  : Started from `main()` in `tortoisecoind.cpp`. Responsible for starting up and
  shutting down the application.

- [Init load (`b-initload`)](https://doxygen.tortoisecoincore.org/namespacenode.html#ab4305679079866f0f420f7dbf278381d)
...
- [CCheckQueue::Loop (`b-scriptch.x`)](https://doxygen.tortoisecoincore.org/class_c_check_queue.html#a6e7fa51d3a25e7cb65446d4b50e6a987)
  : Parallel script validation threads for transactions in blocks.

- [ThreadHTTP (`b-http`)](https://doxygen.tortoisecoincore.org/httpserver_8cpp.html#abb9f6ea8819672bd9a62d3695070709c)
  : Libevent thread to listen for RPC and REST connections.

- [HTTP worker threads(`b-httpworker.x`)](https://doxygen.tortoisecoincore.org/httpserver_8cpp.html#aa6a7bc27265043bc0193220c5ae3a55f)
  : Threads to service RPC and REST requests.

- [Indexer threads (`b-txindex`, etc)](https://doxygen.tortoisecoincore.org/class_base_index.html#a96a7407421fbf877509248bbe64f8d87)
  : One thread per indexer.

- [SchedulerThread (`b-scheduler`)](https://doxygen.tortoisecoincore.org/class_c_scheduler.html#a14d2800815da93577858ea078aed1fba)
...
- [TorControlThread (`b-torcontrol`)](https://doxygen.tortoisecoincore.org/torcontrol_8cpp.html#a52a3efff23634500bb42c6474f306091)
  : Libevent thread for tor connections.

- Net threads:

  - [ThreadMessageHandler (`b-msghand`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#aacdbb7148575a31bb33bc345e2bf22a9)
  ...
  - [ThreadDNSAddressSeed (`b-dnsseed`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#aa7c6970ed98a4a7bafbc071d24897d13)
    : Loads addresses of peers from the DNS.

  - ThreadMapPort (`b-mapport`)
    : Universal plug-and-play startup/shutdown.

  - [ThreadSocketHandler (`b-net`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#a765597cbfe99c083d8fa3d61bb464e34)
    : Sends/Receives data from peers on port 8333.

  - [ThreadOpenAddedConnections (`b-addcon`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#a0b787caf95e52a346a2b31a580d60a62)
    : Opens network connections to added nodes.

  - [ThreadOpenConnections (`b-opencon`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#a55e9feafc3bab78e5c9d408c207faa45)
    : Initiates new connections to peers.

  - [ThreadI2PAcceptIncoming (`b-i2paccept`)](https://doxygen.tortoisecoincore.org/class_c_connman.html#a57787b4f9ac847d24065fbb0dd6e70f8)
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `TORTOISECOIN_FOO_BAR_H`, e.g.

```c++
#ifndef TORTOISECOIN_FOO_BAR_H
#define TORTOISECOIN_FOO_BAR_H
...
#endif // TORTOISECOIN_FOO_BAR_H
```
...
- Try not to overload methods on argument type. E.g. don't make `getblock(true)` and `getblock("hash")`
  ...
  - *Rationale*: This is impossible to use with `tortoisecoin-cli`, and can be surprising to users.
