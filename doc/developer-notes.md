...
CPPFLAGS, e.g. `CPPFLAGS="-DDEBUG_LOCKCONTENTION"`, then build and run widecoind.
...
- [ThreadImport (`b-loadblk`)](https://doxygen.widecoincore.org/init_8cpp.html#ae9e290a0e829ec0198518de2eda579d1)
  : Loads blocks from `blk*.dat` files or `-loadblock=<file>` on startup.

- [ThreadScriptCheck (`b-scriptch.x`)](https://doxygen.widecoincore.org/validation_8cpp.html#a925a33e7952a157922b0bbb8dab29a20)
...
- [TorControlThread (`b-torcontrol`)](https://doxygen.widecoincore.org/torcontrol_8cpp.html#a4faed3692d57a0d7bdbecf3b37f72de0)
...
- Net threads:
  ...
  - [ThreadMapPort (`b-upnp`)](https://doxygen.widecoincore.org/net_8cpp.html#a63f82a71c4169290c2db1651a9bbe249)
...
- src/univalue
  - Subtree at https://github.com/widecoin-core/univalue-subtree ; maintained by Core contributors.
