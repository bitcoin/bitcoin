...
While `LogInfo`, `LogWarning` and `LogError` messages should be rare, they
are also automatically rate-limited to prevent potential disk-filling
attacks. For the rare message where this protection is undesirable,
