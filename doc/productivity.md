...
```sh
make src/britanniacoind src/britanniacoin-cli
make src/qt/britanniacoin-qt
make -C src britanniacoin_bench
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:britanniacoin/britanniacoin.git
```
