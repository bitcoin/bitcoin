...
```sh
make src/bitcointalkcoind src/bitcointalkcoin-cli
make src/qt/bitcointalkcoin-qt
make -C src bitcointalkcoin_bench
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitcointalkcoin/bitcointalkcoin.git
```
