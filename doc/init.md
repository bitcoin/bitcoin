...
All three Linux startup configurations assume the existence of a "btcsq" user
...
`/etc/btcsq/btcsq.conf` with the current systemd, OpenRC, and Upstart init
files out-of-the-box. This is because the command line options specified in the
init files take precedence over the configurations in
`/etc/btcsq/btcsq.conf`. However, some init systems have their own
