...
It is possible to run Credits as a Tor hidden service, and connect to such services.
...
The first step is running Credits behind a Tor proxy. This will already make all
