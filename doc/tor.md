...
## 2. Manually create a Syscoin Core onion service
...
## 3. Automatically create a Syscoin Core onion service
...
Syscoin Core automatically creates an onion service to listen on. This will positively
...
which has the appropriate permissions. Before starting syscoind you will need to re-login
...
- Do not add anything but Syscoin Core ports to the onion service created in section 2.
