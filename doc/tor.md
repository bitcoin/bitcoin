...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./chaincoin -proxy=127.0.0.1:9050
...
your chaincoind's P2P listen port (8333 by default).
	...
	-externalip=X   You can tell chaincoin about its publicly reachable address using
	                ...
	                /var/lib/tor/chaincoin-service/hostname. Onion addresses are given
...
for normal IPv4/IPv6 communication, use:
	...
	./chaincoin -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
configured. For cookie authentication the user running chaincoind must have write access 
