...
It is possible to run XPChain as a Tor hidden service, and connect to such services.

The following directions assume you have a Tor proxy running on port 9050. Many distributions default to having a SOCKS proxy listening on port 9050, but others may not. In particular, the Tor Browser Bundle defaults to listening on port 9150. See [Tor Project FAQ:TBBSocksPort](https://www.torproject.org/docs/faq.html.en#TBBSocksPort) for how to properly
configure Tor.


1. Run xpchain behind a Tor proxy
---------------------------------

The first step is running XPChain behind a Tor proxy. This will already make all
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./xpchain -proxy=127.0.0.1:9050


2. Run a xpchain hidden server
------------------------------
...
your xpchaind's P2P listen port (8798 by default).
	...
	-externalip=X   You can tell xpchain about its publicly reachable address using
	                ...
	                /var/lib/tor/xpchain-service/hostname. Onion addresses are given
...
for normal IPv4/IPv6 communication, use:
	...
	./xpchain -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
- Do not add anything but xpchain ports to the hidden service created in section 2.
