...
To create a new language template, you will need to edit the languages manifest file `src/qt/dash.qrc` and add a new entry. Below is an example of the English language entry.
