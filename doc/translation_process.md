...
The Peercoin-Core project has been designed to support multiple localisations. This makes adding new phrases, and completely new languages easily achievable. For managing all application translations, Peercoin-Core makes use of the Transifex online translation management tool.
