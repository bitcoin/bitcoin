NdovuCoin version 0.5.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/NdovuCoin/bitcoin-0.5.0/
...
The wallet encryption feature introduced in NdovuCoin version 0.4.0 did not sufficiently secure the private keys. An attacker who
managed to get a copy of your encrypted wallet.dat file might be able to recover some or all of the unencrypted keys and steal the
associated coins.

If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, NdovuCoin will
...
Wallets encrypted with this version of NdovuCoin are written properly.
...
1. Run NdovuCoin and let it rewrite the wallet.dat file

2. Run it again, then ask it for a new bitcoin address.
NdovuCoin-Qt: Address Book, then New Address...
...
4. Shut down NdovuCoin, then backup the wallet.dat file.
