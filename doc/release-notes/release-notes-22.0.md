...
Widecoin Core version 22.0 is now available from:

  <https://widecoincore.org/bin/widecoin-core-22.0/>
...
From Widecoin Core 22.0 onwards, macOS versions earlier than 10.14 are no longer supported.
...
- A new CLI `-addrinfo` command returns the number of addresses known to the
  ...
  like `-onlynet=<network>` or to upgrade to this release of Widecoin Core 22.0
...
- widecoin/widecoin#22589 net, doc: update I2P hardcoded seeds and docs for 22.0 (jonatack)
...
- widecoin/widecoin#21036 gitian: Bump descriptors to focal for 22.0 (fanquake)
