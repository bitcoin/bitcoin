...
http://sourceforge.net/projects/bitcoinrupee/files/Bitcoin/bitcoinrupee-0.5.3/
...
http://gitorious.org/bitcoinrupee/bitcoinrupeed-stable/archive-tarball/v0.5.3#.tar.gz
...
Handle invalid Bitcoin URIs using "bitcoinrupee://" instead of "bitcoinrupee:".
