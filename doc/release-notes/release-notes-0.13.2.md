Bitcointalkcoin Core version 0.13.2 is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcointalkcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcointalkcoin-tx to create v2 transactions (btcdrak)
