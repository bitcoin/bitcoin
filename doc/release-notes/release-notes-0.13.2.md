Raven Core version 0.13.2 is now available from:

  <https://raven.org/bin/raven-core-0.13.2/>
...
- #8908 `4a974b2` Update raven-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow raven-tx to create v2 transactions (btcdrak)
