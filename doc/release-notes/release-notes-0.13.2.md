BritanniaCoin Core version 0.13.2 is now available from:

  <https://britanniacoin.org/bin/britanniacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update britanniacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow britanniacoin-tx to create v2 transactions (brtdrak)
