Talkcoin Core version 0.13.2 is now available from:

  <https://talkcoin.org/bin/talkcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update talkcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow talkcoin-tx to create v2 transactions (btcdrak)
