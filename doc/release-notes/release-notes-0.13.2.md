XBit Core version 0.13.2 is now available from:

  <https://xbit.org/bin/xbit-core-0.13.2/>
...
- #8908 `4a974b2` Update xbit-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xbit-tx to create v2 transactions (btcdrak)
