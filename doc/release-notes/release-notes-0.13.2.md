Widecoin Core version 0.13.2 is now available from:

  <https://widecoin.org/bin/widecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update widecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow widecoin-tx to create v2 transactions (wcndrak)
