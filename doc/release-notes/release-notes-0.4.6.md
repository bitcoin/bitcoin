...
Source: tar.gz
iopd and Bitcoin-Qt version 0.6.0.7 are also tagged in git, but it is recommended to upgrade to 0.6.1.
...
Correct sign message iop address tooltip. Fixes #1050 (Bitcoin-Qt)
