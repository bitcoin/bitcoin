Widecoin Core version *0.15.2* is now available from:

  <https://widecoincore.org/bin/widecoin-core-0.15.2/>
...
Widecoin Core is extensively tested on multiple operating systems using
...
- #11554 `a69cc07` Sanity-check script sizes in widecoin-tx (TheBlueMatt)
