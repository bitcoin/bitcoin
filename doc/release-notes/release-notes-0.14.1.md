Raven Core version 0.14.1 is now available from:

  <https://raven.org/bin/raven-core-0.14.1/>
...
here:
[reducing-ravend-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` raven-tx input verification (awemany, jnewbery)
