Bitcoin Core version 0.14.1 is now available from:
  ...
  <https://bitcoinrupee.org/bin/bitcoinrupee-core-0.14.1/>
...
here:
[reducing-bitcoinrupeed-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` bitcoinrupee-tx input verification (awemany, jnewbery)
