...
Snailcoin Core version 0.21.1 is now available from:
...
The addition of taproot-related features to Snailcoin Core's wallet is
...
- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Snailcoin](https://bitcoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitcoin)
  - [What do Schnorr Signatures Mean for Snailcoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitcoin)
...
### Documentation
- #21384 add signet to snailcoin.conf documentation (jonatack)
