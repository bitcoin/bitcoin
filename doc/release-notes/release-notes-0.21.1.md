...
Widecoin Core version 0.21.1 is now available from:

  <https://widecoincore.org/bin/widecoin-core-0.21.1/>
...
using the Linux kernel, macOS 10.12+, and Windows 7 and newer.  Widecoin
Core should also work on most other Unix-like systems but is not as
frequently tested on them.  It is not recommended to use Widecoin Core on
unsupported systems.

From Widecoin Core 0.20.0 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, Widecoin Core does not yet change appearance
...
fungibility of all widecoins. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Widecoin Core's wallet is
...
FAQ](https://widecoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/widecoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/widecoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/widecoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Widecoin](https://widecoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-widecoin)
  - [What do Schnorr Signatures Mean for Widecoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-widecoin)
...
- Development history overview
  - [Taproot](https://widecoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://widecoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://widecoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://widecoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://widecoin.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/widecoin/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/widecoin/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to widecoin.conf documentation (jonatack)
