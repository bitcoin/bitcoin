NdovuCoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/NdovuCoin/bitcoin-0.8.4/
...
code, causing the NdovuCoin-Qt or bitcoind process to crash.
...
their own version of NdovuCoin against Boost versions 1.50-1.52.
