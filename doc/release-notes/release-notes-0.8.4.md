Snailcoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Snailcoin/bitcoin-0.8.4/
...
code, causing the Snailcoin-Qt or snailcoind process to crash.
...
their own version of Snailcoin against Boost versions 1.50-1.52.
