NdovuCoin Core version 0.11.0 is now available from:
...
Block pruning allows NdovuCoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that NdovuCoin Core will 
...
- #6116 `30dc3c1` [OSX] rename NdovuCoin-Qt.app to NdovuCoin-Core.app
