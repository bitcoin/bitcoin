XBit Core version 0.10.2 is now available from:

  <https://xbit.org/bin/xbit-core-0.10.2/>
...
characters (https://github.com/xbit/xbit/issues/6078).

For other platforms there are no notable changes.

For the notable changes in 0.10, refer to the release notes
at https://github.com/xbit/xbit/blob/v0.10.0/doc/release-notes.md
