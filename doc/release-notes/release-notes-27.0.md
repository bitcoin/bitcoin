Snailcoin Core version 27.0 is now available from:
...
- A C++20 capable compiler is now required to build Snailcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Snailcoin Core would
