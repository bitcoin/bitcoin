XBit Core version 0.10.4 is now available from:

  <https://xbit.org/bin/xbit-core-0.10.4/>
...
- #6953 `43c2789` Split xbit-tx into its own package
- #6953 `dfe0d4d` Include xbit-tx binary on Debian/Ubuntu
