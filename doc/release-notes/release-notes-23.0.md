...
Widecoin Core version 23.0 is now available from:

  <https://widecoincore.org/bin/widecoin-core-23.0/>
...
- Before this release, Widecoin Core had a strong preference to try to connect only to peers that listen on port 8333. As a result of that, Widecoin nodes listening on non-standard ports would likely not get any Widecoin Core peers connecting to them. This preference has been removed. (#23542)

- Full support has been added for the CJDNS network. See the new option `-cjdnsreachable` and [doc/cjdns.md](https://github.com/widecoin/widecoin/tree/23.x/doc/cjdns.md) (#23077)
...
Widecoin Core release binaries for Linux now include experimental tracepoints which
...
[doc/tracing.md](https://github.com/widecoin/widecoin/blob/23.x/doc/tracing.md) and
usage examples are provided in [contrib/tracing/](https://github.com/widecoin/widecoin/tree/23.x/contrib/tracing).
