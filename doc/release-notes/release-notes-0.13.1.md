...
- #8829 `2a8bca4` Add navio-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` navio-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_naviods() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update navio-tx to output witness data (jnewbery)
