Tortoisecoin version 0.4.4 is now available for download at:
http://luke.dashjr.org/programs/tortoisecoin/files/tortoisecoind-0.4.4/
...
http://gitorious.org/tortoisecoin/tortoisecoind-stable/archive-tarball/v0.4.4#.tar.gz
