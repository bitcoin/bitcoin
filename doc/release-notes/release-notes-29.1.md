Snailcoin Core version 29.1 is now available from:
...
- #32679 doc: update tor docs to use snailcoind binary from path
...
- #32719 doc, windows: CompanyName "Snailcoin" => "Snailcoin Core project"
