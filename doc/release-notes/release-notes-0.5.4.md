BritanniaCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/britanniacoin/files/BritanniaCoin/britanniacoin-0.5.4/
...
http://gitorious.org/britanniacoin/britanniacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BritanniaCoin-Qt notifications under Growl 1.3.
Increase required age of BritanniaCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBritanniaCoin properly when installing BritanniaCoin-Qt over it. (Windows)
