Buttcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/Buttcoin/files/Buttcoin/Buttcoin-0.5.4/
...
http://gitorious.org/Buttcoin/Buttcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Buttcoin-Qt notifications under Growl 1.3.
Increase required age of Buttcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxButtcoin properly when installing Buttcoin-Qt over it. (Windows)
