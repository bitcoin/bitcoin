Snailcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Snailcoin/bitcoin-0.5.4/
...
http://gitorious.org/bitcoin/snailcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Snailcoin-Qt notifications under Growl 1.3.
Increase required age of Snailcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSnailcoin properly when installing Snailcoin-Qt over it. (Windows)
