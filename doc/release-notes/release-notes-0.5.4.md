...
http://sourceforge.net/projects/bitcoinrupee/files/Bitcoin/bitcoinrupee-0.5.4/
...
http://gitorious.org/bitcoinrupee/bitcoinrupeed-stable/archive-tarball/v0.5.4#.tar.gz
