Raven version 0.5.4 is now available for download at:
http://sourceforge.net/projects/raven/files/Raven/raven-0.5.4/
...
http://gitorious.org/raven/ravend-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Raven-Qt notifications under Growl 1.3.
Increase required age of Raven-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRaven properly when installing Raven-Qt over it. (Windows)
