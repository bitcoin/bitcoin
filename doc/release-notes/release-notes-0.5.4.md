Liberta version 0.5.4 is now available for download at:
http://sourceforge.net/projects/liberta/files/Liberta/liberta-0.5.4/
...
http://gitorious.org/liberta/libertad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Liberta-Qt notifications under Growl 1.3.
Increase required age of Liberta-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLiberta properly when installing Liberta-Qt over it. (Windows)
