Crowncoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/crowncoin/files/Crowncoin/crowncoin-0.5.4/
...
http://gitorious.org/crowncoin/crowncoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Crowncoin-Qt notifications under Growl 1.3.
Increase required age of Crowncoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCrowncoin properly when installing Crowncoin-Qt over it. (Windows)
