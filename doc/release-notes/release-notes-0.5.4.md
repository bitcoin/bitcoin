Widecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/widecoin/files/Widecoin/widecoin-0.5.4/
...
http://gitorious.org/widecoin/widecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Widecoin-Qt notifications under Growl 1.3.
Increase required age of Widecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxWidecoin properly when installing Widecoin-Qt over it. (Windows)
