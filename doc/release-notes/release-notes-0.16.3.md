XBit Core version 0.16.3 is now available from:

  <https://xbitcore.org/bin/xbit-core-0.16.3/>
...
been discovered in XBit Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` xbitconsensus: invalid flags error should be set to `xbitconsensus_err` (afk11)
