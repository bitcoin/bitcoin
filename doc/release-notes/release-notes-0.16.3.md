Widecoin Core version 0.16.3 is now available from:
  ...
  <https://widecoincore.org/bin/widecoin-core-0.16.3/>
...
been discovered in Widecoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` widecoinconsensus: invalid flags error should be set to `widecoinconsensus_err` (afk11)
