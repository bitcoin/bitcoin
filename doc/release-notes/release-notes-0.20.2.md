...
BritanniaCoin Core version 0.20.2 is now available from:

  <https://britanniacoincore.org/bin/britanniacoin-core-0.20.2/>
...
- Instead of running `make` simply, you should instead run
  `BRITANNIACOIN_GENBUILD_NO_GIT=1 make`.
...
[#18325](https://github.com/britanniacoin/britanniacoin/issues/18325)).
