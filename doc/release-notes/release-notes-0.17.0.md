Buttcoin Core version 0.17.0 is now available from:

  <https://Buttcoincore.org/bin/Buttcoin-core-0.17.0/>
...
[BIP 174 PSBT](https://github.com/Buttcoin/bips/blob/master/bip-0174.mediawiki) is an interchange format for Buttcoin transactions that are not fully signed
...
- #11962 `0a01843` add seed.Buttcoin.sprovoost.nl to DNS seeds (Sjors)
...
- #12723 `310dc61` Qt5: Warning users about invalid-BIP21 URI Buttcoin:// (krab)
...
- #13528 `b877c39` Move ButtcoinGUI initializers to class, fix initializer order warning (laanwj)
...
- #13486 `66e1a08` Move rpc/util.cpp from libButtcoin-util to libButtcoin-server (ken2812221)
...
- #13604 `75bea05` Add depends 32-bit arm support for Buttcoin-qt (TheCharlatan)
...
- #13696 `2ab7208` Add aarch64 qt depends support for cross compiling Buttcoin-qt (TheCharlatan)
...
- #11771 `2dbc4a4` Change invalidtxrequest to use ButtcoinTestFramework (jnewbery)
...
- #12443 `07090c5` Move common args to Buttcoin.conf (MarcoFalke)
...
- #11772 `0630974` Change invalidblockrequest to use ButtcoinTestFramework (jnewbery)
...
- #11773 `f0f9732` Change `feature_block.py` to use ButtcoinTestFramework (jnewbery)
- #12839 `40f4baf` Remove travis checkout depth (laanwj)
- #11817 `2a09a78` Change `feature_csv_activation.py` to use ButtcoinTestFramework (jnewbery)
...
- #12856 `27278df` Add Metaclass for ButtcoinTestFramework (WillAyd)
...
- #12882 `d96bdd7` Make `test_Buttcoin` pass under ThreadSanitzer (clang). Fix lock-order-inversion (potential deadlock) (practicalswift)
...
- #13687 `9d26b69` travis: Check that ~/.Buttcoin is never created (MarcoFalke)
...
- #13811 `660abc1` travis: Run `bench_Buttcoin` once (MarcoFalke)
...
- #12102 `7fb8fb4` Apply hardening measures in Buttcoind systemd service file (Flowdalic)
- #12652 `55f490a` Buttcoin-cli: Provide a better error message when Buttcoind is not running (practicalswift)
...
- #12769 `35eb9d6` Add systemd service to Buttcoind in debian package (ghost)
...
- #13374 `56f6936` utils and libraries: checking for Buttcoin address in translations (kaplanmaxe)
...
- #13603 `453ae5e` Buttcoin-tx: Stricter check for valid integers (domob1812)
...
- #13725 `07ce278` Fix Buttcoin-cli --version (Empact)
...
- #12877 `2b54155` Use Buttcoind in Tor documentation (knoxcard)
...
- #13346 `60f0358` update Buttcoin-dot-org links in release-process.md (fanquake)
...
- #13742 `d2186b3` Adjust Buttcoincore.org links (MarcoFalke)
...
- #13905 `73a09b4` fixed Buttcoin-cli -help output for help2man (hebasto)
