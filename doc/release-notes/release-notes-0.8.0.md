Liberta-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/liberta/files/Liberta/liberta-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Liberta
...
New/changed settings (command-line or liberta.conf file)
--------------------------------------------------------
