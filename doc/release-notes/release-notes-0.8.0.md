BritanniaCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/britanniacoin/files/BritanniaCoin/britanniacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BritanniaCoin
...
New/changed settings (command-line or britanniacoin.conf file)
--------------------------------------------------------
