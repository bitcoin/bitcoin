Raven-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/raven/files/Raven/raven-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Raven
...
New/changed settings (command-line or raven.conf file)
--------------------------------------------------------
