Widecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/widecoin/files/Widecoin/widecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Widecoin
...
New/changed settings (command-line or widecoin.conf file)
--------------------------------------------------------
