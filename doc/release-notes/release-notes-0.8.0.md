XBit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/xbit/files/XBit/xbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the XBit
...
New/changed settings (command-line or xbit.conf file)
--------------------------------------------------------
