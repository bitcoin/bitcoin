Bitcointalkcoin Core version *0.15.0.1* is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.15.0.1/>

and

  <https://bitcointalkcoincore.org/bin/bitcointalkcoin-core-0.15.0.1/>
