BritanniaCoin Core version *0.15.0.1* is now available from:

  <https://britanniacoin.org/bin/britanniacoin-core-0.15.0.1/>

and

  <https://britanniacoincore.org/bin/britanniacoin-core-0.15.0.1/>
