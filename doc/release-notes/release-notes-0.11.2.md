Widecoin Core version 0.11.2 is now available from:

  <https://widecoin.org/bin/widecoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include widecoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split widecoin-tx into its own package
