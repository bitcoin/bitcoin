Syscoin Core version 0.11.2 is now available from:

  <https://syscoin.org/bin/syscoin-core-0.11.2/>
...
Syscoin transactions currently may specify a locktime indicating when
...
- #6600 `1e672ae` Debian/Ubuntu: Include syscoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split syscoin-tx into its own package
