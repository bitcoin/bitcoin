Bitcointalkcoin Core version 0.11.2 is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include bitcointalkcoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split bitcointalkcoin-tx into its own package
