Raven Core version 0.11.2 is now available from:

  <https://raven.org/bin/raven-core-0.11.2/>
...
Raven transactions currently may specify a locktime indicating when
...
[BIP113]: https://github.com/raven/bips/blob/master/bip-0113.mediawiki
...
- #6600 `1e672ae` Debian/Ubuntu: Include raven-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split raven-tx into its own package
