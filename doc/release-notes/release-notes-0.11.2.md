Buttcoin Core version 0.11.2 is now available from:

  <https://Buttcoin.org/bin/Buttcoin-core-0.11.2/>
...
Buttcoin transactions currently may specify a locktime indicating when
...
[BIP113]: https://github.com/Buttcoin/bips/blob/master/bip-0113.mediawiki
...
- #6600 `1e672ae` Debian/Ubuntu: Include Buttcoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split Buttcoin-tx into its own package
