Talkcoin Core version 0.11.2 is now available from:

  <https://talkcoin.org/bin/talkcoin-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include talkcoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split talkcoin-tx into its own package
