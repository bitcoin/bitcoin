Tortoisecoin Core version 0.11.2 is now available from:

  <https://tortoisecoin.org/bin/tortoisecoin-core-0.11.2/>
...
Tortoisecoin transactions currently may specify a locktime indicating when
...
[BIP113]: https://github.com/tortoisecoin/bips/blob/master/bip-0113.mediawiki
...
- #6600 `1e672ae` Debian/Ubuntu: Include tortoisecoin-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split tortoisecoin-tx into its own package
