...
This allows running naviod without having to do any manual configuration.
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass naviod rpc basic auth
...
Restarting naviod will no longer clear out the list of banned peers; instead
...
- #6600 `ef4945f` Include navio-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix navio-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of navio-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [navio-cli] improve error output (Jonas Schnelli)
