Widecoin Core version 0.16.1 is now available from:

  <https://widecoincore.org/bin/widecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting widecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure widecoind processes are cleaned up when tests end (sdaftuar)
