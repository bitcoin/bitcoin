Tortoisecoin Core version 0.16.1 is now available from:
  ...
  <https://tortoisecoincore.org/bin/tortoisecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting tortoisecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure tortoisecoind processes are cleaned up when tests end (sdaftuar)
