Talkcoin Core version 0.16.1 is now available from:

  <https://talkcoincore.org/bin/talkcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting talkcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure talkcoind processes are cleaned up when tests end (sdaftuar)
