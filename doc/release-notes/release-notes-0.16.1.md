BritanniaCoin Core version 0.16.1 is now available from:

  <https://britanniacoincore.org/bin/britanniacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting britanniacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure britanniacoind processes are cleaned up when tests end (sdaftuar)
