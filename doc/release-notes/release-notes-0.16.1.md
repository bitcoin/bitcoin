Buttcoin Core version 0.16.1 is now available from:

  <https://Buttcoincore.org/bin/Buttcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting Buttcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure Buttcoind processes are cleaned up when tests end (sdaftuar)
