Bitcointalkcoin Core version 0.16.1 is now available from:

  <https://bitcointalkcoincore.org/bin/bitcointalkcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcointalkcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcointalkcoind processes are cleaned up when tests end (sdaftuar)
