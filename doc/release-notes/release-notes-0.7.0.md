...
We recommend that everybody running prior versions of naviod/Bitcoin-Qt
...
* (Windows only): enable ASLR and DEP for navio-qt.exe
* (Windows only): add meta-data to navio-qt.exe (e.g. description)
...
* Bash programmable completion for naviod(1)
