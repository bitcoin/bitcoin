Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoinrupee/files/Bitcoin/bitcoinrupee-0.7.0/

We recommend that everybody running prior versions of bitcoinrupeed/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/bitcoinrupee/bitcoinrupee/tarball/v0.7.0  # .tar.gz
  https://github.com/bitcoinrupee/bitcoinrupee/zipball/v0.7.0  # .zip
...
Core bitcoinrupee handling and blockchain database
...
* Ensure a changed bitcoinrupee unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for bitcoinrupee-qt.exe
* (Windows only): add meta-data to bitcoinrupee-qt.exe (e.g. description)
...
* Bash programmable completion for bitcoinrupeed(1)
