Bitcointalkcoin Core version *0.14.3* is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/bitcointalkcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
