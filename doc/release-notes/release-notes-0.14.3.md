Buttcoin Core version *0.14.3* is now available from:

  <https://Buttcoin.org/bin/Buttcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/Buttcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
