Widecoin Core version *0.14.3* is now available from:

  <https://widecoin.org/bin/widecoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/widecoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
