BritanniaCoin Core version *0.14.3* is now available from:

  <https://britanniacoin.org/bin/britanniacoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/britanniacoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
