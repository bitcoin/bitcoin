Talkcoin Core version *0.14.3* is now available from:

  <https://talkcoin.org/bin/talkcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/talkcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
