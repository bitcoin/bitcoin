Bitcointalkcoin Core version 0.10.3 is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.10.3/>
...
(see https://github.com/bitcointalkcoin/bitcointalkcoin/pull/6793, as well as the 0.11.0
