Liberta Core version 0.10.3 is now available from:

  <https://liberta.org/bin/liberta-core-0.10.3/>
...
(see https://github.com/liberta/liberta/pull/6793, as well as the 0.11.0
