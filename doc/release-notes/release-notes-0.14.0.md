IoP HD version 0.14.0 is now available from:

  <https://iop.org/bin/iop-hd-0.14.0/>
...
IoP HD has supported automatically pruning the blockchain since 0.11. Pruning
...
When IoP HD is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://iop.org/en/alert/2016-11-01-alert-retirement) in IoP HD 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of IoP HD. This was added in conjunction with
