Download URL: https://sourceforge.net/projects/britanniacoin/files/BritanniaCoin/britanniacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BRT fee schedule (users still pay 0.01 BRT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #britanniacoin00 - #britanniacoin99
