Download URL: https://sourceforge.net/projects/xbit/files/XBit/xbit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 XBT fee schedule (users still pay 0.01 XBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #xbit00 - #xbit99
