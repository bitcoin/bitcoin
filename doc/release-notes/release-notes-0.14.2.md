Bitcointalkcoin Core version 0.14.2 is now available from:

  <https://bitcointalkcoin.org/bin/bitcointalkcoin-core-0.14.2/>
...
(in Bitcointalkcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Bitcointalkcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcointalkcoin-config.h as necessary (theuni)
