Talkcoin Core version 0.14.2 is now available from:

  <https://talkcoin.org/bin/talkcoin-core-0.14.2/>
...
(in Talkcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Talkcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate talkcoin-config.h as necessary (theuni)
