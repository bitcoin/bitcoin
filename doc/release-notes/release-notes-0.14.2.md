Syscoin Core version 0.14.2 is now available from:

  <https://syscoin.org/bin/syscoin-core-0.14.2/>
...
(in Syscoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate syscoin-config.h as necessary (theuni)
