Talkcoin Core version 0.11.1 is now available from:

  <https://talkcoin.org/bin/talkcoin-core-0.11.1/>
...
(see https://github.com/talkcoin/talkcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libtalkcoinconsensus: avoid a crash in multi-threaded environments
