Liberta Core version 0.11.1 is now available from:

  <https://liberta.org/bin/liberta-core-0.11.1/>
...
backwards-compatible with pre-0.10 versions of Liberta Core or other software:
...
(see https://github.com/liberta/liberta/pull/6795).
...
one was randomly violated by all deployed liberta software prior to
...
Liberta Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Libertaj has done so for a similar span of time.
Libertajs and electrum have been more recently updated.
...
[1] On the Malleability of Liberta Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/liberta/paper_9.pdf
...
(see https://github.com/liberta/liberta/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` liblibertaconsensus: avoid a crash in multi-threaded environments
