Raven Core version 0.9.4 is now available from:

  https://raven.org/bin/0.9.4/
...
this update is incompatible with the Raven system and could lead to consensus
forks.

Raven Core released binaries from https://raven.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~raven/+archive/ubuntu/raven
- A third-party or self-compiled Raven Core

upgrade to Raven Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
