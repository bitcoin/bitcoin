Bitcointalkcoin Core version 0.9.4 is now available from:

  https://bitcointalkcoin.org/bin/0.9.4/
...
this update is incompatible with the Bitcointalkcoin system and could lead to consensus
forks.

Bitcointalkcoin Core released binaries from https://bitcointalkcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcointalkcoin/+archive/ubuntu/bitcointalkcoin
- A third-party or self-compiled Bitcointalkcoin Core

upgrade to Bitcointalkcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
