Liberta Core version 0.9.4 is now available from:

  https://liberta.org/bin/0.9.4/
...
this update is incompatible with the Liberta system and could lead to consensus
forks.

Liberta Core released binaries from https://liberta.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~liberta/+archive/ubuntu/liberta
- A third-party or self-compiled Liberta Core

upgrade to Liberta Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
