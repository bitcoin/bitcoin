BritanniaCoin Core version 0.9.4 is now available from:

  https://britanniacoin.org/bin/0.9.4/
...
this update is incompatible with the BritanniaCoin system and could lead to consensus
forks.

BritanniaCoin Core released binaries from https://britanniacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~britanniacoin/+archive/ubuntu/britanniacoin
- A third-party or self-compiled BritanniaCoin Core

upgrade to BritanniaCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
