Talkcoin Core version 0.9.4 is now available from:

  https://talkcoin.org/bin/0.9.4/
...
this update is incompatible with the Talkcoin system and could lead to consensus
forks.

Talkcoin Core released binaries from https://talkcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~talkcoin/+archive/ubuntu/talkcoin
- A third-party or self-compiled Talkcoin Core

upgrade to Talkcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
