Widecoin Core version 0.9.4 is now available from:

  https://widecoin.org/bin/0.9.4/
...
this update is incompatible with the Widecoin system and could lead to consensus
forks.

Widecoin Core released binaries from https://widecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~widecoin/+archive/ubuntu/widecoin
- A third-party or self-compiled Widecoin Core

upgrade to Widecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
