XBit Core version 0.9.4 is now available from:

  https://xbit.org/bin/0.9.4/
...
this update is incompatible with the XBit system and could lead to consensus
forks.

XBit Core released binaries from https://xbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~xbit/+archive/ubuntu/xbit
- A third-party or self-compiled XBit Core

upgrade to XBit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
