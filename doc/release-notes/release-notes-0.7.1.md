NdovuCoin version 0.7.1 is now available from:
  http://sourceforge.net/projects/bitcoin/files/NdovuCoin/bitcoin-0.7.1/
...
* Clicking on a bitcoin: URI on Windows should now launch NdovuCoin-Qt properly.
