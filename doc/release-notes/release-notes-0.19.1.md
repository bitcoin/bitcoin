...
Widecoin Core version 0.19.1 is now available from:

  <https://widecoincore.org/bin/widecoin-core-0.19.1/>
...
From Widecoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Widecoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Widecoin Core does not yet change appearance when
...
- #17488 fix "widecoind already running" warnings on macOS (fanquake)
