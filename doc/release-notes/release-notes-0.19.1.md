...
XBit Core version 0.19.1 is now available from:

  <https://xbitcore.org/bin/xbit-core-0.19.1/>
...
From XBit Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as XBit Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, XBit Core does not yet change appearance when
...
- #17488 fix "xbitd already running" warnings on macOS (fanquake)
