...
Buttcoin Core version 0.19.1 is now available from:

  <https://Buttcoincore.org/bin/Buttcoin-core-0.19.1/>
...
From Buttcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Buttcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Buttcoin Core does not yet change appearance when
...
- #17488 fix "Buttcoind already running" warnings on macOS (fanquake)
