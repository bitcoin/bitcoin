...
BritanniaCoin Core version 0.19.1 is now available from:

  <https://britanniacoincore.org/bin/britanniacoin-core-0.19.1/>
...
From BritanniaCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BritanniaCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BritanniaCoin Core does not yet change appearance when
...
- #17488 fix "britanniacoind already running" warnings on macOS (fanquake)
