BritanniaCoin Core version 0.9.2 is now available from:

  https://britanniacoin.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 BRT to 0.01 BRT
...
- Fix "Start britanniacoin on system login"
