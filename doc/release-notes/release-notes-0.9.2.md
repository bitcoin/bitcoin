Widecoin Core version 0.9.2 is now available from:

  https://widecoin.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 WCN to 0.01 WCN
...
- Fix "Start widecoin on system login"
