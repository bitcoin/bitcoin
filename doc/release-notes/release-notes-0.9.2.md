XBit Core version 0.9.2 is now available from:

  https://xbit.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 XBT to 0.01 XBT
...
- Fix "Start xbit on system login"
