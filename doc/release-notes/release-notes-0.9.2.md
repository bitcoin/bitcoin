Bitcointalkcoin Core version 0.9.2 is now available from:

  https://bitcointalkcoin.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 TALK to 0.01 TALK
...
- Fix "Start bitcointalkcoin on system login"
