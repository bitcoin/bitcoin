Raven version 0.6.2 is now available for download at:
http://sourceforge.net/projects/raven/files/Raven/raven-0.6.2/
...
Fixed https://github.com/raven/raven/issues/1065, a bug that
