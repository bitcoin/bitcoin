...
Below are some notes on how to build yama_coin core for Windows.

The options known to work for building yama_coin core on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Trusty 14.04 is recommended
and is the platform used to build the yama_coin core Windows release binaries.
...
for Ubuntu Xenial does not produce working executables for some of the yama_coin core applications.
...
Note that for WSL the yama_coin core source path MUST be somewhere in the default mount file system, for
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/yamacoinproject/yamacoin.git
