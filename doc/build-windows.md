...
Below are some notes on how to build Snailcoin Core for Windows.

The options known to work for building Snailcoin Core on Windows are:
...
Note that for WSL the Snailcoin Core source path MUST be somewhere in the default mount file system, for
