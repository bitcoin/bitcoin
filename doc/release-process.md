...
### NdovuCoin maintainers/release engineers, suggestion for writing release notes
...
- Announce the release:
  ...
  - NdovuCoin Core announcements list https://bitcoincore.org/en/list/announcements/join/
  ...
  - Optionally twitter, reddit /r/NdovuCoin, ... but this will usually sort out itself
