...
* Update manpages, see [gen-manpages.sh](https://github.com/iop/iop/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Build and sign IoP Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit iop=v${VERSION} ../iop/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit iop=v${VERSION} ../iop/contrib/gitian-descriptors/gitian-osx.yml
...
Codesigner only: Sign the osx binary:
    ...
    transfer iop-osx-unsigned.tar.gz to osx for signing
    tar xf iop-osx-unsigned.tar.gz
...
Codesigner only: Sign the windows binaries:
    ...
    tar xf iop-win-unsigned.tar.gz
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/iop/iop/releases/new) with a link to the archived release notes.
