...
Build output expected:
  ...
  1. source tarball (`btcsq-${VERSION}.tar.gz`)
  2. linux 32-bit and 64-bit dist tarballs (`btcsq-${VERSION}-linux[32|64].tar.gz`)
  3. windows 32-bit and 64-bit unsigned installers and dist zips (`btcsq-${VERSION}-win[32|64]-setup-unsigned.exe`, `btcsq-${VERSION}-win[32|64].zip`)
  4. macOS unsigned installer and dist tarball (`btcsq-${VERSION}-osx-unsigned.dmg`, `btcsq-${VERSION}-osx64.tar.gz`)
