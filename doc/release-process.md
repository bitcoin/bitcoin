...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/widecoin/widecoin/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/widecoin/widecoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
* On the new release branch in [`configure.ac`](../configure.ac) and [`build_msvc/widecoin_config.h`](/build_msvc/widecoin_config.h) (see [this commit](https://github.com/widecoin/widecoin/commit/742f7dd)):
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the widecoin.org server
