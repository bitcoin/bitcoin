# Support for Output Descriptors in vBitcoin Core

Since vBitcoin Core v0.17, there is support for Output Descriptors. This is a
...
on vBitcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing vBitcoin Core wallets, a convenience function `combo` is
...
All RPCs in vBitcoin Core will include the checksum in their output. Only
