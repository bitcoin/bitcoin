# Support for Output Descriptors in BTCSQ Core

Since BTCSQ Core v0.17, there is support for Output Descriptors. This is a
...
on BTCSQ's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing BTCSQ Core wallets, a convenience function `combo` is
...
All RPCs in BTCSQ Core will include the checksum in their output. Only
