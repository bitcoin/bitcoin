...
For the same "decaying" multisig built as a Taproot output, see [this functional test](/test/functional/wallet_taproot_decaying_multisig_descriptor_psbt.py). Its descriptor has the form `tr(musig(XPUB1/<0;1>/*,XPUB2/<0;1>/*,XPUB3/<0;1>/*,XPUB4/<0;1>/*),thresh(4,pk(XPUB1/<0;1>/*),s:pk(XPUB2/<0;1>/*),s:pk(XPUB3/<0;1>/*),s:pk(XPUB4/<0;1>/*),sln:after(t1),sln:after(t2),sln:after(t3)))`.
