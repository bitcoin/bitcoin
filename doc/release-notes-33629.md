...
- The mempool no longer enforces ancestor or descendant size/count limits.
  ...
  any combination of parent/child relationships in the mempool.
...
- The replace-by-fee validation logic has been updated so that transaction
  ...
  [here](https://delvingbitcoin.org/t/an-overview-of-the-cluster-mempool-proposal/393#rbf-can-now-be-made-incentive-compatible-for-miners-11)
