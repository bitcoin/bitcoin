...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between crownd and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Sample initialization flow from _crown-qt_ console (this needs to be done only once to set up the association):
 ...
 - You should get a response like this "_Association successful. Id: mydrkwalletcrown - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _crown.conf_ and fill in these values
```
keepass=1
...
Extended guide with screenshots is also available: https://crowntalk.org/threads/keepass-integration.3620/
