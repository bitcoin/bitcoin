...
This document provides guidelines for internationalization of the BritanniaCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `britanniacoin_en.ts` remains unchanged.
