...
Only requiring some minor changes is chaincoin.cpp.
...
Changes to chaincoin.cpp
----------------------
chaincoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
