...
application bridge enabled. The following routers are recommended for use with Syscoin Core:
...
The first time Syscoin Core connects to the I2P router, it automatically
...
`i2p_private_key` in the Syscoin Core data directory.  The persistent I2P
...
## Fetching I2P-related information from Syscoin Core
...
It's important that the nodes of a popular application like Syscoin contribute
...
## Bundling I2P in a Syscoin application

Please see the "General Guidance for Developers" section in https://geti2p.net/en/docs/api/samv3
if you are developing a downstream application that may be bundling I2P with Syscoin.
