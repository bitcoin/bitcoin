...
Litecoin Core version 0.21.1 is now available from:

  <https://download.litecoin.org/litecoin-0.21.0/>
...
Upgrading directly from a version of Litecoin Core that has reached its EOL is
possible, but it might take some time if the data directory needs to be migrated. Old
wallet versions of Litecoin Core are generally supported.
...
From Litecoin Core 0.21.1 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, Litecoin Core does not yet change appearance
