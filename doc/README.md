...
Setup
---------------------
Bitcoin Core is the original Bitcoin client, and it builds the backbone of the network. It downloads and, by default, stores the entire history of Bitcoin transactions, which requires a few hundred gigabytes of disk space. Depending on your computer and network connection speed, the synchronization process can take anywhere from a few hours to a day or more.
