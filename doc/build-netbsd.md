...
This guide describes how to build naviod, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run naviod or the GUI.
