- Logging and RPC
  ...
  - Bitcoin Core now provides the specific reason and index of the first
  ...
  - `bad-txns-nonstandard-inputs` message will now be:
    ...
    - `bad-txns-non-witness-sigops-exceeds-bip54-limit`: When the total number of non-witness sigops across the whole transaction exceeds `MAX_TX_LEGACY_SIGOPS`.
