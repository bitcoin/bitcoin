...
From Syscoin Core 4.1.3 onwards, macOS versions earlier than 10.10 are no
longer supported, as Syscoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Syscoin Core does not yet change appearance when
