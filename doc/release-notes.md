Syscoin Core version 0.13.2 is now available from:

  <https://syscoin.org/bin/syscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update syscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow syscoin-tx to create v2 transactions (sysdrak)
