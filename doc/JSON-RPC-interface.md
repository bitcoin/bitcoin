...
The headless daemon `tortoisecoind` has the JSON-RPC API enabled by default, the GUI
...
- **Securing remote network access:** You may optionally allow other
  ...
  `tortoisecoind -help` for more information about these settings and other
