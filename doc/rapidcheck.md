# RapidCheck property-based testing for vBitcoin Core

## Concept

Property-based testing is experimentally being added to vBitcoin Core with
...
If RapidCheck is installed, vBitcoin Core will automatically run the
...
3. Configure vBitcoin Core with RapidCheck.
...
4. Build vBitcoin Core with RapidCheck.
