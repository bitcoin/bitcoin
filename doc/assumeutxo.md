...
**Failure consideration:** if syscoind unexpectedly halts after `m_stop_use` is set on
...
When syscoind initializes again, what began as the snapshot chainstate is now
