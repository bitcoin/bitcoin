...
* dobbscoin.conf: contains configuration settings for dobbscoind or dobbscoin-qt
* dobbscoind.pid: stores the process id of dobbscoind while running
...
* debug.log: contains debug information and general logging generated by dobbscoind or dobbscoin-qt
