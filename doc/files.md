...
* btchd.conf: contains configuration settings for btchdd or btchd-qt
* btchdd.pid: stores the process id of btchdd while running
...
* debug.log: contains debug information and general logging generated by btchdd or btchd-qt
