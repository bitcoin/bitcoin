...
* bitcoin.conf: contains configuration settings for microbitcoind or microbitcoin-qt
* microbitcoind.pid: stores the process id of microbitcoind while running
...
* debug.log: contains debug information and general logging generated by microbitcoind or microbitcoin-qt
