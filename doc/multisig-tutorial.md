...
[PR #22341](https://github.com/bitcoin/bitcoin/pull/22341), which is still under development, introduces a new wallet RPC `gethdkey`. It takes a BIP32 path as an argument and returns the xpub, along with the master key fingerprint.
