...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-liberta executable and locales:
    Delete /REBOOTOK $INSTDIR\liberta.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\liberta-qt.exe
    ...
    WriteRegStr HKCR "liberta" "URL Protocol" ""
    WriteRegStr HKCR "liberta" "" "URL:Liberta"
    WriteRegStr HKCR "liberta\DefaultIcon" "" $INSTDIR\liberta-qt.exe
    WriteRegStr HKCR "liberta\shell\open\command" "" '"$INSTDIR\liberta-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\liberta-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Liberta.lnk"
