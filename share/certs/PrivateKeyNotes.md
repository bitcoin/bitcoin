...
unlocked to sign the Liberta-Qt.app bundle.
...
allowing somebody to distribute a Liberta-Qt.app or liberta-qt-setup.exe with a valid
...
that the liberta-qt.exe file inside the installer had not been tampered with.
