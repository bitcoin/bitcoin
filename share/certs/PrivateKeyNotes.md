...
unlocked to sign the Crowncoin-Qt.app bundle.
...
allowing somebody to distribute a Crowncoin-Qt.app or crowncoin-qt-setup.exe with a valid
...
that the crowncoin-qt.exe file inside the installer had not been tampered with.
