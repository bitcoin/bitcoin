...
unlocked to sign the IoP-Qt.app bundle.
...
allowing somebody to distribute a IoP-Qt.app or iop-qt-setup.exe with a valid
...
that the iop-qt.exe file inside the installer had not been tampered with.
