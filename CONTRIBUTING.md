...
[good first issue](https://github.com/widecoin/widecoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/widecoin/widecoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
...
`#widecoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#widecoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/widecoin-core-dev/](https://www.erisian.com.au/widecoin-core-dev/)
and [https://gnusha.org/widecoin-core-dev/](https://gnusha.org/widecoin-core-dev/).
...
For all other issues and pull requests, the https://github.com/widecoin/widecoin node repository should be used.
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/widecoin/widecoin  # Fetch the latest upstream commit
...
https://github.com/widecoin/widecoin/pull/16189).
