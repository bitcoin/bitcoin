...
First, in terms of structure, there is no particular concept of "Buttcoin Core
...
Before you start contributing, familiarize yourself with the Buttcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Buttcoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/Buttcoin/Buttcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/Buttcoin/Buttcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Buttcoin Core PR Review Club](https://Buttcoincore.reviews/) meeting.
...
`#Buttcoin-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/Buttcoin-core-dev/](http://www.erisian.com.au/Buttcoin-core-dev/)
and [http://gnusha.org/Buttcoin-core-dev/](http://gnusha.org/Buttcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/Buttcoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/Buttcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/Buttcoin/Buttcoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to Buttcoin-qt
...
fork of Buttcoin Core copies the merge. Instead, make any username mentions in a
...
https://github.com/Buttcoin/Buttcoin/pull/16189).

Also see the [backport.py script](
https://github.com/Buttcoin-core/Buttcoin-maintainer-tools#backport).
