Contributing to Bitcoil Core
============================

The Bitcoil Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bitcoil Core
...
Before you start contributing, familiarize yourself with the Bitcoil Core build
system and tests. Refer to the documentation in the repository on how to build
Bitcoil Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Bitcoil Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bitcoil-qt
...
Whether a pull request is merged into Bitcoil Core rests with the project merge
maintainers.
