...
using UpnpSetting = common::Setting<
    "-upnp", std::optional<bool>, common::SettingOptions{.legacy = true},
    "">
...
using CheckPointsSetting = common::Setting<
    ...
    ::HelpFn<[](const auto& help, const auto& defaultChainParams) { return help.Format(defaultChainParams->Checkpoints().GetHeight(), DEFAULT_CHECKPOINTS_ENABLED); }>
    ::Category<OptionsCategory::DEBUG_TEST>;
