...
using RpcWorkQueueSetting = common::Setting<
    "-rpcworkqueue=<n>", int, common::SettingOptions{.legacy = true, .debug_only = true},
...
using RpcThreadsSetting = common::Setting<
    "-rpcthreads=<n>", int, common::SettingOptions{.legacy = true},
...
using BlockreservedweightSetting = common::Setting<
    "-blockreservedweight=<n>", std::optional<int64_t>, common::SettingOptions{.legacy = true},
