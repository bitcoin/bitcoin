...
public:
    ...
    {
        auto new_template = WaitAndCreateNewBlock(chainman(), notifications(), m_node.mempool.get(), m_block_template, options, m_assemble_options, waiting);
    ...
    {
        InterruptWait(notifications(), waiting);
    }
