...
public:
    ...
    TxReconciliationState(bool we_initiate, uint64_t k0, uint64_t k1) : m_we_initiate(we_initiate), m_hasher(k0, k1) {}
    ...
    */
     ...
     */
    Minisketch ComputeExtendedSketch(uint32_t extended_capacity) const;
...
private:
    ...
    void ClearLocalSetSnapshot()
    {
        ...
        m_short_id_mapping_snapshot.clear();
