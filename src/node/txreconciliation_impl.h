 ...
 */
inline constexpr unsigned int BYTES_PER_SKETCH_CAPACITY = RECON_FIELD_SIZE / 8;
 ...
 */
inline constexpr uint32_t MAX_SKETCH_CAPACITY = 2 << 12;
 ...
 */
inline constexpr unsigned int RECON_FALSE_POSITIVE_COEF = 16;
 ...
 */
inline constexpr size_t MAX_RECONSET_SIZE = 3000;
 ...
 */
inline constexpr std::chrono::microseconds RECON_REQUEST_INTERVAL{30s};
...
public:
     ...
     * Returns a error if the registering process fails for any reason, nullopt otherwise.
     */
