...
{
    const auto merged_options{MergeMiningOptions(options, m_block_create_args)};
                                   ...
                                   CAmount fee_threshold) const
{
    ...
    if (snapshot->second.options != FlattenMiningOptions(MergeMiningOptions(options, m_block_create_args))) return false;
