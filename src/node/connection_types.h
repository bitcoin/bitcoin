...
#ifndef SYSCOIN_NODE_CONNECTION_TYPES_H
#define SYSCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/syscoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Syscoin’s Peer-to-Peer Network")
...
#endif // SYSCOIN_NODE_CONNECTION_TYPES_H
