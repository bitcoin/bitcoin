...
#ifndef WIDECOIN_NODE_CONNECTION_TYPES_H
#define WIDECOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/widecoin-cli.cpp::NetinfoRequestHandler. */
...
#endif // WIDECOIN_NODE_CONNECTION_TYPES_H
