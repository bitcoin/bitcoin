...
// void CMainSignals::ScriptForMining(const std::shared_ptr<const CReserveScript> &preservescript) {
//     m_internals->GetScriptForMiningScriptForMining(preservescript);
// }
