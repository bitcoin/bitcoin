...
struct MainSignalsInstance {
    ...
    boost::signals2::signal<void (const CBlockIndex *, const std::shared_ptr<const CBlock>&)> NewPoCValidBlock;
...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NewPoCValidBlock.connect(boost::bind(&CValidationInterface::NewPoCValidBlock, pwalletIn, _1, _2));
}
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    g_signals.m_internals->NewPoCValidBlock.disconnect(boost::bind(&CValidationInterface::NewPoCValidBlock, pwalletIn, _1, _2));
}
...
void UnregisterAllValidationInterfaces() {
    ...
    g_signals.m_internals->NewPoCValidBlock.disconnect_all_slots();
}
...
void CMainSignals::NewPoCValidBlock(const CBlockIndex *pindex, const std::shared_ptr<const CBlock> &block) {
    m_internals->NewPoCValidBlock(pindex, block);
}
