...
static void SetupBitcointalkcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcointalkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcointalkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bitcointalkcoin transaction\n" +
            "or:     bitcointalkcoin-tx [options] -create [commands]   Create hex-encoded bitcointalkcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcointalkcoin transaction
