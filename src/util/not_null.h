...
#ifndef BITCOIN_UTIL_NOT_NULL_H
#define BITCOIN_UTIL_NOT_NULL_H
...
public:
    ...
    constexpr explicit(!std::convertible_to<U, T>)
        NotNull(NotNull<U>&& other) noexcept(std::is_nothrow_move_constructible_v<U> && std::is_nothrow_constructible_v<T, U&&>)
