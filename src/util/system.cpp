...
const char * const BITCOIN_CONF_FILENAME = "bitcoin-staking.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitcoin-staking
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitcoin-staking
    // Mac: ~/Library/Application Support/Bitcoin-staking
    // Unix: ~/.bitcoin-staking
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoin-staking";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitcoin-staking";
#else
    // Unix
    return pathRet / ".bitcoin-staking";
#endif
#endif
}
