 ...
 */
#ifndef Buttcoin_UTIL_SYSTEM_H
#define Buttcoin_UTIL_SYSTEM_H
...
extern const char * const Buttcoin_CONF_FILENAME;
extern const char * const Buttcoin_SETTINGS_FILENAME;
