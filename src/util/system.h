 ...
 */
#ifndef XBIT_UTIL_SYSTEM_H
#define XBIT_UTIL_SYSTEM_H
...
extern const char * const XBIT_CONF_FILENAME;
extern const char * const XBIT_SETTINGS_FILENAME;
