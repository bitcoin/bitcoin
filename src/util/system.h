...
bool StartGethNode(const std::string &exePath, pid_t &pid, bool bGethTestnet = false, int websocketport=8546);
bool StopGethNode(pid_t &pid);
fs::path GetRelayerPidFile();
std::string GeteRelayerFilename();
bool StartRelayerNode(const std::string &exePath, pid_t &pid, int rpcport, const std::string& rpcuser, const std::string& rpcpassword, int websocketport=8546);
