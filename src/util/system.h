 ...
 */
#ifndef REVOLT_UTIL_SYSTEM_H
#define REVOLT_UTIL_SYSTEM_H
...
extern const char * const REVOLT_CONF_FILENAME;
extern const char * const REVOLT_SETTINGS_FILENAME;
