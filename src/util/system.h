...
bool StartGethNode(const std::string &exePath, pid_t &pid, int websocketport=8646);
bool StopGethNode(pid_t &pid);
fs::path GetRelayerPidFile();
std::string GeteRelayerFilename();
bool StartRelayerNode(const std::string &exePath, pid_t &pid, int rpcport, int websocketport=8646);
