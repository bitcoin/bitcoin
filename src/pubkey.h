...
public:
    ...
    [[nodiscard]] bool Derive(CPubKey& pubkeyChild, ChainCode &ccChild, unsigned int nChild, const ChainCode& cc, uint256* tweak_out = nullptr) const;
};
...
struct CExtPubKey {
    ...
    [[nodiscard]] bool Derive(CExtPubKey& out, unsigned int nChild, uint256* tweak_out = nullptr) const;
};
