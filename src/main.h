...
static const int MAX_BLOCKS_IN_TRANSIT_PER_PEER = 1; // BU request manager just needs one per peer
...
static const unsigned int BLOCK_DOWNLOAD_WINDOW = 6; // BU request manager doesn't need to look ahead so far
