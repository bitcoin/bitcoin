...
bool CGovernanceManager::GetObjectForHash(uint256 nHash, CGovernanceObject& obj)
{
    LOCK(cs);
...
bool CGovernanceManager::GetVoteForHash(uint256 nHash, CGovernanceVote& vote)
{
    LOCK(cs);
