...
const std::string CURRENCY_UNIT = "SNAIL"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    SNAIL_KVB,      //!< Use SNAIL/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SNAIL_KVB) const;
