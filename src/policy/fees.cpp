...
void CBlockPolicyEstimator::FlushFeeEstimates()
{
    ...
    // that data may is lost and not recoverable after a restart.
    // It is also possible that MaxUsableEstimate > 0, but not have enough stats to provide an estimate.
    //
