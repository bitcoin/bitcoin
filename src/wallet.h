...
public:
    ...
    bool CreateDepositTransaction(Credits_CWallet *deposit_wallet, const std::pair<CScript, int64_t>& vecSend,
                           Credits_CWalletTx& wtxNew, Credits_CReserveKey& reservekey, const int64_t & nTotalIn, std::string& strFailReason, const Credits_COutput& coin, Credits_CCoinsViewCache &credits_view, Bitcoin_CCoinsViewCache &bitcoin_view);
    bool CreateClaimTransaction(Bitcoin_CWallet *bitcoin_wallet, Bitcoin_CCoinsViewCache *claim_view, const std::vector<std::pair<CScript, int64_t> >& vecSend,
                           Credits_CWalletTx& wtxNew, Credits_CReserveKey& reservekey, int64_t& nFeeRet, std::string& strFailReason, const CCoinControl *coinControl = NULL);
