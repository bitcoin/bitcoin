...
#if defined(NDEBUG)
# error "Flow cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Flow Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FLW additional fees, %d delta bytes\n",
