...
public:
    ...
    struct ATMPArgs {
        ...
        /** Whether we are validating as a package */
        const bool m_package_validation;
    };
...
bool MemPoolAccept::Finalize(const ATMPArgs& args, Workspace& ws)
{
    ...
    if (!args.m_package_validation && !bypass_limits) {
