...
#if defined(NDEBUG)
# error "Dobbscoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Dobbscoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SLACK additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (consensusParams.fPowAllowMinDifficultyBlocks && nHeight >= 150) { nSubsidy = 10 * COIN; }
...
void ThreadScriptCheck() {
    RenameThread("dobbscoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Dobbscoin: Always enforce BIP30
