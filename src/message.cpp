...
UniValue messagenew(const UniValue& params, bool fHelp) {
	...
	newMessage.vchData = vchFromString(strMessage);
	...
	newMessage.vchEncryptionPublicKey = vchFromString(strEncryptionPublicKey);
	newMessage.vchEncryptionPrivateKeyFrom = vchFromString(strEncryptionPrivateKeyFrom);
	newMessage.vchEncryptionPrivateKeyTo = vchFromString(strEncryptionPrivateKeyTo);
...
void MessageTxToJSON(const int op, const std::vector<unsigned char> &vchData, const std::vector<unsigned char> &vchHash, UniValue &entry)
{
	...
	strEncryptionPrivateKeyFrom = stringFromVch(message.vchEncryptionPrivateKeyFrom);
	strEncryptionPrivateKeyTo = stringFromVch(message.vchEncryptionPrivateKeyTo);
	...
	string strDecrypted = "";
	string strData = "";
	strData = stringFromVch(message.vchData);
