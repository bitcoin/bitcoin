...
void run_silentpayments_test_vector_send(const struct bip352_test_vector *test) {
    ...
    static secp256k1_keypair taproot_keypairs[MAX_INPUTS_PER_TEST_CASE];
    static secp256k1_keypair const *taproot_keypair_ptrs[MAX_INPUTS_PER_TEST_CASE];
    static unsigned char const *plain_seckeys[MAX_INPUTS_PER_TEST_CASE];
...
void run_silentpayments_test_vector_receive(const struct bip352_test_vector *test) {
    static secp256k1_pubkey plain_pubkeys_objs[MAX_INPUTS_PER_TEST_CASE];
    ...
    static secp256k1_pubkey const *plain_pubkeys[MAX_INPUTS_PER_TEST_CASE];
