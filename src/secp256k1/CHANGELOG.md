...
#### Added
  - Added tests against [Project Wycheproof's](https://github.com/C2SP/wycheproof/) set of ECDSA test vectors (Snailcoin "low-S" variant), a fixed set of test cases designed to trigger various edge cases.
