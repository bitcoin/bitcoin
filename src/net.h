...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 8; //8; // Cybersecurity Lab
/** Maximum number of addnode outgoing nodes */
static const int MAX_ADDNODE_CONNECTIONS = 8; //8; // Cybersecurity Lab
/** Maximum number of block-relay-only outgoing connections */
static const int MAX_BLOCKS_ONLY_CONNECTIONS = 2; // 2; // Cybersecurity Lab
/** Maximum number of feeler connections */
static const int MAX_FEELER_CONNECTIONS = 1; // 1; // Cybersecurity Lab
/** -listen default */
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 150; //125; // Cybersecurity Lab
