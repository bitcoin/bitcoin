...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 10000; //8; // Cybersecurity Lab
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 10000; //125; // Cybersecurity Lab
