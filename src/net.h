...
static const int MAX_OUTBOUND_FULL_RELAY_CONNECTIONS = 2000; //8; // Cybersecurity Lab
/** Maximum number of addnode outgoing nodes */
static const int MAX_ADDNODE_CONNECTIONS = 2000; //8; // Cybersecurity Lab
...
static const unsigned int DEFAULT_MAX_PEER_CONNECTIONS = 2000; //125; // Cybersecurity Lab
