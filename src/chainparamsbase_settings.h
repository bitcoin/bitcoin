...
using TestActivationHeightSetting = common::Setting<
    ...
    "Set the activation height of 'name' (segwit, bip34, dersig, cltv, csv). (test-only)">
...
using VbParamsSetting = common::Setting<
    ...
    "Use given start/end times and min_activation_height for specified version bits deployment (test-only)">
