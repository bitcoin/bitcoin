...
/**
 * Under BIP54, the timestamp of the first block in a difficulty adjustment period must be superior
 * or equal to the timestamp of the last block of the previous period minus two hours (7200 seconds).
 */
...
/** The maximum number of potentially executed legacy (non-Segwit) signature operations in a single tx */
