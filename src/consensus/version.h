...
#ifndef BITCOIN_CONSENSUS_VERSION_H
#define BITCOIN_CONSENSUS_VERSION_H

/**
 * network protocol versioning
 */

static constexpr int PROTOCOL_VERSION = 70016;

//! initial proto version, to be increased after version/verack negotiation
static constexpr int INIT_PROTO_VERSION = 209;

//! disconnect from peers older than this proto version
static constexpr int MIN_PEER_PROTO_VERSION = 31800;
...
static constexpr int WTXID_RELAY_VERSION = 70016;

// Make sure that none of the values above collide with
// `SERIALIZE_TRANSACTION_NO_WITNESS` or `ADDRV2_FORMAT`.

#endif // BITCOIN_CONSENSUS_VERSION_H
