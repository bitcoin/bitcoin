...
#ifndef TORTOISECOIN_HEADERSSYNC_H
#define TORTOISECOIN_HEADERSSYNC_H
 ...
 *
 * The Tortoisecoin protocol does not offer an easy way to determine the work on a
...
#endif // TORTOISECOIN_HEADERSSYNC_H
