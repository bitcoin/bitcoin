...
void ReceiveRequestDialog::update()
{
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SyscoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSyscoinURI(info));
}
