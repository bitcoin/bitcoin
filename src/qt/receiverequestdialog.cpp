...
#include "config/liberta-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLibertaURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + LibertaUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLibertaURI(info));
}
