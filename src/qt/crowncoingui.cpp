<<<<<<< HEAD:src/qt/bitcoingui.cpp
// Copyright (c) 2011-2014 The Bitcoin developers
// Copyright (c) 2014-2015 The Crown developers
=======
// Copyright (c) 2011-2014 The Crowncoin developers
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
const QString CrowncoinGUI::DEFAULT_WALLET = "~Default";

<<<<<<< HEAD:src/qt/bitcoingui.cpp
BitcoinGUI::BitcoinGUI(const NetworkStyle *networkStyle, QWidget *parent) :
=======
CrowncoinGUI::CrowncoinGUI(bool fIsTestnet, QWidget *parent) :
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
    QMainWindow(parent),
    clientModel(0),
    walletFrame(0),
...
=======
    QString windowTitle = tr("Crowncoin") + " - ";
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
#ifdef ENABLE_WALLET
...
#endif
=======
        QApplication::setWindowIcon(QIcon(":icons/crowncoin"));
        setWindowIcon(QIcon(":icons/crowncoin"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/crowncoin"));
#endif
    }
    else
    {
...
#ifndef Q_OS_MAC
        QApplication::setWindowIcon(QIcon(":icons/crowncoin_testnet"));
        setWindowIcon(QIcon(":icons/crowncoin_testnet"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/crowncoin_testnet"));
#endif
    }
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
=======
void CrowncoinGUI::createActions(bool fIsTestnet)
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
{
...
=======
    sendCoinsAction->setStatusTip(tr("Send coins to a Crowncoin address"));
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
=======
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crowncoin: URIs)"));
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
=======
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/crowncoin"), tr("&About Crowncoin"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/crowncoin_testnet"), tr("&About Crowncoin"), this);
    aboutAction->setStatusTip(tr("Show information about Crowncoin"));
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
=======
    optionsAction->setStatusTip(tr("Modify configuration options for Crowncoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/crowncoin"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/crowncoin_testnet"), tr("&Show / Hide"), this);
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
=======
    signMessageAction->setStatusTip(tr("Sign messages with your Crowncoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Crowncoin addresses"));
...
void CrowncoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void CrowncoinGUI::createToolBars()
{
    if(walletFrame)
    {
...
void CrowncoinGUI::setClientModel(ClientModel *clientModel)
{
...
#ifdef ENABLE_WALLET
bool CrowncoinGUI::addWallet(const QString& name, WalletModel *walletModel)
{
    if(!walletFrame)
        return false;
...
bool CrowncoinGUI::setCurrentWallet(const QString& name)
{
    if(!walletFrame)
        return false;
...
void CrowncoinGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void CrowncoinGUI::setWalletActionsEnabled(bool enabled)
{
...
=======
void CrowncoinGUI::createTrayIcon(bool fIsTestnet)
{
#ifndef Q_OS_MAC
    trayIcon = new QSystemTrayIcon(this);
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Crowncoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Crowncoin client") + " " + tr("[testnet]"));
...
void CrowncoinGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void CrowncoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void CrowncoinGUI::optionsClicked()
{
...
void CrowncoinGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void CrowncoinGUI::showHelpMessageClicked()
{
...
void CrowncoinGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
...
void CrowncoinGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void CrowncoinGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void CrowncoinGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void CrowncoinGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
#endif // ENABLE_WALLET

void CrowncoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
=======
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Crowncoin network", "", count));
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
}

void CrowncoinGUI::setNumBlocks(int count)
{
    if(!clientModel)
        return;
...
void CrowncoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
<<<<<<< HEAD:src/qt/bitcoingui.cpp
    QString strTitle = tr("Crown Core"); // default title
=======
    QString strTitle = tr("Crowncoin"); // default title
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
...
void CrowncoinGUI::changeEvent(QEvent *e)
{
...
void CrowncoinGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MAC // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
=======
void CrowncoinGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
{
    ...
    message((amount)<0 ? tr("Sent transaction") : tr("Incoming transaction"),
             tr("Date: %1\n"
                ...
                "Address: %4\n")
                  .arg(date)
                  .arg(CrowncoinUnits::formatWithUnit(unit, amount, true))
                  .arg(type)
                  .arg(address), CClientUIInterface::MSG_INFORMATION);
}
#endif // ENABLE_WALLET

void CrowncoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void CrowncoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool CrowncoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool CrowncoinGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void CrowncoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void CrowncoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void CrowncoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void CrowncoinGUI::detectShutdown()
{
...
=======
static bool ThreadSafeMessageBox(CrowncoinGUI *gui, const std::string& message, const std::string& caption, unsigned int style)
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoingui.cpp
{
...
void CrowncoinGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void CrowncoinGUI::unsubscribeFromCoreSignals()
{
