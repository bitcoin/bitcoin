...
#ifndef LIBERTA_QT_LIBERTAGUI_H
#define LIBERTA_QT_LIBERTAGUI_H
...
/**
  LibertaGUI main class. This class represents the main window of the LibertaUI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LibertaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LibertaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~LibertaGUI();
