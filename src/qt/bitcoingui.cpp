...
void BitcoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, [[maybe_unused]] SynchronizationState sync_state)
{
