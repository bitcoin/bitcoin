    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Aither Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aither address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Aither Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aither Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aither Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aither addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aither addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Aither Core help message to get a list with possible Aither Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Aither Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aither network", "", count));
}
...
{
    QString strTitle = tr("Aither Core"); // default title
