    ...
    platformStyle(_platformStyle)
{
    ...
    // normal Buttcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying Buttcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ButtcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
