    ...
    platformStyle(_platformStyle)
{
    ...
    // normal xbit address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying xbit address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &XBitAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
