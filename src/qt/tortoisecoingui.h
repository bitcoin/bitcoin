...
#ifndef TORTOISECOIN_QT_TORTOISECOINGUI_H
#define TORTOISECOIN_QT_TORTOISECOINGUI_H
...
/**
  Tortoisecoin GUI main class. This class represents the main window of the Tortoisecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TortoisecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TortoisecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~TortoisecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a tortoisecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, TortoisecoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Tortoisecoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(TortoisecoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // TORTOISECOIN_QT_TORTOISECOINGUI_H
