...
{
    // Test regression https://github.com/widecoin/widecoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/widecoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/widecoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Widecoin/Widecoin-Qt.conf and all else left as default,
    // widecoin-qt should set both -listen and -listenonion to false and start successfully.
