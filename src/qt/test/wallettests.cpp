...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BritanniaCoinAmountField*>("payAmount")->setValue(amount);
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = BritanniaCoinUnits::formatWithUnit(unit, expected_balance, false, BritanniaCoinUnits::SeparatorStyle::ALWAYS);
...
void TestGUI(interfaces::Node& node)
{
    ...
    // Amount input
    BritanniaCoinAmountField* amountInput = receiveCoinsDialog.findChild<BritanniaCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QCOMPARE(uri.count("britanniacoin:"), 2);
