...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<XBitAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_xbit-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_xbit-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_xbit-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = XBitUnits::formatWithUnit(unit, balance, false, XBitUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    XBitAmountField* amountInput = receiveCoinsDialog.findChild<XBitAmountField*>("reqAmount");
