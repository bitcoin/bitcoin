...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_Buttcoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_Buttcoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_Buttcoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = ButtcoinUnits::formatWithUnit(unit, balance, false, ButtcoinUnits::SeparatorStyle::ALWAYS);
