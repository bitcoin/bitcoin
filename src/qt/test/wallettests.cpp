...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_tortoisecoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_tortoisecoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_tortoisecoin-qt  # macOS
