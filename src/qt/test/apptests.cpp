...
//! Entry point for XBitApplication tests.
void AppTests::appTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping AppTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_xbit-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    ...
    connect(&m_app, &XBitApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for XBitGUI tests.
void AppTests::guiTests(XBitGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &XBitGUI::consoleShown, this, &AppTests::consoleTests);
