...
void AppTests::appTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping AppTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_britanniacoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    ...
    connect(&m_app, &BritanniaCoinApplication::windowShown, this, &AppTests::guiTests);
...
void AppTests::guiTests(BritanniaCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BritanniaCoinGUI::consoleShown, this, &AppTests::consoleTests);
