...
//! Entry point for ButtcoinApplication tests.
void AppTests::appTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping AppTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_Buttcoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    ...
    connect(&m_app, &ButtcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ButtcoinGUI tests.
void AppTests::guiTests(ButtcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ButtcoinGUI::consoleShown, this, &AppTests::consoleTests);
