...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // Realod on primary address changed
        connect(_walletModel, &WalletModel::primaryAddressChanged, _walletModel->getAddressTableModel(), &AddressTableModel::primaryAddressChanged);
    }
}
