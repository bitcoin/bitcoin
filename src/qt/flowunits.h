...
#ifndef FLOW_QT_FLOWUNITS_H
#define FLOW_QT_FLOWUNITS_H
...
/** Flow unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FlowUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FlowUnits(QObject *parent);

    /** Flow units.
      @note Source: https://en.flow.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FLW,
...
typedef FlowUnits::Unit FlowUnit;

#endif // FLOW_QT_FLOWUNITS_H
