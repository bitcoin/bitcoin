...
#ifndef WIDECOIN_QT_WIDECOINGUI_H
#define WIDECOIN_QT_WIDECOINGUI_H
...
/**
  Widecoin GUI main class. This class represents the main window of the Widecoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class WidecoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit WidecoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~WidecoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a widecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Widecoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(WidecoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // WIDECOIN_QT_WIDECOINGUI_H
