...
QT_TRANSLATE_NOOP("chaincoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Error loading wallet %s. -wallet filename must be a regular file."),
QT_TRANSLATE_NOOP("chaincoin-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
QT_TRANSLATE_NOOP("chaincoin-core", "Error loading wallet %s. Invalid characters in -wallet filename."),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Maintain at most <n> connections to peers (default: %u)"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Print this help message and exit"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Send transactions with full-RBF opt-in enabled (RPC only, default: %u)"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Set maximum BIP141 block weight (default: %d)"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Unknown change type '%s'"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "Wallet debugging/testing options:"),
...
QT_TRANSLATE_NOOP("chaincoin-core", "You need to rebuild the database using -reindex to change -txindex"),
