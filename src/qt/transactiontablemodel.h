...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, SnailcoinUnits::SeparatorStyle separators=SnailcoinUnits::SeparatorStyle::STANDARD) const;
