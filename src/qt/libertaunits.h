...
#ifndef LIBERTA_QT_LIBERTAUNITS_H
#define LIBERTA_QT_LIBERTAUNITS_H
...
/** Libertaunit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LibertaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LibertaUnits(QObject *parent);

    /** Libertaunits.
      @note Source: https://en.liberta.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LBT,
...
private:
    QList<LibertaUnits::Unit> unitlist;
};
typedef LibertaUnits::Unit LibertaUnit;

#endif // LIBERTA_QT_LIBERTAUNITS_H
