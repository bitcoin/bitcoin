...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, masternode_info_t& infoMn)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(infoMn.fInfoValid ? CSyscoinAddress(infoMn.pubKeyCollateralAddress.GetID()).ToString() : ""));
