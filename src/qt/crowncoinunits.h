...
#ifndef CROWNCOINUNITS_H
#define CROWNCOINUNITS_H
...
*/
class CrowncoinUnits: public QAbstractListModel
{
    Q_OBJECT
...
=======
    /** Crowncoin units.
      @note Source: https://en.crowncoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CRW,
...
typedef CrowncoinUnits::Unit CrowncoinUnit;

<<<<<<< HEAD:src/qt/bitcoinunits.h
#endif // BITCOIN_QT_BITCOINUNITS_H
=======
#endif // CROWNCOINUNITS_H
>>>>>>> origin/dirty-merge-dash-0.11.0:src/qt/crowncoinunits.h
