...
/** Widget for entering widecoin amounts.
  */
class WidecoinAmountField: public QWidget
{
    Q_OBJECT

    // ugly hack: for some unknown reason CAmount (instead of qint64) does not work here as expected
    // discussion: https://github.com/widecoin/widecoin/pull/5117
...
#endif // WIDECOIN_QT_WIDECOINAMOUNTFIELD_H
