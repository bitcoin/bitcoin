...
QString BitcoinUnits::longName(int unit)
{
    ...
    case ATM: return QString("Atoms (ATM)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case DYN: return QString("Dynamo");
    case ATM: return QString("Atom");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case DYN: return QString("Dynamo");
    case ATM: return QString("Atoms (ATM) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
