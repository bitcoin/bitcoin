...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog *dialog, GameunitsBridge *bridge)
{
    if (!model) return;
    ...
    } else
    {
        ...
        int nDisplayUnit = BitcoinUnits::GAMEUNITS;
        ...
        l8->setStyleSheet((nChange > 0 && nChange < CENT) ? "color:red;" : ""); // Change < 0.01GAMEUNITS
