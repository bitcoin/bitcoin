...
#ifndef MINER_COINCONTROLDIALOG_H
#define MINER_COINCONTROLDIALOG_H
...
namespace Ui {
    class Miner_CoinControlDialog;
}
class Bitcredit_WalletModel;
class CCoinControl;

class Miner_CoinControlDialog : public QDialog
{
    Q_OBJECT

public:
    explicit Miner_CoinControlDialog(QWidget *parent = 0);
    ~Miner_CoinControlDialog();
...
#endif // MINER_COINCONTROLDIALOG_H
