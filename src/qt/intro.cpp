...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/liberta"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Liberta Core"),
     ...
     * override -datadir in the liberta.conf file in the default data directory
     * (to be consistent with libertad behavior)
     */
    if(dataDir != getDefaultDataDirectory())
