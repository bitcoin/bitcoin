...
#ifndef MINERDEPOSITSVIEW_H
#define MINERDEPOSITSVIEW_H
...
/** Widget showing the transaction list for a wallet, including a filter row.
  ...
  */
class MinerDepositsView : public QWidget
{
    Q_OBJECT

public:
    explicit MinerDepositsView(QWidget *parent = 0);
