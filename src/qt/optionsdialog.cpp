    ...
    mapper(nullptr)
{
    ...
    /* Wallet elements init */
#ifndef ENABLE_OMNICORE
    ui->enableOmniCore->setVisible(false);
    ui->enableOmniCore->setEnabled(false);
#endif
    ...
    ui->bitcoinAtStartup->setToolTip(ui->bitcoinAtStartup->toolTip().arg(BitcoinGUI::tr(PACKAGE_NAME)));
    ui->bitcoinAtStartup->setText(ui->bitcoinAtStartup->text().arg(BitcoinGUI::tr(PACKAGE_NAME)));

    ui->openBitcoinConfButton->setToolTip(ui->openBitcoinConfButton->toolTip().arg(BitcoinGUI::tr(PACKAGE_NAME)));

    ui->lang->setToolTip(ui->lang->toolTip().arg(BitcoinGUI::tr(PACKAGE_NAME)));
...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    connect(ui->enableOmniCore, &QCheckBox::clicked, this, &OptionsDialog::showRestartWarning);
#endif
    /* Network */
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->enableOmniCore, OptionsModel::EnableOmniCore);
