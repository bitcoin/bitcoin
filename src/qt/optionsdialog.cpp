    ...
    mapper(nullptr)
{
    ...
    ui->ButtcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ButtcoinAtStartup);
    ...
    ui->ButtcoinAtStartup->setToolTip(ui->ButtcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ButtcoinAtStartup->setText(ui->ButtcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openButtcoinConfButton->setToolTip(ui->openButtcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ButtcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ButtcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openButtcoinConfButton_clicked()
{
