      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->tortoisecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tortoisecoinAtStartup);
    ...
    ui->tortoisecoinAtStartup->setToolTip(ui->tortoisecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->tortoisecoinAtStartup->setText(ui->tortoisecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openTortoisecoinConfButton->setToolTip(ui->openTortoisecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TortoisecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tortoisecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTortoisecoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openTortoisecoinConf())
