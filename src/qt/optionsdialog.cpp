...
// Copyright (c) 2023 The BritanniaCoin Development Team (Britannia Coin Ltd), The Bitcoin Core Developers
      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->britanniacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->britanniacoinAtStartup);
    ...
    ui->britanniacoinAtStartup->setToolTip(ui->britanniacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->britanniacoinAtStartup->setText(ui->britanniacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openBritanniaCoinConfButton->setToolTip(ui->openBritanniaCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BritanniaCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->britanniacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBritanniaCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openBritanniaCoinConf())
