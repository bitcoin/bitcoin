...
QT_TRANSLATE_NOOP("widecoin-core", ""
"Error: Dumpfile version is not supported. This version of widecoin-wallet "
...
QT_TRANSLATE_NOOP("widecoin-core", "Dump file %s does not exist."),
QT_TRANSLATE_NOOP("widecoin-core", "Error creating %s"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Error reading next record from wallet database"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Could not add watchonly tx to watchonly wallet"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Could not delete watchonly transactions"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Couldn't create cursor into database"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Dumpfile checksum does not match. Computed %s, expected %s"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Failed to create new watchonly wallet"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Got key that was not hex: %s"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Got value that was not hex: %s"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Missing checksum"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: No %s addresses available."),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Not all watchonly txs could be deleted"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: This wallet already uses SQLite"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: This wallet is already a descriptor wallet"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to begin reading all records in the database"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to make a backup of your wallet"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to parse version %u as a uint32_t"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to read all records in the database"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to remove watchonly address book data"),
QT_TRANSLATE_NOOP("widecoin-core", "Error: Unable to write record to new wallet"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Listening for incoming connections failed (listen returned error %s)"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Unable to allocate memory for -maxsigcachesize: '%s' MiB"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Unable to find UTXO for external input"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Unable to unload the wallet before migrating"),
...
QT_TRANSLATE_NOOP("widecoin-core", "Unsupported global logging level -loglevel=%s. Valid values: %s."),
