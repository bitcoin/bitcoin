...
#ifndef REVOLT_QT_OPTIONSMODEL_H
#define REVOLT_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Revolt client.
...
public:
    ...
    RevoltUnit getDisplayUnit() const { return m_display_revolt_unit; }
...
private:
    ...
    QString language;
    RevoltUnit m_display_revolt_unit;
...
Q_SIGNALS:
    void displayUnitChanged(RevoltUnit unit);
    void coinControlFeaturesChanged(bool);
    void showTrayIconChanged(bool);
    void useEmbeddedMonospacedFontChanged(bool);
};

#endif // REVOLT_QT_OPTIONSMODEL_H
