...
/** Interface from Qt to configuration data structure for Snailcoin client.
...
public:
    ...
    SnailcoinUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSSNAILontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    SnailcoinUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(SnailcoinUnit unit);
