...
#ifndef TALKCOIN_QT_TALKCOINUNITS_H
#define TALKCOIN_QT_TALKCOINUNITS_H
...
public:
    ...
    /** Talkcoin units.
      @note Source: https://en.talkcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TALK,
...
#endif // TALKCOIN_QT_TALKCOINUNITS_H
