    ...
    platformStyle(_platformStyle)
{
    ...
    ui->openDebugLogfileButton->setToolTip(ui->openDebugLogfileButton->toolTip().arg(BitcoinGUI::tr(PACKAGE_NAME)));
    ...
    connect(ui->promptIcon, &QPushButton::clicked, this, &RPCConsole::inputMultilineCommand);
...
void RPCConsole::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the %1 RPC console.").arg(BitcoinGUI::tr(PACKAGE_NAME)) + "<br>" +
...
void RPCConsole::inputMultilineCommand()
{
#if (QT_VERSION >= QT_VERSION_CHECK(5, 2, 0))
    bool fOk = false;
    QString cmd = QInputDialog::getMultiLineText(this, this->windowTitle(), tr("Input command:"), ui->lineEdit->text().replace("\t", "\n"), &fOk);
    if (fOk) {
