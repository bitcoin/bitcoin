...
public:
    ...
    explicit SyscoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~SyscoinGUI();
...
public Q_SLOTS:
    ...
    /** SYSCOIN Get restart command-line parameters and request restart */
