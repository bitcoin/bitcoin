...
public:
    ...
    void TransactionAddedToMempool(const CTransactionRef&, uint64_t mempool_sequence) override;
};
...
void NetWatchValidationInterface::TransactionAddedToMempool(const CTransactionRef& tx, uint64_t mempool_sequence)
{
    model.LogTransaction(tx);
}
