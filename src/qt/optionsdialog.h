...
#ifndef TORTOISECOIN_QT_OPTIONSDIALOG_H
#define TORTOISECOIN_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openTortoisecoinConfButton_clicked();
...
#endif // TORTOISECOIN_QT_OPTIONSDIALOG_H
