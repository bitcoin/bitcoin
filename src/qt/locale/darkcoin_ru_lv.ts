<?xml version="1.0" ?><!DOCTYPE TS><TS language="ru_lv" version="2.1">
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Выбрать все/отменить</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>При отключении траты неподтверждённой сдачи, сдача от транзакции не может быть использована до тех пор, пока у этой транзакции не будет хотя бы одно подтверждение. Это также влияет как  рассчитывается Ваш баланс.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Darkcoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP и данная функция на нем включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сворачивать приложение вместо завершения работы при закрытии окна. Если данная опция будет выбрана — приложение закроется только после выбора в меню пункта Завершить.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отображать суммы в &amp;единицах измерения:</translation>
    </message>
    <message>
        <location filename="../forms/optionsdialog.ui" line="527"/>
        <location filename="../forms/ui_optionsdialog.h" line="597"/>
        <source>Choose the default subdivision unit to show in the interface and when sending coins.</source>
        <translation>Выберите единицу измерения, используемую по умолчанию при отображении и отправке монет.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сторонние URL (например, эксплорер блоков), которые отображаются на вкладке транзакций как пункты контекстного меню. %s в URL заменяется хэшем транзакции. Несколько URL отделяются друг от друга вертикальной чертой |.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Активные опции командной строки, которые перекрывают вышеуказанные настройки:</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Darkcoin после подключения, но этот процесс еще не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предоставленные деноминации:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Попробовать перемешать</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл Darkcoin из текущего каталога данных.  Для больших лог-файлов это действие может занимать несколько секунд.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Примечание: сообщение не будет отправлено вместе с платежом через сеть Darkcoin.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Заполните эту форму для запроса платежей. Все поля  &lt;b&gt;необязательны&lt;/b&gt;.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>К darkcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией только для вашего сведения. Примечание: сообщение не будет отправлено через сеть Darkcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес, которым вы хотите подписать сообщение  (напр. XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwg)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом Darkcoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сбросить все поля формы подписи сообщения</translation>
    </message>
    <message>
