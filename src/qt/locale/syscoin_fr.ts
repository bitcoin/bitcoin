...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation type="unfinished">Ce sont vos adresses Syscoin pour recevoir des paiements. Utilisez le bouton « Créer une nouvelle adresse de réception » dans l’onglet Recevoir afin de créer de nouvelles adresses.
