...
#ifndef REVOLT_QT_REVOLTGUI_H
#define REVOLT_QT_REVOLTGUI_H
...
public:
    ...
    explicit RevoltGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~RevoltGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a revolt wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, RevoltUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Revolt Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(RevoltUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // REVOLT_QT_REVOLTGUI_H
