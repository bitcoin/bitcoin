#ifndef BITCOINTALKCOINMOBILEGUI_H
#define BITCOINTALKCOINMOBILEGUI_H
...
class BitcointalkcoinMobileGUI : public QQuickView
{
    Q_OBJECT

public:
    BitcointalkcoinMobileGUI(interfaces::Node& node, const PlatformStyle *m_platformStyle, const NetworkStyle *networkStyle, QWindow *parent = nullptr);
...
private Q_SLOTS:
    void requestBitcointalkcoin();
    void sendBitcointalkcoin(QString address, int amount, int confirmations);
...
#endif // BITCOINTALKCOINMOBILEGUI_H
