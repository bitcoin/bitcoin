...
#ifndef NAVCOIN_BLSCT_ARITH_GENERATORS_H
#define NAVCOIN_BLSCT_ARITH_GENERATORS_H
...
public:
    ...
    static void Init(const size_t bit_size, const size_t max_value_vec_len);
...
#endif // NAVCOIN_BLSCT_ARITH_GENERATORS_H
