...
static std::vector<bls::G1Element> HadamardFold(
    const std::vector<bls::G1Element> &vec, const std::vector<Scalar> *scale, const Scalar &a, const Scalar &b)
{
    if(!((vec.size() & 1) == 0))
...
bls::G1Element CrossVectorExponent(
    size_t size, 
    const std::vector<bls::G1Element> &A, 
    size_t Ao, 
    const std::vector<bls::G1Element> &B, 
    size_t Bo, 
    ...
    const bls::G1Element *extra_point, 
