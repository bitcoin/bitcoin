...
#ifndef NAVIO_BLSCT_BUILDING_BLOCK_G_H_GI_HI_ZERO_VERIFIER_H
#define NAVIO_BLSCT_BUILDING_BLOCK_G_H_GI_HI_ZERO_VERIFIER_H
...
#endif // NAVIO_BLSCT_BUILDING_BLOCK_G_H_GI_HI_ZERO_VERIFIER_H
