...
static void SetupTalkcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " talkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  talkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded talkcoin transaction\n" +
            "or:     talkcoin-tx [options] -create [commands]   Create hex-encoded talkcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded talkcoin transaction
