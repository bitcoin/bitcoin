...
class SnailcoinNodeInit : public interfaces::Init
{
public:
    SnailcoinNodeInit(node::NodeContext& node, const char* arg0)
        : m_node(node),
...
{
    auto init = std::make_unique<init::SnailcoinNodeInit>(node, argc > 0 ? argv[0] : "");
