...
{
    const char* pszTimestamp = "Parliament agrees modest tightening of anti-money laundering law";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 4 * 60 * 60; // two weeks
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1616942923; // March 28, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1619621323;   // Apr 28, 2021

        // Deployment of Taproot (BIPs 340-342)
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1616942923; // March 28, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1619621323;   // Apr 28, 2021
        ...
        genesis = CreateGenesisBlock(1616855732, 249710424, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000058fa3f1a26007c42944593d05c2fcd9587c4517bbaf3057417c2949d"));
        assert(genesis.hashMerkleRoot == uint256S("0x668e1e45859f81a4003030334157c6fbfa77bd108feb0d8b5274cd6d1355364b"));
        ...
        vSeeds.emplace_back("xbt.nodes.counos.org"); // Jason Maurice
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x08, 0x99, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x08, 0x99, 0xAD, 0xE4};
...
public:
    CTestNetParams()
    {
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 210; // 75% for testchains
        ...
        genesis = CreateGenesisBlock(1486949366, 389117447, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000002d8495d8241ea0c950f21bb08c59feebdb141de389f9d0f45db8ad4b"));
        assert(genesis.hashMerkleRoot == uint256S("0x668e1e45859f81a4003030334157c6fbfa77bd108feb0d8b5274cd6d1355364b"));
...
public:
    explicit SigNetParams(const ArgsManager& args)
    {
        ...
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 220; // 95% of 2016
        consensus.nMinerConfirmationWindow = 240;       // nPowTargetTimespan / nPowTargetSpacing
...
public:
    explicit CRegTestParams(const ArgsManager& args)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7aee0a075213fa0619ea0b03b026ab791ba702b5bea73668acdd999571115481"));
        assert(genesis.hashMerkleRoot == uint256S("0x668e1e45859f81a4003030334157c6fbfa77bd108feb0d8b5274cd6d1355364b"));
