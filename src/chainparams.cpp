...
public:
    CRegTestParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_QRWIT].bit = 2;
		consensus.vDeployments[Consensus::DEPLOYMENT_QRWIT].nStartTime = 0;
		consensus.vDeployments[Consensus::DEPLOYMENT_QRWIT].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
