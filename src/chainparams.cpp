...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dashdot.io", "dnsseed.dashdot.io");
        vSeeds.emplace_back("masternode.io", "dnsseed.masternode.io");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("dashdot.io",  "testnet-seed.dashdot.io");
