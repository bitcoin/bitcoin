...
public:
    CMainParams() {
        ...
        consensus.fPowAllowMinDifficultyBlocks = true; // REMOVE
        ...
        consensus.hardforkHeight = 5;
        consensus.premineAddress = "MvEKpm1mvFirMzfX6AWSikVFrhghS5jViw";
        consensus.premineValue = 240000 * COIN * BTC_2_MBC_RATE;
         ...
         */
        pchBitcoinMessageStart[0] = 0xb4;
        pchBitcoinMessageStart[1] = 0xbe;
        pchBitcoinMessageStart[2] = 0xb4;
        pchBitcoinMessageStart[3] = 0xbe;
