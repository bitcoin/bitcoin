...
public:
    CTestNetParams() {
		...
		genesis = CreateGenesisBlock(1512581755, 8694633, 0x1e0ffff0, 1, 8.88 * COIN);
		/*CBlockHeader genesisHeader = genesis.GetBlockHeader();
		GenerateGenesisBlock(genesisHeader, &hash);*/
		consensus.hashGenesisBlock = genesis.GetHash();
		assert(consensus.hashGenesisBlock == uint256S("0x00000ce252979d26a7fcab9508a47121a3f50236209111b61432e52697cc83fc"));
		assert(genesis.hashMerkleRoot == uint256S("0x68519c429727677424e712d467bf835a88f52bc648dc491155a9da18b0ec3ffd"));
