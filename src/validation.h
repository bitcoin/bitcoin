...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly = false, bool fMasternodePartOnly = false, unsigned int nStartHeight=0, CAmount & nTotalRewardWithMasternodes=CAmount());
