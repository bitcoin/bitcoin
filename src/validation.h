...
static const int64_t DEFAULT_MAX_TIP_AGE = 24 * 60 * 60 * 50;       //TODO - fix after final dev
...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, const CChainParams& chainparams, bool fCheckPOW = true, bool fCheckMerkleRoot = true );
