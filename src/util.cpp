...
const char * const BITCOIN_CONF_FILENAME = "dobbscoin.conf";
const char * const BITCOIN_PID_FILENAME = "dobbscoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dobbscoin";
#else
    // Unix
