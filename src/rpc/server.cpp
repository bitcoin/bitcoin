...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Liberta server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Staking */
    { "staking",             "checkkernel",           &checkkernel,            true  },
    { "staking",             "getstakesubsidy",       &getstakesubsidy,        true  },
    { "staking",             "getstakinginfo",        &getstakinginfo,         true  },
...
{"wallet", "sendtoaddressix", &sendtoaddressix,  true},
    ...
    {"masternode",          "mnbudget",               &mnbudget,               true  },
    {"masternode",          "mnbudgetvoteraw",        &mnbudgetvoteraw,        true  },
    {"masternode",          "mnfinalbudget",          &mnfinalbudget,          true  },
...
{
    return "> liberta-cli " + methodname + " " + args + "\n";
}
