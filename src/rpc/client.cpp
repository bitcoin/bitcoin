...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "assetallocationsendmany", 0, "asset" },
    { "assetallocationsendmany", 2, "inputs" },
    { "assetallocationburn", 0, "asset" },
    { "assetallocationburn", 2, "amount" },
    { "assetallocationmint", 0, "asset" },
    { "assetallocationmint", 2, "amount" },
    { "assetallocationmint", 3, "blocknumber" },
    { "assetallocationinfo", 0, "asset" },
    { "assetallocationbalance", 0, "asset" },
    { "assetallocationsenderstatus", 0, "asset" },
    ...
    { "assetupdate", 0, "asset" },
    { "assetupdate", 5, "update_flags" },
    { "assettransfer", 0, "asset" },
    { "assetsend", 0, "asset" },
    { "assetsendmany", 0, "asset" },
