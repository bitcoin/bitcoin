...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendpointoaddress", 1, "amount" },
    { "sendpointoaddress", 2, "lock_blocks" },
    { "sendpointoaddress", 5, "subtractfeefromamount" },
    { "sendpointoaddress", 6, "replaceable" },
    { "sendpointoaddress", 7, "conf_target" },
    { "withdrawpoint", 3, "replaceable" },
    { "withdrawpoint", 4, "conf_target" },
    { "listpoints", 0, "count" },
    { "listpoints", 1, "skip" },
    { "listpoints", 2, "include_watchonly" },
    { "sendstakingoaddress", 1, "amount" },
    { "sendstakingoaddress", 2, "lock_blocks" },
    { "sendstakingoaddress", 5, "subtractfeefromamount" },
    { "sendstakingoaddress", 6, "replaceable" },
    { "sendstakingoaddress", 7, "conf_target" },
