...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "assetallocationmint", 10, "auxfee_test" },
    ...
    { "assetnew", 7, "updatecapability_flags" },
    { "assetnew", 10, "notary_details" },
    { "assetnew", 11, "auxfee_details" },
    { "assetnewtest", 0, "asset_guid" }, 
    { "assetnewtest", 1, "funding_amount" }, 
    { "assetnewtest", 5, "precision" },
    { "assetnewtest", 6, "total_supply" },
    { "assetnewtest", 7, "max_supply" },
    { "assetnewtest", 8, "updatecapability_flags" },
    { "assetnewtest", 11, "notary_details" },
    { "assetnewtest", 12, "auxfee_details" },
    { "assetupdate", 0, "asset_guid" },
    { "assetupdate", 3, "supply" },
    { "assetupdate", 4, "updatecapability_flags" },
    { "assetupdate", 7, "notary_details" },
    { "assetupdate", 8, "auxfee_details" },
