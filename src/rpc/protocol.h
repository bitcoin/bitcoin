...
#ifndef REVOLT_RPC_PROTOCOL_H
#define REVOLT_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< REVOLT is not connected
