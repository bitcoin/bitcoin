...
std::vector<RPCResult> TxDoc(const TxDocOptions& opts)
{
    ...
    if (opts.include_scripts) {
        vin_inner.emplace_back(
            RPCResult::Type::OBJ, "redeemScript", /*optional=*/true, "The decoded redeem script (only for P2SH, P2SH-P2WPKH and P2SH-P2WSH inputs, omitted if block undo data is not available)",
