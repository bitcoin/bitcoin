...
// NOTE: Unlike wallet RPC (which use SNAIL values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!lpval.isNull()) {
         ...
         *
         * getblocktemplate is unlikely to be called by snailcoin-cli, so
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{
        ...
        "See https://en.snailcoin.it/wiki/BIP_0022 for full specification.\n",
        {
