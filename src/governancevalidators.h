...
#ifndef SYSCOIN_GOVERNANCEVALIDATORS_H
#define SYSCOIN_GOVERNANCEVALIDATORS_H
...
public:
    explicit CProposalValidator(const std::string& strDataHexIn = std::string());
...
#endif // SYSCOIN_GOVERNANCEVALIDATORS_H
