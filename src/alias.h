...
public:
	...
	bool CleanupDatabase(int &servicesCleaned, std::vector<std::vector<unsigned char> > &cleanupAliases);
	bool CleanupDatabaseLinks(const std::vector<std::vector<unsigned char> > &cleanupAliases);
