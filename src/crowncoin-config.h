/* src/crowncoin-config.h.  Generated from crowncoin-config.h.in by configure.  */
/* src/crowncoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CROWNCOIN_CONFIG_H

#define CROWNCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@crowncoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Crowncoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Crowncoin 0.9.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "crowncoin"
