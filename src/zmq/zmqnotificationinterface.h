...
protected:
    ...
    void NotifyCheckNEVMBlobs(const std::vector<const CNEVMDataPayload*> &nevmData, BlockValidationState &state) override;
    void NotifyCreateNEVMBlob(const std::vector<uint8_t> &vchData, CNEVMDataPayload &nevmData, BlockValidationState &state) override;
