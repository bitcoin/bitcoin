...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 100000 SYS, signature to prove
...
public:
    ...
    static bool Create(const COutPoint& outpoint, const CService& service, const CKey& keyCollateralAddressNew, const CSyscoinAddress& pubKeyCollateralAddressNew, const CKey& keyMasternodeNew, const CPubKey& pubKeyMasternodeNew, std::string &strErrorRet, CMasternodeBroadcast &mnbRet);
