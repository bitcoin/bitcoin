...
public:
	...
	static bool VerifyMessage(const CSyscoinAddress &pubkey, const std::vector<unsigned char>& vchSig, const std::string &strMessage, std::string& strErrorRet);
};
...
public:
	...
	static bool VerifyHash(const uint256& hash, const CSyscoinAddress& pubkey, const std::vector<unsigned char>& vchSig, std::string& strErrorRet);
};
