...
#ifndef TORTOISECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define TORTOISECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // TORTOISECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
