...
#ifndef TORTOISECOIN_COMMON_ARGS_H
#define TORTOISECOIN_COMMON_ARGS_H
...
extern const char * const TORTOISECOIN_CONF_FILENAME;
extern const char * const TORTOISECOIN_SETTINGS_FILENAME;
...
#endif // TORTOISECOIN_COMMON_ARGS_H
