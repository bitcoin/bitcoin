...
interface Wallet $Proxy.wrap("interfaces::Wallet") {
    ...
    getAddress @16 (context :Proxy.Context, dest :TxDestination, wantName :Bool, wantIsMine :Bool, wantPurpose :Bool) -> (name :Text, isMine :Int32, purpose :Int32, result :Bool);
    ...
    getDebit @45 (context :Proxy.Context, txin :Data, filter :UInt32) -> (result :Int64);
    getCredit @46 (context :Proxy.Context, txout :Data, filter :UInt32) -> (result :Int64);
