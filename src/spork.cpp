...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT) r = SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT") return SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT) return "SPORK_8_SYSTEMNODE_PAYMENT_ENFORCEMENT";
