...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES) r = SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES") return SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES) return "SPORK_15_SYSTEMNODE_PAY_UPDATED_NODES";
