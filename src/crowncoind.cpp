 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Crowncoin (http://www.crowncoin.org/),
 * which enables instant payments to anyone, anywhere in the world. Crowncoin uses peer-to-peer technology to operate
