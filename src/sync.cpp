...
{
    LogPrintf(LogInstance(), "POTENTIAL DEADLOCK DETECTED\n");
    LogPrintf(LogInstance(), "Previous lock order was:\n");
    ...
    LogPrintf(LogInstance(), "Current lock order is:\n");
...
{
    LogPrintf(LogInstance(), "DOUBLE LOCK DETECTED\n");
    LogPrintf(LogInstance(), "Lock order:\n");
...
void CheckLastCritical(void* cs, std::string& lockname, const char* guardname, const char* file, int line)
{
    ...
    LogPrintf(LogInstance(), "INCONSISTENT LOCK ORDER DETECTED\n");
    LogPrintf(LogInstance(), "Current lock order (least recent first) is:\n");
    for (const LockStackItem& i : lock_stack) {
