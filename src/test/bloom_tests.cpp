...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize)
{
    ...
    CDataStream stream(SER_NETWORK, BITCREDIT_PROTOCOL_VERSION);
    filter.Serialize(stream, SER_NETWORK, BITCREDIT_PROTOCOL_VERSION);
...
{
    // Random real transaction (b70564747556df3fe9f126d70b412d6b944bbb79e5a4c96d702fdc463aad8b1e)
    Bitcredit_CTransaction tx;
    CDataStream stream(ParseHex(""), SER_DISK, BITCREDIT_CLIENT_VERSION);
    stream >> tx;

    // and one which spends it (281928943dda529c5aa97567fa6b09b3096c9c1f8d44c7895cd131ca2c364d4d)
    Bitcredit_CTransaction spendingTx;
    CDataStream spendStream(ParseHex(""), SER_DISK, BITCREDIT_CLIENT_VERSION);
    spendStream >> spendingTx;

    CBloomFilter filter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    filter.insert(uint256("0xb70564747556df3fe9f126d70b412d6b944bbb79e5a4c96d702fdc463aad8b1e"));
    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match tx hash");

    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // byte-reversed tx hash
    filter.insert(ParseHex("1e8bad3a46dc2f706dc9a4e579bb4b946b2d410bd726f1e93fdf5675746405b7"));
    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match manually serialized tx hash");
...
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match input signature");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
...
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match input pub key");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
//    filter.insert(ParseHex("04943fdd508053c75000106d3bc6e2754dbcff19"));
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match output address");
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(spendingTx, spendingTx.GetHash()), "Simple Bloom filter didn't add output");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
...
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match COutPoint");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
...
//        filter.insert(data);
//    }
//    BOOST_CHECK_MESSAGE(filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter didn't match manually serialized COutPoint");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
//    filter.insert(uint256("00000009e784f32f62ef849763d4f45b98e07ba658647343b915ff832b110436"));
//    BOOST_CHECK_MESSAGE(!filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter matched random tx hash");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
//    filter.insert(ParseHex("0000006d2965547608b9e15d9032a7b9d64fa431"));
//    BOOST_CHECK_MESSAGE(!filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter matched random address");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
//    filter.insert(COutPoint(uint256("0x90c122d70786e899529d71dbeba91ba216982fb6ba58f3bdaab65e73b7e9260b"), 1));
//    BOOST_CHECK_MESSAGE(!filter.bitcredit_IsRelevantAndUpdate(tx, tx.GetHash()), "Simple Bloom filter matched COutPoint for an output we didn't care about");
//
//    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
...
//    BOOST_CHECK(merkleBlock.txn.ExtractMatches(vMatched, BITCREDIT_MAX_BLOCK_SIZE) == block.hashMerkleRoot);
...
//        BOOST_CHECK(vMatched[i] == merkleBlock.vMatchedTxn[i].second);
//
//    CDataStream merkleStream(SER_NETWORK, BITCREDIT_PROTOCOL_VERSION);
