...
BOOST_AUTO_TEST_CASE(bloom_create_insert_serialize)
{
    ...
    CDataStream stream(SER_NETWORK, CREDITS_PROTOCOL_VERSION);
    filter.Serialize(stream, SER_NETWORK, CREDITS_PROTOCOL_VERSION);
...
//        BOOST_CHECK(vMatched[i] == merkleBlock.vMatchedTxn[i].second);
//
//    CDataStream merkleStream(SER_NETWORK, CREDITS_PROTOCOL_VERSION);
