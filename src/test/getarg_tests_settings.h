...
using FooSettinguint8_t = common::Setting<
    "foo", uint8_t, common::SettingOptions{.legacy = true}>
    ::Default<uint8_t{0}>
    ::HelpArgs<>;
...
using FooSetting2uint8_t = common::Setting<
    "-foo", uint8_t, common::SettingOptions{.legacy = true}>
    ::Default<uint8_t{0}>
    ::HelpArgs<>;
...
using BarSettinguint8_t = common::Setting<
    "-bar", uint8_t, common::SettingOptions{.legacy = true}>;
