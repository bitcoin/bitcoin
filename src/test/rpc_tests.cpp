...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::max()).write(), "92233720368.54775807");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::max() - 1).write(), "92233720368.54775806");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::max() - 2).write(), "92233720368.54775805");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::max() - 3).write(), "92233720368.54775804");
    // ...
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::min() + 3).write(), "-92233720368.54775805");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::min() + 2).write(), "-92233720368.54775806");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::min() + 1).write(), "-92233720368.54775807");
    BOOST_CHECK_EQUAL(ValueFromAmount(std::numeric_limits<CAmount::inner_type>::min()).write(), "-92233720368.54775808");
}
...
BOOST_AUTO_TEST_CASE(rpc_getblockstats_calculate_percentiles_by_weight)
{
    ...
    BOOST_CHECK_EQUAL(result[0], 1_sats);
    BOOST_CHECK_EQUAL(result[1], 1_sats);
    BOOST_CHECK_EQUAL(result[2], 1_sats);
    BOOST_CHECK_EQUAL(result[3], 2_sats);
    BOOST_CHECK_EQUAL(result[4], 2_sats);
    ...
    BOOST_CHECK_EQUAL(result2[0], 2_sats);
    BOOST_CHECK_EQUAL(result2[1], 2_sats);
    BOOST_CHECK_EQUAL(result2[2], 4_sats);
    BOOST_CHECK_EQUAL(result2[3], 4_sats);
    BOOST_CHECK_EQUAL(result2[4], 9_sats);
    ...
    BOOST_CHECK_EQUAL(result3[0], 2_sats);
    BOOST_CHECK_EQUAL(result3[1], 2_sats);
    BOOST_CHECK_EQUAL(result3[2], 4_sats);
    BOOST_CHECK_EQUAL(result3[3], 4_sats);
    BOOST_CHECK_EQUAL(result3[4], 9_sats);
    ...
    feerates.emplace_back(3_sats, 1);
    feerates.emplace_back(3_sats, 1);
    feerates.emplace_back(999999_sats, 1);

    CalculatePercentilesByWeight(result4, feerates, total_weight);

    for (int64_t i = 0; i < NUM_GETBLOCKSTATS_PERCENTILES; i++) {
        BOOST_CHECK_EQUAL(result4[i], 1_sats);
    }
}
