...
BOOST_AUTO_TEST_CASE(logging_sourcelocation_counter)
{
    ...
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::WINDOW_MAX_BYTES);
    ...
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::WINDOW_MAX_BYTES - MESSAGE_SIZE);
    BOOST_CHECK_EQUAL(counter.GetDroppedBytes(), 0ull);

    BOOST_CHECK(counter.Consume(MESSAGE_SIZE));
    BOOST_CHECK_EQUAL(counter.GetAvailableBytes(), BCLog::WINDOW_MAX_BYTES - MESSAGE_SIZE * 2);
    BOOST_CHECK_EQUAL(counter.GetDroppedBytes(), 0ull);
