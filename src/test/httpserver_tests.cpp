...
BOOST_AUTO_TEST_CASE(http_request_state_tests)
{
...

    {
        ...
        BOOST_CHECK(!HTTPRemoteClient::ReadRequests(client));
        ...
        auto req{HTTPRemoteClient::ReadRequests(client)};
        BOOST_REQUIRE(req);
    ...
    }
    {
        ...
        // Read second request
        req = HTTPRemoteClient::ReadRequests(client);
        BOOST_REQUIRE(req);
        BOOST_CHECK(!client->GetRequest());
        BOOST_CHECK_EQUAL(req->GetState(), Complete);
    ...
    }
    {
        ...
        HTTPRemoteClient::ReadRequests(client);
        BOOST_CHECK_EQUAL(client->GetRequest()->GetState(), NeedsBody);
