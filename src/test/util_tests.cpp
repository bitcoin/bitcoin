...
{
    BOOST_CHECK_EQUAL(FormatMoney(0*sats), "0.00");
...
{
    BOOST_CHECK_EQUAL(ParseMoney("0.0").value(), 0*sats);
    BOOST_CHECK_EQUAL(ParseMoney(".").value(), 0*sats);
    BOOST_CHECK_EQUAL(ParseMoney("0.").value(), 0*sats);
    BOOST_CHECK_EQUAL(ParseMoney(".0").value(), 0*sats);
    BOOST_CHECK_EQUAL(ParseMoney(".6789").value(), 6789'0000*sats);
