...
BOOST_AUTO_TEST_CASE (generate_aliasexpired)
{
	...
	BOOST_CHECK_THROW(CallRPC("node1", "certupdate " + certgoodguid + " pubdata"), runtime_error);
	...
	BOOST_CHECK_THROW(CallRPC("node1", "certtransfer " + certguid + " aliasexpire1"), runtime_error);
