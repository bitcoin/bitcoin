...
BOOST_AUTO_TEST_CASE(xor_file)
{
...

    {
        ...
        AutoFile xor_file{raw_file("rb"), {key_bytes}}; // use the old array-to-Obfuscation constructor
    ...
    std::memcpy(&xor_key, key_bytes.data(), Obfuscation::SIZE_BYTES);
    {
        ...
        const char* mode = "wbx";
#endif
        AutoFile xor_file{raw_file(mode), xor_key}; // use the new uint64_t-to-Obfuscation constructor
