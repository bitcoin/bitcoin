...
BOOST_FIXTURE_TEST_SUITE(musig2_tests, BasicTestingSetup)

BOOST_AUTO_TEST_CASE(bip328)
{
    ...
    std::vector<BIP328TestVector> test_vectors = {
        // Test vector 0
        {
            ...
            .expected_xpub = "xpub661MyMwAqRbcFt6tk3uaczE1y6EvM1TqXvawXcYmFEWijEM4PDBnuCXwwXEKGEouzXE6QLLRxjatMcLLzJ5LV5Nib1BN7vJg6yp45yHHRbm"
        },
        // Test vector 1
        {
            .pubkeys = {
            ...
            .expected_xpub = "xpub661MyMwAqRbcFt6tk3uaczE1y6EvM1TqXvawXcYmFEWijEM4PDBnuCXwwVk5TFJk8Tw5WAdV3DhrGfbFA216sE9BsQQiSFTdudkETnKdg8k"
        },
        // Test vector 2
        {
            .pubkeys = {
            ...
            .expected_xpub = "xpub661MyMwAqRbcFt6tk3uaczE1y6EvM1TqXvawXcYmFEWijEM4PDBnuCXwwUvaZYpysLX4wN59tjwU5pBuDjNrPEJbfxjLwn7ruzbXTcUTHkZ"
        }
    };
    ...
    for (int i = 0; i < (int) test_vectors.size(); ++i) {
        ...
        BOOST_CHECK_MESSAGE(xpub == test.expected_xpub, "Test vector " << i << ": Synthetic xpub mismatch");
    }
}
