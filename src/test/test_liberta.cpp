...
#define BOOST_TEST_MODULE Liberta Test Suite

#include "test_liberta.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_liberta_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
