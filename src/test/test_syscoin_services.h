...
void CertUpdate(const string& node, const string& guid, const string& title="\"\"", const string& pubdata="\"\"", const string& data="\"\"", const string& safesearch="Yes");
