...
const UniValue FindOfferAcceptFeedback(const string& node, const string& acceptguid, const char& user, bool nocheck=false);
const string OfferNew(const string& node, const string& aliasname, const string& category, const string& title, const string& qty, const string& price, const string& description, const string& currency, const string& certguid="\"\"", const string& paymentoptions="\"\"", const string& safesearch="\"\"", const string& witness="\"\"");
void OfferUpdate(const string& node, const string& aliasname, const string& offerguid,  const string& category="\"\"", const string& title="\"\"", const string& qty="\"\"", const string& price="\"\"", const string& description="\"\"", const string& currency="\"\"", const string &isprivate="\"\"", const string& certguid="\"\"", const string &safesearch="\"\"", const string &commission="\"\"", const string &paymentoptions="\"\"", const string& witness="\"\"");
