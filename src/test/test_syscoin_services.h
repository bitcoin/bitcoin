...
const string EscrowNewBuyItNow(const string& node, const string& sellernode, const string& buyeralias, const string& offerguid, const string& qtyStr, const string& arbiteralias, const string& shippingFee = "0", const string& networkFee = "''", const string& arbiterFee = "0.005", const string& witnessFee = "0", const string& witness = "''");
const string EscrowNewAuction(const string& node, const string& sellernode, const string& buyeralias, const string& offerguid, const string& qtyStr, const string& bid_in_offer_currency, const string& arbiteralias, const string& shippingFee = "0", const string& networkFee = "''", const string& arbiterFee = "0.005", const string& witnessFee = "0", const string& witness = "''");
