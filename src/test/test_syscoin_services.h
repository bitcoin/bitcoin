...
string AssetNew(const string& node, const string& name, const string& alias, const string& pubdata = "''", const string& precision="8", const string& useinputranges="false", const string& supply = "1", const string& maxsupply = "10", const string& interestrate = "0", string canadjustinterestandsupply = "true", const string& witness = "''");
