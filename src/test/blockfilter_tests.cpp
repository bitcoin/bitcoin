...
BOOST_AUTO_TEST_CASE(blockfilter_basic_test)
{
    ...
    tx_1.vout.emplace_back(CAmount{100}, included_scripts[0]);
    tx_1.vout.emplace_back(CAmount{200}, included_scripts[1]);
    tx_1.vout.emplace_back(CAmount{0}, excluded_scripts[0]);

    CMutableTransaction tx_2;
    tx_2.vout.emplace_back(CAmount{300}, included_scripts[2]);
    tx_2.vout.emplace_back(CAmount{0}, excluded_scripts[2]);
    tx_2.vout.emplace_back(CAmount{400}, excluded_scripts[3]); // Script is empty
    ...
    block_undo.vtxundo.back().vprevout.emplace_back(CTxOut(CAmount{500}, included_scripts[3]), 1000, true);
    block_undo.vtxundo.back().vprevout.emplace_back(CTxOut(CAmount{600}, included_scripts[4]), 10000, false);
    block_undo.vtxundo.back().vprevout.emplace_back(CTxOut(CAmount{700}, excluded_scripts[3]), 100000, false);
...
BOOST_AUTO_TEST_CASE(blockfilters_json_test)
{
    ...
    for (unsigned int i = 0; i < tests.size(); i++) {
        ...
        for (unsigned int ii = 0; ii < prev_scripts.size(); ii++) {
            ...
            CTxOut txout(CAmount{0}, CScript(raw_script.begin(), raw_script.end()));
