...
public:
    explicit VersionBitsTester(int32_t nVersionBase=0) : nVersionBase{nVersionBase} { }
...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    for (int i = 0; i < 64; i++) {
        ...
        VersionBitsTester(VERSIONBITS_TOP_BITS).TestDefined().TestStateSinceHeight(0)
