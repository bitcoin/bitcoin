...
/* Define a virtual block time, one block per 60 seconds after Nov 14 2014, 0:55:36am */
int32_t TestTime(int nHeight) { return 1415926536 + 60 * nHeight; }
...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    // Mine 20155 more blocks at the old time, and check that CBV isn't setting the bit yet.
