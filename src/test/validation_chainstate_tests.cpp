...
BOOST_FIXTURE_TEST_CASE(chainstate_update_tip, TestChain100Setup)
{
    ...
    uint256 curr_tip{WITH_LOCK(m_node.notifications->m_tip_block_mutex, return m_node.notifications->m_tip_block;)};
    ...
    uint256 new_tip{WITH_LOCK(m_node.notifications->m_tip_block_mutex, return m_node.notifications->m_tip_block;)};
    BOOST_CHECK(new_tip != curr_tip);
    ...
    curr_tip = WITH_LOCK(m_node.notifications->m_tip_block_mutex, return m_node.notifications->m_tip_block;);
    ...
    new_tip = WITH_LOCK(m_node.notifications->m_tip_block_mutex, return m_node.notifications->m_tip_block;);
    BOOST_CHECK_EQUAL(curr_tip, new_tip);
}
