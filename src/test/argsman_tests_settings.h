...
using Opt1Setting = common::Setting<
    "-opt1=<file name>", common::Unset, common::SettingOptions{.legacy = true, .disallow_negation = true},
    "Opt 1">
    ::Category<OptionsCategory::COMMAND_OPTIONS>;

using Opt2Setting = common::Setting<
    "-opt2=<file name>", common::Unset, common::SettingOptions{.legacy = true, .disallow_negation = true},
    "Opt 2">
    ::Category<OptionsCategory::COMMAND_OPTIONS>;

using Opt3Setting = common::Setting<
    "-opt3=<file name>", common::Unset, common::SettingOptions{.legacy = true, .disallow_negation = true},
    "Opt 3">;
