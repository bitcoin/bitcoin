...
BOOST_AUTO_TEST_CASE(DoS_exceeded_threshold)
{
    ...
    auto ppeer1 = peermgr.Get(dummyNode1.GetId());
    assert(ppeer1);
    BOOST_CHECK(ppeer1->GetMisbehavior() == 0);
    BOOST_CHECK(!ppeer1->ExceededMisbehaviorThreshold());
    BOOST_CHECK(!Misbehavior::IsExcessive(ppeer1->Misbehaving(50)));
    BOOST_CHECK(!ppeer1->ExceededMisbehaviorThreshold());
    BOOST_CHECK(Misbehavior::IsExcessive(ppeer1->Misbehaving(50)));
    BOOST_CHECK(ppeer1->ExceededMisbehaviorThreshold());
    BOOST_CHECK(!ppeer1->ExceededMisbehaviorThreshold());
    BOOST_CHECK(Misbehavior::IsExcessive(ppeer1->GetMisbehavior()));
}
