...
public:
    ...
    /** Generate a random GenTxid, whose priorities for certain peers are constrained.
     *
     * For example, NewGTxid({{p1,p2,p3},{p2,p4,p5}}) will generate a txhash T such that both:
