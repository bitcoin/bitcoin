...
#ifndef TORTOISECOIN_TEST_SCRIPTNUM10_H
#define TORTOISECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Tortoisecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // TORTOISECOIN_TEST_SCRIPTNUM10_H
