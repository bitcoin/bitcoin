...
#ifndef FLOW_TEST_SCRIPTNUM10_H
#define FLOW_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Flow Core 0.10.0, for cross-comparison.
 */
public:
