...
#ifndef XBIT_TEST_SCRIPTNUM10_H
#define XBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from XBit Core 0.10.0, for cross-comparison.
 */
public:
