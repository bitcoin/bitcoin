...
#ifndef Buttcoin_TEST_SCRIPTNUM10_H
#define Buttcoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Buttcoin Core 0.10.0, for cross-comparison.
 */
public:
