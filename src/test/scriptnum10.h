...
#ifndef REVOLT_TEST_SCRIPTNUM10_H
#define REVOLT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Revolt Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // REVOLT_TEST_SCRIPTNUM10_H
