...
#ifndef LITECOIN_TEST_SCRIPTNUM10_H
#define LITECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Litecoin Core 0.10.0, for cross-comparison.
 */
public:
