...
#ifndef LIBERTA_TEST_SCRIPTNUM10_H
#define LIBERTA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Liberta Core 0.10.0, for cross-comparison.
 */
public:
