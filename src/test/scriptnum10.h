...
#ifndef WIDECOIN_TEST_SCRIPTNUM10_H
#define WIDECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Widecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // WIDECOIN_TEST_SCRIPTNUM10_H
