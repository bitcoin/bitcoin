...
{
//	const vector<unsigned char> vchPubKey = ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f");
//    const CScript scriptPubKey = CScript() << vchPubKey << OP_CHECKSIG;
//    const CScript scriptPubKeyDeposit = CScript() << vchPubKey << OP_CHECKSIG;
...
//        pblock->nTotalMonetaryBase = (i+1) * 4 * COIN;
//        pblock->nTotalDepositBase = (i+1) * 4 * COIN;
//        pblock->nDepositAmount = 4 * COIN;
//        //TODO . This needs to be set to some good testing values
//        pblock->hashLinkedBitcoinBlock = 0;
//        CValidationState state;
//        BOOST_CHECK(Bitcredit_ProcessBlock(state, NULL, pblock));
