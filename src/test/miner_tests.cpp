...
struct MinerTestingSetup : public TestingSetup {
    ...
    void TestSigOpsAdjustedWeightChunkLimit(const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst);
...
void MinerTestingSetup::TestPackageSelection(const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst)
{
    ...
    const auto template_chunks = Assert(m_node.block_template_manager)->CreateNewTemplate(options)->m_template_chunks;
