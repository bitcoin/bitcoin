...
BOOST_AUTO_TEST_CASE(feefrac_operators)
{
    ...
    BOOST_CHECK_EQUAL(FeeFrac(0x1ffffffff, 123456789).Evaluate(98765432), 6871947728);
    BOOST_CHECK_EQUAL(FeeFrac(0x200000000, 123456789).Evaluate(98765432), 6871947729);
    BOOST_CHECK_EQUAL(FeeFrac(0x200000001, 123456789).Evaluate(98765432), 6871947730);
