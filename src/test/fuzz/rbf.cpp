...
FUZZ_TARGET(package_rbf, .init = initialize_package_rbf)
{
    ...
    while (fuzzed_data_provider.ConsumeBool()) {
        ...
        parent.vout.emplace_back(CAmount{0}, CScript());
        ...
        if (fuzzed_data_provider.ConsumeBool()) {
            pool.PrioritiseTransaction(mempool_txs.back().GetHash(), ConsumeMoney(fuzzed_data_provider, CAmount{-100000}, CAmount{100000}));
        }
    }
