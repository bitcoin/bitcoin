...
FUZZ_TARGET(script_sigcache, .init = initialize_script_sigcache)
{
    ...
    const bool use_sighash_cache = fuzzed_data_provider.ConsumeBool();
    PrecomputedTransactionData tx_data;
    CachingTransactionSignatureChecker caching_transaction_signature_checker{mutable_transaction ? &tx : nullptr, n_in, amount, store, signature_cache, tx_data, /*use_sighash_cache=*/use_sighash_cache};
