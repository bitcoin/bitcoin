...
bool CheckInputScripts(const CTransaction& tx, TxValidationState& state,
                       ...
                       std::vector<CScriptCheck>* pvChecks) TS_ITCOIN_EXCLUSIVE_LOCKS_REQUIRED(cs_main);
...
static void ValidateCheckInputsForAllFlags(const CTransaction &tx, uint32_t failing_flags, bool add_to_cache, CCoinsViewCache& active_coins_tip) TS_ITCOIN_EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
