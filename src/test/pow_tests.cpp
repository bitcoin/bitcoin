...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 486801404U);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual)
{
    ...
    // SYSCOIN
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 471240656U);
}
