...
BOOST_AUTO_TEST_CASE(ValidateInputsStandardness)
{
    ...
    txFrom.vout[8].nValue = CAmount{1000};
    ...
    txFrom.vout[9].nValue = CAmount{1000};
...

    {
        ...
        txToNonStd2_no_scriptSig.vout[0].nValue = CAmount{1000};
    ...
    // TxoutType::NONSTANDARD
    {
        ...
        txToNonStd3.vout[0].nValue = CAmount{1000};
    ...
    // TxoutType::INCORRECT_SCRIPTSIG
    {
        ...
        txToNonStd4.vout[0].nValue = CAmount{1000};
    ...
    // TxoutType::WITNESS_UNKNOWN
    {
        ...
        txWitnessUnknown.vout[0].nValue = CAmount{1000};
