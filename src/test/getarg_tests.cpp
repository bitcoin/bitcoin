...
BOOST_AUTO_TEST_CASE(patharg)
{
    ...
    const fs::path absolute_path{"/home/user/.widecoin"};
    ResetArgs(local_args, "-dir=/home/user/.widecoin");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);

    ResetArgs(local_args, "-dir=/root/../home/user/.widecoin");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);
