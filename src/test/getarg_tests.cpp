...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    BOOST_CHECK(str.contains("Command-line arg: okaylog-bool=\"\""));
    BOOST_CHECK(str.contains("Command-line arg: okaylog-negbool=false"));
    BOOST_CHECK(str.contains("Command-line arg: okaylog=\"public\""));
    BOOST_CHECK(str.contains("dontlog=****"));
    BOOST_CHECK(!str.contains("private42"));
}
