...
constexpr char BUFFER_SIZE_WARNING[]{"Unexpectedly reached minimum required work before starting to feed back headers, even though we started all the way back from genesis. This indicates the redownload_buffer_size was too big."};
