...
{
    BOOST_CHECK(TestSplitHost("www.bitcointalkcoincore.org", "www.bitcointalkcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcointalkcoincore.org]", "www.bitcointalkcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcointalkcoincore.org:80", "www.bitcointalkcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcointalkcoincore.org]:80", "www.bitcointalkcoincore.org", 80));
