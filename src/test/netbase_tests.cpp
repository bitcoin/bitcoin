...
{
    BOOST_CHECK(TestSplitHost("www.snailcoincore.org", "www.snailcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.snailcoincore.org]", "www.snailcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.snailcoincore.org:80", "www.snailcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.snailcoincore.org]:80", "www.snailcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.snailcoincore.org:65536", "www.snailcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.snailcoincore.org:0", "www.snailcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.snailcoincore.org:", "www.snailcoincore.org:", 0, false));
}
