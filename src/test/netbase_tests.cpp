...
{
    BOOST_CHECK(TestSplitHost("www.tortoisecoincore.org", "www.tortoisecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.tortoisecoincore.org]", "www.tortoisecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.tortoisecoincore.org:80", "www.tortoisecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tortoisecoincore.org]:80", "www.tortoisecoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.tortoisecoincore.org:65536", "www.tortoisecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.tortoisecoincore.org:0", "www.tortoisecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.tortoisecoincore.org:", "www.tortoisecoincore.org:", 0, false));
}
