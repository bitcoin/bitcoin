...
BOOST_AUTO_TEST_CASE(isbadport)
{
    ...
    // Check all ports, there must be 17 bad ports in addition to the restriction on privileged ports.
    ...
    BOOST_CHECK_EQUAL(total_bad_ports - PRIVILEGED_PORTS_THRESHOLD, 17);
}
