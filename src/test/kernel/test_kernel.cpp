...
static std::string stringify(const Wtxid& t)
{
    return "Wtxid{" + ::byte_span_to_hex_string_reversed(t.ToBytes()) + "}";
}

static std::string stringify(const WtxidView& t)
{
    return "WtxidView{" + ::byte_span_to_hex_string_reversed(t.ToBytes()) + "}";
}
