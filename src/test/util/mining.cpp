...
COutPoint generatetoaddress(const node::NodeContext& node, const std::string& address)
{
...
COutPoint MineBlock(const node::NodeContext& node, const CScript& coinbase_scriptPubKey)
{
