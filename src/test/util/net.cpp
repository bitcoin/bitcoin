...
{
    AssertUnreachable(); // Move of Sock into ZeroSock not allowed.
    return *this;
}
...
{
    AssertUnreachable(); // Move of Sock into StaticContentsSock not allowed.
    return *this;
}
...
{
    AssertUnreachable(); // Move of Sock into DynSock not allowed.
    return *this;
}
