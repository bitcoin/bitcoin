...
/// Helper to initialize the global MockableSteadyClock, elapse it, and reset
/// it after use in a test.
class ElapseSteady
{
...
/// Helper to initialize the global NodeClock, elapse it, and reset
/// it after use in a test.
class ElapseTime
{
