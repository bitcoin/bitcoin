...
std::string stringify(std::nullopt_t);
...
public:
    explicit InfoScopeGuard(std::string info);
    ~InfoScopeGuard() noexcept;
...
std::optional<unsigned int> parse_shuffle_seed(const char* raw);
