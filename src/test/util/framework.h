...
/** True only for actual char-pointer values; false for array-typed string literals. */
template <typename T>
...
/** Register a test case using the enclosing suite's fixture (EmptyFixture at file scope). */
