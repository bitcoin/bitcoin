...
void CMasternodeMan::Check()
{
    ...
    LogPrint(BCLog::MNODE, "CMasternodeMan::Check -- nLastWatchdogVoteTime=%d, IsWatchdogActive()=%d\n", nLastWatchdogVoteTime, IsWatchdogActive());
...
void CMasternodeMan::UpdateLastPaid(const CBlockIndex* pindex)
{
    ...
    // LogPrint(BCLog::MNODEPAY, "CMasternodeMan::UpdateLastPaid -- nHeight=%d, nMaxBlocksToScanBack=%d, IsFirstRun=%s\n",
