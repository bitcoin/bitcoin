...
#ifndef TALKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define TALKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@talkcoin.
 *
 ...
 *
 * The chacha20-poly1305@talkcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@talkcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@talkcoin are relatively fast in
...
#endif // TALKCOIN_CRYPTO_CHACHA_POLY_AEAD_H
