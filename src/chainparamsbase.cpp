...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-testnet", "Use the zhaolunet chain (formerly testnet3). Equivalent to -chain=zhaolunet.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("zhaolunet", 32332);
