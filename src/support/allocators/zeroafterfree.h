...
#ifndef TORTOISECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define TORTOISECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // TORTOISECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
