// Copyright (c) 2016-2020 The Tortoisecoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef TORTOISECOIN_SUPPORT_LOCKEDPOOL_H
#define TORTOISECOIN_SUPPORT_LOCKEDPOOL_H
...
#endif // TORTOISECOIN_SUPPORT_LOCKEDPOOL_H
