 ...
 * SHA256 to SHA256("BIP0458/randomizer")||SHA256("BIP0458/randomizer"). */
static void secp256k1_schnorrsig_sha256_tagged_aggregation(secp256k1_sha256 *sha) {
    static const uint32_t midstate[8] = {
        0x296922a5ul, 0xdf58ca21ul, 0xbaf01b5cul, 0x7b0fe578ul,
        0x6f56025cul, 0x962979eaul, 0xeac84bf6ul, 0xe6c22681ul
    };
