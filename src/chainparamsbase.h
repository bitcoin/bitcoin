...
#ifndef XBIT_CHAINPARAMSBASE_H
#define XBIT_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between xbit-cli and xbitd)
 * of a given instance of the XBit system.
 */
