...
#ifndef Buttcoin_CHAINPARAMSBASE_H
#define Buttcoin_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between Buttcoin-cli and Buttcoind)
 * of a given instance of the Buttcoin system.
 */
...
#endif // Buttcoin_CHAINPARAMSBASE_H
