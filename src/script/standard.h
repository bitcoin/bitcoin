...
#ifndef XBIT_SCRIPT_STANDARD_H
#define XBIT_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a xbit address
 */
...
/**
 * Generate a XBit scriptPubKey for the given CTxDestination. Returns a P2PKH
