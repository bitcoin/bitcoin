...
public:
    ...
    //! The checker must not be used for further verification afterwards.
    std::vector<SchnorrSignatureToVerify> TakeCollectedSignatures() { return std::move(m_collected_signatures); }
};
