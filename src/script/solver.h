 ...
 * For nested segwit inputs:
 * - P2SH-P2WSH: both are set. `redeem_script` is the P2WSH program extracted
 *   from the scriptSig, and `witness_script` is the actual script extracted
 *   from the witness stack.
 * - P2SH-P2WPKH: `redeem_script` is the witness program extracted from the
 *   scriptSig (BIP 141); no witness script exists.
