...
enum opcodetype
{
	...
	OP_CERT_ACTIVATE = 0x06,
	OP_CERT_UPDATE = 0x07,
	OP_CERT_TRANSFER = 0x08,

	// distributed escrow system
	OP_ESCROW_ACTIVATE = 0x09,
	OP_ESCROW_RELEASE = 0x0a,
	OP_ESCROW_REFUND = 0x0b,
	OP_ESCROW_COMPLETE = 0x0c,
	OP_ESCROW_BID = 0x0d,
	OP_ESCROW_ACKNOWLEDGE = 0x0e,
