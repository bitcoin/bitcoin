...
enum class V1SigVersion : std::underlying_type_t<SigVersion>
{
    TAPROOT = static_cast<std::underlying_type_t<SigVersion>>(SigVersion::TAPROOT),
    TAPSCRIPT = static_cast<std::underlying_type_t<SigVersion>>(SigVersion::TAPSCRIPT)
};
...
public:
    ...
    virtual bool CheckSchnorrSignature(Span<const unsigned char> sig, Span<const unsigned char> pubkey, V1SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const
    {
        return false;
    }
...
public:
    ...
    bool CheckSchnorrSignature(Span<const unsigned char> sig, Span<const unsigned char> pubkey, V1SigVersion sigversion, ScriptExecutionData& execdata, ScriptError* serror = nullptr) const override;
