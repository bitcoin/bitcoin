...
#ifndef WIDECOIN_KERNEL_CONTEXT_H
#define WIDECOIN_KERNEL_CONTEXT_H
...
//! passed to external libwidecoin_kernel functions which need access to this
...
#endif // WIDECOIN_KERNEL_CONTEXT_H
