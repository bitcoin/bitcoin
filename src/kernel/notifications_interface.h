...
#ifndef TORTOISECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
#define TORTOISECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // TORTOISECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
