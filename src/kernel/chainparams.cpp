...
{
    const char* pszTimestamp = "garcoin 10/Jan/2025 Student project creating custom cryptocurrency";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 120 * consensus.nPowTargetSpacing; // 120 blocks
        consensus.nPowTargetSpacing = 120; // 2 minutes for garcoin
        ...
        nDefaultPort = 9004; // garcoin default port
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 810;
        m_assumed_chain_state_size = 14;

        genesis = CreateGenesisBlock(1736524800, 2083236893, 0x1d00ffff, 1, 50 * COIN); // garcoin genesis: Jan 10, 2025
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update hashes after genesis block changes
