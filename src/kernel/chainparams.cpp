...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        consensus.minchainwork_height = 938343; // Block height nMinimumChainWork was taken at.
...
public:
    CTestNetParams(const TestNetOptions& opts) {
        ...
        consensus.minchainwork_height = 4842348; // Block height nMinimumChainWork was taken at.
...
public:
    CTestNet4Params(const TestNetOptions& opts) {
        ...
        consensus.minchainwork_height = 123613; // Block height nMinimumChainWork was taken at.
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            consensus.minchainwork_height = 293175; // Block height nMinimumChainWork was taken at.
            ...
            // Custom signet has no minimum-chain-work checkpoint; use a nominal height purely to
            // size the headers sync parameters.
            consensus.minchainwork_height = 293175;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.nMinimumChainWork = uint256{};
        consensus.defaultAssumeValid = uint256{};
        // Regtest has no minimum-chain-work checkpoint; use a nominal height (matching testnet4,
        // from which the regtest headers sync parameters were historically copied) purely to size
        // the headers sync parameters.
        consensus.minchainwork_height = 123613;
