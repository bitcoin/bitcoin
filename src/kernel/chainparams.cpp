...
{
    auto out = blsct::CreateOutput(dest, genesisReward, "Reward");
...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    public:
        explicit CBLSCTRegTestParams(const BLSCTRegTestOptions& opts)
        {
            ...
            genesis = CreateBLSCTGenesisBlock(1296688602, 2, 0x207fffff, 0x40000000UL, blsct::DoublePublicKey(), 50 * COIN);
            consensus.hashGenesisBlock = genesis.GetHash();
