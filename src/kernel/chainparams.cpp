...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1767744000, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"7eec4e2c5f193ab31e26ae15b682ea08c15a0579774790ac186b09d50ea8d817"});
        assert(genesis.hashMerkleRoot == uint256{"7d2542ef8c80d9e234fdbb80e01ebd91ec49808a2729bb83def2744e56d4788a"});
        ...
        checkpointData = {
            {
                { 0, uint256{"7eec4e2c5f193ab31e26ae15b682ea08c15a0579774790ac186b09d50ea8d817"}},
            }
        };
