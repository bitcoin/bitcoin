...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].min_activation_height = 0; // No activation delay
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].threshold = 108; // 75%
        consensus.vDeployments[Consensus::DEPLOYMENT_CISA].period = 144;
