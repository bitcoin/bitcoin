...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        consensus.minchainwork_height = 966143; // Block height nMinimumChainWork was taken at.
...
public:
    CTestNetParams(const TestNetOptions& opts) {
        ...
        consensus.minchainwork_height = 5128859; // Block height nMinimumChainWork was taken at.
...
public:
    CTestNet4Params(const TestNetOptions& opts) {
        ...
        consensus.minchainwork_height = 151604; // Block height nMinimumChainWork was taken at.
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            consensus.minchainwork_height = 321295; // Block height nMinimumChainWork was taken at.
            ...
            consensus.minchainwork_height = 321295;
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.minchainwork_height = 151604;
