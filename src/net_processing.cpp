...
void PeerManagerImpl::MaybeSendAddr(CNode& node, Peer& peer, std::chrono::microseconds current_time)
{
    ...
    m_connman.PushMessage(&node, CNetMsgMaker(peer.m_greatest_common_version).Make(msg_type, WithParams(CAddress::SerParams{{ser_enc}, CAddress::Format::Network}, peer.m_addrs_to_send)));
    peer.m_addrs_to_send.clear();
