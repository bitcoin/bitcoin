...
private:
    ...
    */
    ...
    void ProcessGetHeaders(CNode& pfrom, DataStream& vRecv)
    ...
    */
    ...
    void ProcessTx(CNode& pfrom, Peer& peer, DataStream& vRecv)
        EXCLUSIVE_LOCKS_REQUIRED(g_msgproc_mutex, !m_peer_mutex, !m_tx_download_mutex, !m_inv_to_send_mutex);

    /** Process a new block. Perform any post-processing housekeeping */
    void ProcessBlock(CNode& node, const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked);

    void ProcessCompactBlock(CNode& pfrom, Peer& peer, DataStream& vRecv)
        EXCLUSIVE_LOCKS_REQUIRED(g_msgproc_mutex, !m_peer_mutex, !m_most_recent_block_mutex, !m_headers_presync_mutex);
    ...
    void ProcessGetBlocks(CNode& pfrom, Peer& peer, DataStream& vRecv)
        EXCLUSIVE_LOCKS_REQUIRED(g_msgproc_mutex, !m_most_recent_block_mutex);
...
void PeerManagerImpl::ProcessGetBlocks(CNode& pfrom, Peer& peer, DataStream& vRecv)
{
...
void PeerManagerImpl::ProcessGetHeaders(CNode& pfrom, DataStream& vRecv)
{
    CBlockLocator locator;
    uint256 hashStop;
    vRecv >> locator >> hashStop;
...
void PeerManagerImpl::ProcessCompactBlock(CNode& pfrom, Peer& peer, DataStream& vRecv)
{
                                     ...
                                     const std::atomic<bool>& interruptMsgProc)
{
    ...
    if (msg_type == NetMsgType::GETBLOCKS) {
        ProcessGetBlocks(pfrom, peer, vRecv);
        return;
    }
    ...
    {
        ProcessCompactBlock(pfrom, peer, vRecv);
        return;
    }
