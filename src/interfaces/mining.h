...
#include <node/types.h>             // for BlockCreateOptions, BlockCheckOptions
...
public:
   ...
   /**
     ...
     *                        external software. A multiplier can be provided to
     *                        verify weak blocks against a higher proof-of-work target.
     ...
     * a multiplier is provided (via options).
     */
