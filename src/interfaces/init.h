...
#ifndef WIDECOIN_INTERFACES_INIT_H
#define WIDECOIN_INTERFACES_INIT_H
...
//! (widecoin-gui, widecoin-node, widecoin-wallet, widecoind, widecoin-qt) and each
...
#endif // WIDECOIN_INTERFACES_INIT_H
