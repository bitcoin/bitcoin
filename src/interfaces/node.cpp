...
public:
    ...
    std::unique_ptr<Handler> handleNotifyBestDeadlineChanged(NotifyBestDeadlineChangedFn fn) override
    {
        return MakeHandler(::uiInterface.NotifyBestDeadlineChanged_connect(fn));
    }
