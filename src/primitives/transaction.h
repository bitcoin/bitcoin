...
int GetSyscoinDataOutput(const CTransaction& tx, const int &nVersion = -1);
bool GetSyscoinData(const CTransaction &tx, std::vector<unsigned char> &vchData, int& nOut, const int &nVersion = -1);
