...
enum {
    ...
    TRANSACTION_TOKEN_REGISTER = 1100,
    //TRANSACTION_TOKEN_TRANSFER = 1111,
    //TRANSACTION_TOKEN_METADATA_TRANSFER = 1112,
    //TRANSACTION_TOKEN_LEND = 1113,
    //TRANSACTION_TOKEN_ID_UPDATE = 1114,
    //TRANSACTION_TOKEN_METADATA_UPDATE = 1115,
    //TRANSACTION_TOKEN_DESTROY = 1116

    TRANSACTION_TOKEN_TYPE_REGISTER = 1200
    //TRANSACTION_TOKEN_TYPE_TRANSFER = 1201,
    //TRANSACTION_TOKEN_TYPE_UPDATE = 1202,
    //TRANSACTION_TOKEN_TYPE_REVOKE = 1203
};
