...
{
    return strprintf("CTxOut(nValue=%d.%08d, scriptPubKey=%s%s)", nValue / COIN, nValue % COIN, HexStr(scriptPubKey).substr(0, 30), tokenId.IsNull() ? "" : strprintf(", tokenId=%s", tokenId.ToString()));
}
