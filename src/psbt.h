        ...
        while(!s.empty()) {
            ...
            switch(type) {
                ...
                case PSBT_IN_MUSIG2_PARTICIPANT_PUBKEYS:
                {
                    ...
                    if (!s_val.empty()) {
                        throw std::ios_base::failure("Input musig2 participants pubkeys value size is not a multiple of 33");
                    }
        ...
        while(!s.empty()) {
            ...
            switch(type) {
                ...
                case PSBT_OUT_MUSIG2_PARTICIPANT_PUBKEYS:
                {
                    ...
                    if (!s_val.empty()) {
                        throw std::ios_base::failure("Output musig2 participants pubkeys value size is not a multiple of 33");
                    }
