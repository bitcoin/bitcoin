 ...
 **/
[[nodiscard]] PSBTError SignPSBTInput(const SigningProvider& provider, PartiallySignedTransaction& psbt, int index, const PrecomputedTransactionData* txdata, common::PSBTOptions options, SignatureData* out_sigdata = nullptr);
