...
protected:
     ...
     * Called on a background thread.
     */
    virtual void MempoolTransactionsRemovedForBlock(const std::vector<RemovedMempoolTransactionInfo>& txs_removed_for_block,
...
public:
    ...
    void MempoolTransactionsRemovedForBlock(const std::vector<RemovedMempoolTransactionInfo>&,
                                            const std::vector<CTransactionRef>&, unsigned int nBlockHeight);
