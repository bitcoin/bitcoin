...
RPCHelpMan listsinceblock()
{
    return RPCHelpMan{"listsinceblock",
                ...
                {
                    {"blockhash", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "If set, the block hash to list transactions since (excluding this block), otherwise list all transactions."},
