...
static RPCHelpMan loadwallet()
{
    return RPCHelpMan{"loadwallet",
                ...
                {
                    {"filename", RPCArg::Type::STR, RPCArg::Optional::NO, "You may pass in the absolute path of your wallet directory or .dat file. Otherwise, the interpreted path will be relative to the default wallet directory."},
