...
enum isminetype : unsigned int {
    ...
    ISMINE_USED = 1 << 2,
    ISMINE_SPENDABLE_BLSCT = 1 << 3,
    ISMINE_STAKED_COMMITMENT_BLSCT = 1 << 4,
    ISMINE_ALL = ISMINE_WATCH_ONLY | ISMINE_SPENDABLE | ISMINE_SPENDABLE_BLSCT | ISMINE_STAKED_COMMITMENT_BLSCT,
