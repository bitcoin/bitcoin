...
{
    // for now we use a fixed keypath scheme of m/44'/57'/0'/0'/k
    CKey seed;                     //seed (256bit)
    CExtKey masterKey;             //hd master key
    CExtKey purposeKey;            //key at m/44''
    CExtKey cointypeKey;           //key at m/44'/57'
    CExtKey accountKey;            //key at m/44'/57'/0'
    CExtKey chainChildKey;         //key at m/44'/57'/0'/0' (external) or m/44'/57'/0'/1' (internal)
    CExtKey childKey;              //key at m/44'/57'/0'/0'/<n>'
    ...
    purposeKey.Derive(cointypeKey, 57 | BIP32_HARDENED_KEY_LIMIT);
    
    cointypeKey.Derive(accountKey, BIP32_HARDENED_KEY_LIMIT);

    // derive m/44'/57'/0' (external chain) OR m/44'/57'/1' (internal chain)
    ...
    do {
        ...
        if (internal) {
            ...
            metadata.hdKeypath = "m/44'/57'/0'/1'/" + std::to_string(hdChain.nInternalChainCounter) + "'";
            hdChain.nInternalChainCounter++;
        }
        else {
            chainChildKey.Derive(childKey, hdChain.nExternalChainCounter | BIP32_HARDENED_KEY_LIMIT);
            metadata.hdKeypath = "m/44'/57'/0'/0'/" + std::to_string(hdChain.nExternalChainCounter) + "'";
...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/syscoin/syscoin/pull/10340, but that change has been
    // postponed until after https://github.com/syscoin/syscoin/pull/10244 to
