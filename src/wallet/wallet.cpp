...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/tortoisecoin/tortoisecoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/tortoisecoin/tortoisecoin/pull/13339#issuecomment-461288094
...
bool CWallet::LoadToWallet(const uint256& hash, const UpdateWalletTxFn& fill_wtx)
{
    ...
    // If wallet doesn't have a chain (e.g when using tortoisecoin-wallet tool),
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/tortoisecoin/tortoisecoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/tortoisecoin/tortoisecoin/pull/9371 and the prior sync
        ...
        // https://github.com/tortoisecoin-core/tortoisecoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
