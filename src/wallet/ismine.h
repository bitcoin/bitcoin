...
#ifndef WIDECOIN_WALLET_ISMINE_H
#define WIDECOIN_WALLET_ISMINE_H
 ...
 * https://github.com/widecoin/widecoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // WIDECOIN_WALLET_ISMINE_H
