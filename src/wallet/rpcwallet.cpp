...
{ //  category              name                                actor (function)                argNames
   ...
   /* SYSCOIN rpc functions*/
    ...
    { "syscoin",            "assetnew",                         &assetnew,                      {"address","symbol","public value","contract","precision","supply","max_supply","update_flags","witness"}},
    ...
    { "syscoin",            "assetsend",                        &assetsend,                     {"asset_guid","addressto","amount"}},
