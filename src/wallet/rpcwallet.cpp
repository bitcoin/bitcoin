...
static CTransactionRef SendMoney(CWallet * const pwallet, const CTxDestination &address, CAmount nValue, bool fSubtractFeeFromAmount, const CCoinControl& coin_control, mapValue_t mapValue, bool fUsePrivateSend=false)
{
    ...
    if (!pwallet->CommitTransaction(tx, std::move(mapValue), {} /* orderForm */, "" /* account */, reservekey, g_connman.get(), state, fUsePrivateSend)) {
...
static UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    CTransactionRef tx = SendMoney(pwallet, dest, nAmount, fSubtractFeeFromAmount, coin_control, std::move(mapValue), fUsePrivateSend);
...
static UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    CValidationState state;
    if (!pwallet->CommitTransaction(tx, std::move(mapValue), {} /* orderForm */, "" /* account */, keyChange, g_connman.get(), state, fUsePrivateSend)) {
