        ...
        HELP_REQUIRING_PASSPHRASE,
            ...
            "       \"" + FeeModes("\"\n\"") + "\""},
                ...
                RPCExamples{
                    ...
                    "\nSend 0.1 SYS with a fee rate of 1 " + CURRENCY_ATOM + "/vB, subtract fee from amount, BIP125-replaceable, using positional arguments\n"
      ...
      if (options.type() == UniValue::VBOOL) {
        ...
        if (options.exists("feeRate")) {
            ...
            if (fee_rate <= CFeeRate(0)) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, strprintf("Invalid feeRate %s (must be greater than 0)", fee_rate.ToString(FeeEstimateMode::SYS_KVB)));
            }
...
static RPCHelpMan send()
{
    return RPCHelpMan{"send",
        ...
        "Send 0.2 SYS with a fee rate of 1 " + CURRENCY_ATOM + "/vB using positional arguments\n"
