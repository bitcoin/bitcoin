...
#ifndef REVOLT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define REVOLT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // REVOLT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
