...
class ExternalSignerScriptPubKeyMan : public DescriptorScriptPubKeyMan
{
 ...
 util::Result<void> DisplayAddress(const CTxDestination& dest, const ExternalSigner& signer) const;
  ...
  std::optional<common::PSBTError> FillPSBT(PartiallySignedTransaction& psbt, const PrecomputedTransactionData& txdata, common::PSBTOptions options, int* n_signed = nullptr) const override;
};
} // namespace wallet
