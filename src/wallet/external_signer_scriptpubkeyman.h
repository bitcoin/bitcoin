...
#ifndef WIDECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define WIDECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // WIDECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
