...
static bool GetWalletAddressesForKey(LegacyScriptPubKeyMan* spk_man, const CWallet* const pwallet, const CKeyID& keyid, std::string& strAddr, std::string& strLabel) TS_ITCOIN_EXCLUSIVE_LOCKS_REQUIRED(pwallet->cs_wallet)
{
...
static UniValue ProcessImport(CWallet * const pwallet, const UniValue& data, const int64_t timestamp) TS_ITCOIN_EXCLUSIVE_LOCKS_REQUIRED(pwallet->cs_wallet)
{
    UniValue warnings(UniValue::VARR);
...
static UniValue ProcessDescriptorImport(CWallet * const pwallet, const UniValue& data, const int64_t timestamp) TS_ITCOIN_EXCLUSIVE_LOCKS_REQUIRED(pwallet->cs_wallet)
{
    UniValue warnings(UniValue::VARR);
    UniValue result(UniValue::VOBJ);
