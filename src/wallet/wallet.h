...
public:
    ...
    static util::ResultPtr<std::shared_ptr<CWallet>> CreateNew(WalletContext& context, const std::string& name, std::unique_ptr<WalletDatabase> database, uint64_t wallet_creation_flags);
