...
#ifndef Buttcoin_WALLET_WALLET_H
#define Buttcoin_WALLET_WALLET_H
...
public:
     ...
     * on this Buttcoin node, and set to 0 for transactions that were created
...
#endif // Buttcoin_WALLET_WALLET_H
