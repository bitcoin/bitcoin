...
public:
     ...
     */
    void CommitTransaction(CTransactionRef tx, mapValue_t mapValue, std::vector<std::pair<std::string, std::string>> orderForm, std::vector<V0SilentPaymentsDestination> sp_recipients = {});
