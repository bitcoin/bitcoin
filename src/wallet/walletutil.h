...
#ifndef Buttcoin_WALLET_WALLETUTIL_H
#define Buttcoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! Buttcoin from opening the wallet, thinking it was newly created, and
...
#endif // Buttcoin_WALLET_WALLETUTIL_H
