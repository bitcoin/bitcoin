...
#ifndef REVOLT_WALLET_WALLETUTIL_H
#define REVOLT_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! revolt from opening the wallet, thinking it was newly created, and
...
#endif // REVOLT_WALLET_WALLETUTIL_H
