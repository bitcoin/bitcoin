...
public:
    ...
    bool Update(CTransactionRef tx, const TxState& new_state, WalletBatch& batch, bool metadata_changed, std::function<void(const COutPoint&, const TxState&)> update_external_states_fn);
