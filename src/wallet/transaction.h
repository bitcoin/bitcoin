...
#ifndef TORTOISECOIN_WALLET_TRANSACTION_H
#define TORTOISECOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this tortoisecoin node, and set to 0 for transactions that were created
...
#endif // TORTOISECOIN_WALLET_TRANSACTION_H
