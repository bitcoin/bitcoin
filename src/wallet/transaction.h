...
#ifndef REVOLT_WALLET_TRANSACTION_H
#define REVOLT_WALLET_TRANSACTION_H
...
public:
     ...
     * on this revolt node, and set to 0 for transactions that were created
...
#endif // REVOLT_WALLET_TRANSACTION_H
