...
public:
    ...
    void ComputeAndSetWaste(const CAmount min_change, const CAmount change_cost, const CAmount change_fee);
     ...
     *
     * @param[in]  min_change  Minimum amount for change output, if change would be less than that we forgo change
