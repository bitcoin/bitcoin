...
bool WalletBatch::WriteNonValidationBestBlock(const CBlockLocator& locator)
{
    //nWalletDBUpdated++;
    return m_batch.Write(std::string("nonvalidationbestblock"), locator);
}

bool WalletBatch::ReadNonValidationBestBlock(CBlockLocator& locator)
{
    return m_batch.Read(std::string("nonvalidationbestblock"), locator);
}
