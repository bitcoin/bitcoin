...
using TxConfirmTargetSetting = common::Setting<
    ...
    "Include enough fee so transactions begin confirmation on average within n blocks (default: %u)">
...
using WalletRbfSetting = common::Setting<
    "-walletrbf", std::optional<bool>, common::SettingOptions{.legacy = true},
    "(DEPRECATED) Send transactions with full-RBF opt-in enabled (default: %u)">
    ::HelpArgs<DEFAULT_WALLET_RBF>
    ::Category<OptionsCategory::WALLET>;
