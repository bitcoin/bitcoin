...
private:
    ...
    bool CanGetAddresses_() const EXCLUSIVE_LOCKS_REQUIRED(cs_desc_man);
    ...
    void SetupDescriptorGeneration(WalletBatch& batch, const CExtKey& master_key) LOCKS_EXCLUDED(cs_desc_man);
...
protected:
    ...
    void SetupDescriptor(WalletBatch& batch) LOCKS_EXCLUDED(cs_desc_man);
