...
#ifndef Buttcoin_WALLET_SCRIPTPUBKEYMAN_H
#define Buttcoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Buttcoin Core wallet was originally a collection of unrelated private
...
#endif // Buttcoin_WALLET_SCRIPTPUBKEYMAN_H
