...
#ifndef XBIT_WALLET_SCRIPTPUBKEYMAN_H
#define XBIT_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The XBit Core wallet was originally a collection of unrelated private
...
#endif // XBIT_WALLET_SCRIPTPUBKEYMAN_H
