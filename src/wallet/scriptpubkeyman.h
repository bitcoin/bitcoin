...
public:
    ...
    virtual bool SignTransaction(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, std::string>& input_errors, std::optional<CAmount>* inputs_amount_sum = nullptr) const { return false; }
...
public:
    ...
    bool SignTransaction(CMutableTransaction& tx, const std::map<COutPoint, Coin>& coins, int sighash, std::map<int, std::string>& input_errors, std::optional<CAmount>* inputs_amount_sum = nullptr) const override;
