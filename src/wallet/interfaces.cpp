...
public:
    ...
    {
        std::vector<CTxOut> new_outputs; // just an empty list of new recipients
        return feebumper::CreateRateBumpTransaction(*m_wallet.get(), txid, coin_control, errors, old_fee, new_fee, mtx, new_outputs) == feebumper::Result::OK;
    }
