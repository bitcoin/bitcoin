...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    coin_selection_params_bnb.min_change = coin_selection_params_bnb.m_effective_feerate.GetFee(coin_selection_params_bnb.change_spend_size);
    {
