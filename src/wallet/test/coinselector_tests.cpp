...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
...

    {
        ...
        BOOST_CHECK(util::ErrorString(no_res).original.contains("The inputs size exceeds the maximum weight"));
...
BOOST_AUTO_TEST_CASE(coin_grinder_tests)
{
...

    {
        ...
        BOOST_CHECK(!res);
        BOOST_CHECK(util::ErrorString(res).original.contains("The inputs size exceeds the maximum weight"));
    }
