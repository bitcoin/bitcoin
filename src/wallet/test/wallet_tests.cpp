...
BOOST_FIXTURE_TEST_CASE(CreateWallet, TestChain100Setup)
{
    ...
    BOOST_CHECK(m_node.chain->broadcastTransaction(MakeTransactionRef(mempool_tx), DEFAULT_TRANSACTION_MAXFEE, CFeeRate(DEFAULT_TRANSACTION_MAXFEE, tx_vsize), false, error));
