    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see iopd log for details) and could be dealt with by "
...
BOOST_FIXTURE_TEST_CASE(ListCoins, ListCoinsTestingSetup)
{
    ...
    // NOTE: IoP has a premine of 2.1 million coins.
    BOOST_CHECK_EQUAL(2100000 * COIN, wallet->GetAvailableBalance());
