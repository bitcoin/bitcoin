...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    // temporary disable psbt test due to temporary broken CanProvide().
    // fix will be landed with bitcoin#18067
    ...
    std::unique_ptr<SigningProvider> provider = m_wallet.GetSigningProvider(ws1, sigdata);
