...
FUZZ_TARGET(wallet_scan, .init = initialize)
{
    ...
    (void)fuzzed_wallet.wallet->ScanForWalletTransactions(start_block, start_height, max_height, reserver, /*save_progress=*/false);
