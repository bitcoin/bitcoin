...
bool CWalletTx::Update(CTransactionRef new_tx, const TxState& new_state, WalletBatch& batch, bool metadata_changed, std::function<void(const COutPoint&, const TxState&)> update_external_states_fn)
{
    Assert(new_tx);
