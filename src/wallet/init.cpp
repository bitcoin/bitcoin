...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-signer=<cmd>", "External signing tool, see https://github.com/bitcoin/bitcoin/blob/v29.0/doc/external-signer.md", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
#endif
