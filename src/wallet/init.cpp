...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-signer=<cmd>", strprintf("External signing tool, see %s", GetDocumentationUrl("external-signer.md").c_str()), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
#endif
