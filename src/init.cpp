...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-txsonly", strprintf("Whether to reject blocks from network peers. Disables broadcast and rebroadcast of blocks (default: %u)", DEFAULT_TXSONLY), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
