...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-numconnections=<n>", strprintf("Maintain <n> connections to peers (default: %u)", -1), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION); // Cybersecurity Lab
    argsman.AddArg("-numblocksonlyconnections=<n>", strprintf("Maintain <n> blocks-only connection to peers (default: %u)", -1), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION); // Cybersecurity Lab
#ifdef USE_UPNP
#if USE_UPNP
