...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-allowinbound=<net>", "Announce addresses from a network to encourage inbound connections (" + Join(GetNetworkNames(), ", ") + "), even if it is not available outbound. If the network is available outbound this has no effect. It can be specified multiple times to allow multiple networks.", ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
