...
/**
* SYSCOIN Shutdown is split into 2 parts:
...
bool AppInitMain()
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", SYSCOIN_CONF_FILENAME)).string());
    ...
    if (!fLiteMode) {
        ...
        scheduler.scheduleEvery(boost::bind(&CMasternodeMan::DoMaintenance, boost::ref(mnodeman), boost::ref(*g_connman)), 10*60*1000);
