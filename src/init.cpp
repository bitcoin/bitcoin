...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-asmap=<file>", strprintf("Specify the ASN mapping used for bucketing of the peers (default: disabled, but if -asmap or -asmap= is specified without a filename, %s will be used). Relative paths will be prefixed by the net-specific datadir location.", DEFAULT_ASMAP_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
