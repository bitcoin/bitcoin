...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-txreconciliation", strprintf("Enable transaction reconciliations per BIP 330. This opens up to %d additional outbound connections (default: %d)", MAX_OUTBOUND_FULL_RECON_CONNECTIONS, DEFAULT_TXRECONCILIATION_ENABLE), ArgsManager::ALLOW_ANY, OptionsCategory::CONNECTION);
