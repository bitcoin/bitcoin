...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-infanout", strprintf("Percentage of inbound peers to fanout to (default: %f)", INBOUND_FANOUT_DESTINATIONS_FRACTION), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CONNECTION);
    argsman.AddArg("-outfanout", strprintf("Number of outbound peers to fanout to (default: %d)", OUTBOUND_FANOUT_THRESHOLD), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CONNECTION);
