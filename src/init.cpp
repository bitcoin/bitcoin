...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/yamacoinproject/yamacoin>";
    const std::string URL_WEBSITE = "<https://yama-co.in>";
...
/** Sanity checks
 *  Ensure that yama_coin is running in a usable environment with all
...
{
    // Make sure only a single yama_coin process is using the data directory.
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if yama_coin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if yama_coin is started while in a temporary directory.\n",
