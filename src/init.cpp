...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-deprecatedrest=<endpoint>", "Allows deprecated REST endpoint(s) to be used", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
