...
public:
    ...
    /** Try to calculate all in-mempool ancestors of a set of transactions not already in the
     * mempool, and check ancestor and descendant limits. The limits are applied to the union of all
     * transactions. For example, if transactions.size() = 3 and limitAncestorCount = 25, the union of
     * all 3 sets of ancestors must be <= 22.
     * @param[in]       package                 Transaction package being evaluated for acceptance
     *                                          to mempool. The transactions need not be direct
     *                                          ancestors/descendants of each other, though they
     *                                          will be treated as such.
     * @param[out]      setAncestors            Populated with the union of in-mempool ancestors of
     *                                          all the transactions in the package.
     ...
     */
    bool CalculateMemPoolAncestors(const Package& package,
                                   setEntries& setAncestors,
                                   uint64_t limitAncestorCount,
                                   uint64_t limitAncestorSize,
                                   uint64_t limitDescendantCount,
