...
// extracts a transaction hash from CTxMempoolEntry or CTransaction
...
public:
	...
	*/
	...
	boost::signals2::signal<void(CTransaction)> NotifyEntryAdded;
	boost::signals2::signal<void(CTransaction, MemPoolRemovalReason)> NotifyEntryRemoved;
...
struct DisconnectedBlockTransactions {
	...
	size_t DynamicMemoryUsage() const {
		return memusage::MallocUsage(sizeof(CTransaction) + 6 * sizeof(void*)) * queuedTx.size() + cachedInnerUsage;
	}
