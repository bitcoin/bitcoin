...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  ...
  //  --------------------- ------------------------    -----------------------  ---------- ---------- ---------
    ...
    { "omni layer",   "getinfo_MP",                     &getinfo_MP,                    true,   true,   true },
    { "omni layer",   "getallbalancesforid_MP",         &getallbalancesforid_MP,        false,  true,   true },
    { "omni layer",   "getbalance_MP",                  &getbalance_MP,                 false,  true,   true },
    { "omni layer",   "send_MP",                        &send_OMNI,                     false,  true,   true },
    { "omni layer",   "gettransaction_MP",              &gettransaction_MP,             false,  true,   true },
    { "omni layer",   "listtransactions_MP",            &listtransactions_MP,           false,  true,   true },
    { "omni layer",   "getproperty_MP",                 &getproperty_MP,                false,  true,   true },
    { "omni layer",   "listproperties_MP",              &listproperties_MP,             false,  true,   true },
    { "omni layer",   "getcrowdsale_MP",                &getcrowdsale_MP,               false,  true,   true },
    { "omni layer",   "getgrants_MP",                   &getgrants_MP,                  false,  true,   true },
    ...
    { "omni layer",   "gettradehistoryforaddress_OMNI", &gettradehistoryforaddress_OMNI,false,  true,  true },
    { "omni layer",   "gettradehistoryforpair_OMNI",    &gettradehistoryforpair_OMNI,   false,  true,  true },
    { "omni layer",   "gettrade_MP",                    &gettrade_MP,                   false,  true,   true },
    { "hidden",       "trade_MP",                       &trade_MP,                      false,  true,   true }, // depreciated
    { "omni layer",   "sendtrade_OMNI",                 &sendtrade_OMNI,                false,  true,   true },
    { "omni layer",   "sendcanceltradesbyprice_OMNI",   &sendcanceltradesbyprice_OMNI,  false,  true,   true },
    { "omni layer",   "sendcanceltradesbypair_OMNI",    &sendcanceltradesbypair_OMNI,   false,  true,   true },
    { "omni layer",   "sendcancelalltrades_OMNI",       &sendcancelalltrades_OMNI,      false,  true,   true },
    { "omni layer",   "sendtoowners_MP",                &sendsto_OMNI,                  false,  true,   true },
    { "omni layer",   "sendrawtx_MP",                   &sendrawtx_MP,                  false,  true,   true },
    { "omni layer",   "getsto_MP",                      &getsto_MP,                     false,  true,   true },
    { "omni layer",   "listblocktransactions_MP",       &listblocktransactions_MP,      false,  true,   true },
    { "omni layer",   "getallbalancesforaddress_MP",    &getallbalancesforaddress_MP,   false,  true,   true },
    { "omni layer",   "setautocommit_OMNI",             &setautocommit_OMNI,            true,   true,   true },
    { "omni layer",   "send_OMNI",                      &send_OMNI,                     false,  true,   true },
    { "omni layer",   "senddexsell_OMNI",               &senddexsell_OMNI,              false,  true,   true },
    { "omni layer",   "senddexaccept_OMNI",             &senddexaccept_OMNI,            false,  true,   true },
    { "omni layer",   "sendissuancecrowdsale_OMNI",     &sendissuancecrowdsale_OMNI,    false,  true,   true },
    { "omni layer",   "sendissuancefixed_OMNI",         &sendissuancefixed_OMNI,        false,  true,   true },
    { "omni layer",   "sendissuancemanaged_OMNI",       &sendissuancemanaged_OMNI,      false,  true,   true },
    { "omni layer",   "sendsto_OMNI",                   &sendsto_OMNI,                  false,  true,   true },
    { "omni layer",   "sendgrant_OMNI",                 &sendgrant_OMNI,                false,  true,   true },
    { "omni layer",   "sendrevoke_OMNI",                &sendrevoke_OMNI,               false,  true,   true },
    { "omni layer",   "sendclosecrowdsale_OMNI",        &sendclosecrowdsale_OMNI,       false,  true,   true },
    { "omni layer",   "sendchangeissuer_OMNI",          &sendchangeissuer_OMNI,         false,  true,   true },
    { "hidden",       "sendalert_OMNI",                 &sendalert_OMNI,                true,   true,   true },
