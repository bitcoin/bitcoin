...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* CATEGORY       NAME                               ACTOR (FUNCTION)                  OKSAFEMODE  THREADSAFE  REQWALLET */
    { "omni layer",   "omni_getinfo",                    &omni_getinfo,                    true,       true,       true },
    { "omni layer",   "omni_getallbalancesforid",        &omni_getallbalancesforid,        false,      true,       true },
    { "omni layer",   "omni_getbalance",                 &omni_getbalance,                 false,      true,       true },
    { "omni layer",   "omni_gettransaction",             &omni_gettransaction,             false,      true,       true },
    { "omni layer",   "omni_listtransactions",           &omni_listtransactions,           false,      true,       true },
    { "omni layer",   "omni_getproperty",                &omni_getproperty,                false,      true,       true },
    { "omni layer",   "omni_listproperties",             &omni_listproperties,             false,      true,       true },
    { "omni layer",   "omni_getcrowdsale",               &omni_getcrowdsale,               false,      true,       true },
    { "omni layer",   "omni_getgrants",                  &omni_getgrants,                  false,      true,       true },
    { "omni layer",   "omni_getactivedexsells",          &omni_getactivedexsells,          false,      true,       true },
    { "omni layer",   "omni_getactivecrowdsales",        &omni_getactivecrowdsales,        false,      true,       true },
    { "omni layer",   "omni_getorderbook",               &omni_getorderbook,               false,      true,       true },
    { "omni layer",   "omni_gettrade",                   &omni_gettrade,                   false,      true,       true },
    { "omni layer",   "omni_sendrawtx",                  &omni_sendrawtx,                  false,      true,       true },
    { "omni layer",   "omni_getsto",                     &omni_getsto,                     false,      true,       true },
    { "omni layer",   "omni_listblocktransactions",      &omni_listblocktransactions,      false,      true,       true },
    { "omni layer",   "omni_getallbalancesforaddress",   &omni_getallbalancesforaddress,   false,      true,       true },
    { "omni layer",   "omni_gettradehistoryforaddress",  &omni_gettradehistoryforaddress,  false,      true,       true },
    { "omni layer",   "omni_gettradehistoryforpair",     &omni_gettradehistoryforpair,     false,      true,       true },
    { "omni layer",   "omni_setautocommit",              &omni_setautocommit,              true,       true,       true },

    /* Omni Core transaction calls */
    /* CATEGORY       NAME                               ACTOR (FUNCTION)                  OKSAFEMODE  THREADSAFE  REQWALLET */
    { "omni layer",   "omni_send",                       &omni_send,                       false,      true,       true },
    { "omni layer",   "omni_senddexsell",                &omni_senddexsell,                false,      true,       true },
    { "omni layer",   "omni_senddexaccept",              &omni_senddexaccept,              false,      true,       true },
    { "omni layer",   "omni_sendissuancecrowdsale",      &omni_sendissuancecrowdsale,      false,      true,       true },
    { "omni layer",   "omni_sendissuancefixed",          &omni_sendissuancefixed,          false,      true,       true },
    { "omni layer",   "omni_sendissuancemanaged",        &omni_sendissuancemanaged,        false,      true,       true },
    { "omni layer",   "omni_sendtrade",                  &omni_sendtrade,                  false,      true,       true },
    { "omni layer",   "omni_sendcanceltradesbyprice",    &omni_sendcanceltradesbyprice,    false,      true,       true },
    { "omni layer",   "omni_sendcanceltradesbypair",     &omni_sendcanceltradesbypair,     false,      true,       true },
    { "omni layer",   "omni_sendcancelalltrades",        &omni_sendcancelalltrades,        false,      true,       true },
    { "omni layer",   "omni_sendsto",                    &omni_sendsto,                    false,      true,       true },
    { "omni layer",   "omni_sendgrant",                  &omni_sendgrant,                  false,      true,       true },
    { "omni layer",   "omni_sendrevoke",                 &omni_sendrevoke,                 false,      true,       true },
    { "omni layer",   "omni_sendclosecrowdsale",         &omni_sendclosecrowdsale,         false,      true,       true },
    { "omni layer",   "omni_sendchangeissuer",           &omni_sendchangeissuer,           false,      true,       true },
