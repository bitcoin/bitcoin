...
public:
    ...
    explicit Proxy(std::string path, bool _randomize_credentials = false)
        : m_unix_socket_path(std::move(path)), m_is_unix_socket(true), m_randomize_credentials(_randomize_credentials) {}
