...
#define SER_READ(obj, code) ser_action.SerRead(s, obj, [&](Stream& s, typename std::remove_const_t<Type>& obj) { code; })
...
struct VarIntFormatter
{
    ...
    {
        WriteVarInt<Stream,Mode,typename std::remove_cv_t<I>>(s, v);
    }

    template<typename Stream, typename I> void Unser(Stream& s, I& v)
    {
        v = ReadVarInt<Stream,Mode,typename std::remove_cv_t<I>>(s);
    }
};
