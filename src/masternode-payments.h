...
bool IsBlockValueValid(const CBlock& block, int nBlockHeight, const CAmount &nFee, CAmount blockReward, std::string &strErrorRet);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, const CAmount &nFee, masternode_info_t& mnInfo);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, int nBlockHeight, const CAmount &nFee, masternode_info_t& mnInfo);
