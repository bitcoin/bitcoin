 ...
 * for both snailcoind and snailcoin-qt, to make it harder for attackers to
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Snailcoin Core copyright is not removed by accident
    if (copyright_devs.find("Snailcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Snailcoin Core developers";
    }
