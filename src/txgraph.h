...
public:
    ...
    /** Get pointers to all ancestors of the specified transaction, in unspecified order. Returns
     *  {} if arg does not exist in the graph. */
    virtual std::vector<Ref*> GetAncestors(const Ref& arg) noexcept = 0;
    /** Get pointers to all descendants of the specified transaction, in unspecified order. Returns
     *  {} if arg does not exist in the graph. */
