...
static constexpr unsigned MAX_CLUSTER_COUNT_LIMIT{20000};
...
public:
    ...
    virtual std::pair<std::vector<FeePerWeight>, std::vector<FeePerWeight>> GetMainStagingDiagrams() noexcept = 0;
